...
public class CreateVirtualClassTest extends SetupEnvTestCase {
	String dbname="demodb";
	String vtable = "v_code";
	public void testSend() throws Exception {
		String filepath=this.getFilePathInPlugin("com/cubrid/cubridmanager/core/cubrid/table/task/virtualclass/test.message/createvirtualclass_send");
		...
		// composite message
		CreateVirtualClass task = new CreateVirtualClass(site);
	...
	public void testReceive() throws Exception {
		String filepath=this.getFilePathInPlugin("com/cubrid/cubridmanager/core/cubrid/table/task/virtualclass/test.message/createvirtualclass_receive");
		String msg = Tool.getFileContent(filepath);
