...
public class ValidateQuerySpecTaskTest extends SetupEnvTestCase {
	String dbname="demodb";
	String vtable = "v_code";
	String queryspec="select code as aaa from athlete";
	public void testSend() throws Exception {
		String filepath=this.getFilePathInPlugin("com/cubrid/cubridmanager/core/cubrid/table/task/virtualclass/test.message/validatequeryspec_send");
		...
		// composite message
		ValidateQuerySpecTask task = new ValidateQuerySpecTask(site);
	...
	public void testReceive() throws Exception {
		String filepath=this.getFilePathInPlugin("com/cubrid/cubridmanager/core/cubrid/table/task/virtualclass/test.message/validatequeryspec_receive");
		String msg = Tool.getFileContent(filepath);		
