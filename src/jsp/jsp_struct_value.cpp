...
//////////////////////////////////////////////////////////////////////////
  ...
  void
  sp_value::pack_value_internal (cubpacking::packer &serializator, DB_VALUE &v) const
  {
  ...
  size_t
  sp_value::get_packed_size (cubpacking::packer &serializator, std::size_t start_offset) const
  {
    if (value == nullptr)
      {
	return 0;
  ...
  void
  sp_value::pack (cubpacking::packer &serializator) const
  {
    if (value == nullptr)
      {
	return;
  ...
  size_t
  sp_value::get_packed_value_size_internal (cubpacking::packer &serializator, std::size_t start_offset, DB_VALUE &v) const
  {
  ...
  void
  sp_value::unpack (cubpacking::unpacker &deserializator)
  {
    if (value == nullptr)
      {
	return;
