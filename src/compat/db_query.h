...
extern int db_query_end (DB_QUERY_RESULT * result, DB_QUERY_EXECUTION_END_TYPE query_execution_end_type);
...
extern DB_QUERY_EXECUTION_END_TYPE db_get_end_type_after_executed_query (int end_query_result, bool committed,
									 int reset_on_commit);
