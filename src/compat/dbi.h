...
extern int db_commit_transaction (DB_QUERY_EXECUTION_END_TYPE latest_query_execution_end_type);
...
*/
extern void db_free_query (DB_SESSION * session, DB_QUERY_EXECUTION_END_TYPE query_execution_end_type);
