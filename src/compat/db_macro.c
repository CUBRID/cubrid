 ...
 */ 
static int 
transfer_bit_string (char *buf, int *xflen, int *outlen, const int buflen, const DB_VALUE * src,
		     const DB_TYPE_C c_type) 
{
    ...
    
    {
	  ...
	  
	  {
	    ...
	    
	    {
	      ...
	      qstr_bit_to_hex_coerce ((char *) buf, buflen, DB_GET_STRING (value), DB_GET_STRING_LENGTH (value), true,
				       xflen, &truncated);
	    ...
	    
	    {
	      ...
	      qstr_bit_to_hex_coerce ((char *) buf, buflen, DB_GET_STRING (value), DB_GET_STRING_LENGTH (value),
...
coerce_char_to_dbvalue (DB_VALUE * value, char *buf, const int buflen) 
{
    ...
    
    {
	  ...
	  
	  {
	    ...
	    qstr_make_typed_string (db_type, &tmp_value, precision, buf, buflen, LANG_SYS_CODESET,
				      LANG_SYS_COLLATION);
