...
typedef rapidjson::GenericSchemaDocument<rapidjson::GenericValue<rapidjson::UTF8<>, rapidjson::MemoryPoolAllocator<cubrid_json_allocator> > > cubrid_schema_document;
typedef rapidjson::GenericSchemaValidator<cubrid_schema_document> cubrid_schema_validator;
typedef rapidjson::GenericValue<rapidjson::UTF8<>, rapidjson::MemoryPoolAllocator<cubrid_json_allocator> > cubrid_value;
typedef rapidjson::GenericPointer<rapidjson::GenericValue<rapidjson::UTF8<>, rapidjson::MemoryPoolAllocator<cubrid_json_allocator> > > cubrid_pointer;
