 ...
 * NOTE: This is a legacy version of db_commit_transaction.
 * Please consider using the new version, db_commit_transaction_ex when you want to control commit behavior.
 */
int
db_commit_transaction (void)
{
  ...
  retval = tran_commit (false, DB_QUERY_EXECUTE_WITH_COMMIT_NOT_ALLOWED);

  return (retval);
}

/*
 * db_commit_transaction_ex() - Commits the current transaction.
 *    You must call this function if you want changes to be made permanent.
 * return : error code.
 ...
 */
int
db_commit_transaction_ex (DB_QUERY_EXECUTION_ENDING_TYPE latest_query_execution_ending_type)
{
  int retval;
