...
#define DB_IS_CONSTRAINT_UNIQUE_FAMILY(c) \
  ( ((c) == DB_CONSTRAINT_UNIQUE || (c) == DB_CONSTRAINT_PRIMARY_KEY) ? true : false )

#define DB_IS_CONSTRAINT_INDEX_FAMILY(c) \
  ( (DB_IS_CONSTRAINT_UNIQUE_FAMILY(c) || (c) == DB_CONSTRAINT_INDEX || (c) == DB_CONSTRAINT_FOREIGN_KEY) ? true : false )
