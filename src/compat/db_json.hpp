...
int db_json_arrayagg_func (const JSON_DOC *value, JSON_DOC &result_json, bool expand = false);
int db_json_objectagg_func (const char *key_str, const JSON_DOC *val_doc, JSON_DOC &result_json);
int db_json_objectagg_func (const JSON_DOC &object_doc, JSON_DOC &result_json);
