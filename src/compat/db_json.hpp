...
int db_json_arrayagg_func_accumulate (const JSON_DOC *value, JSON_DOC &result_json);
int db_json_objectagg_func_accumulate (const char *key_str, const JSON_DOC *val_doc, JSON_DOC &result_json);
