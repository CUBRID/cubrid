...
static KEYWORD_RECORD keywords[] = {
  ...
  {PREFER_INLINE, "PREFER_INLINE", 1},
  {PREFER_OUTLINE, "PREFER_OUTLINE", 1},
  {PREPARE, "PREPARE", 0},
  {PRESERVE, "PRESERVE", 0},
  {PRIMARY, "PRIMARY", 0},
  {PRINT, "PRINT", 1},
...
static FUNCTION_MAP functions[] = {
  ...
  {0, "bit_to_bfile", PT_BIT_TO_BFILE},
  {0, "bfile_from_file", PT_BFILE_FROM_FILE},
  {0, "bfile_length", PT_BFILE_LENGTH},
  {0, "bfile_to_bit", PT_BFILE_TO_BIT},
  {0, "bfile_to_blob", PT_BFILE_TO_BLOB},
  {0, "bit_to_blob", PT_BIT_TO_BLOB},
  {0, "blob_from_file", PT_BLOB_FROM_FILE},
  {0, "blob_length", PT_BLOB_LENGTH},
  {0, "blob_to_bfile", PT_BLOB_TO_BFILE},
  {0, "blob_to_bit", PT_BLOB_TO_BIT},
  {0, "ceil", PT_CEIL},
  {0, "ceiling", PT_CEIL},
  {0, "char_length", PT_CHAR_LENGTH},
  {0, "char_to_bfile", PT_CHAR_TO_BFILE},
  {0, "char_to_cfile", PT_CHAR_TO_CFILE},
  {0, "character_length", PT_CHAR_LENGTH},
  {0, "cfile_from_file", PT_CFILE_FROM_FILE},
  {0, "cfile_length", PT_CFILE_LENGTH},
  {0, "cfile_to_clob", PT_CFILE_TO_CLOB},
  ...
  {0, "clob_to_cfile", PT_CLOB_TO_CFILE},
  {0, "concat", PT_CONCAT},
