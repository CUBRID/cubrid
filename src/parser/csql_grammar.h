...
enum yytokentype
{
  ...
  DOLLAR_SIGN = 624,
  WON_SIGN = 625,
  TURKISH_LIRA_SIGN = 626,
  BRITISH_POUND_SIGN = 627,
  CAMBODIAN_RIEL_SIGN = 628,
  CHINESE_RENMINBI_SIGN = 629,
  INDIAN_RUPEE_SIGN = 630,
  RUSSIAN_RUBLE_SIGN = 631,
  AUSTRALIAN_DOLLAR_SIGN = 632,
  CANADIAN_DOLLAR_SIGN = 633,
  BRASILIAN_REAL_SIGN = 634,
  ROMANIAN_LEU_SIGN = 635,
  EURO_SIGN = 636,
  SWISS_FRANC_SIGN = 637,
  DANISH_KRONE_SIGN = 638,
  NORWEGIAN_KRONE_SIGN = 639,
  BULGARIAN_LEV_SIGN = 640,
  VIETNAMESE_DONG_SIGN = 641,
  CZECH_KORUNA_SIGN = 642,
  POLISH_ZLOTY_SIGN = 643,
  SWEDISH_KRONA_SIGN = 644,
  CROATIAN_KUNA_SIGN = 645,
  SERBIAN_DINAR_SIGN = 646,
  DOT = 647,
  RIGHT_ARROW = 648,
  STRCAT = 649,
  COMP_NOT_EQ = 650,
