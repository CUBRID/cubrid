...
# define YYTOKENTYPE
   ...
   enum yytokentype {
     ...
     DOLLAR_SIGN = 628,
     WON_SIGN = 629,
     TURKISH_LIRA_SIGN = 630,
     BRITISH_POUND_SIGN = 631,
     CAMBODIAN_RIEL_SIGN = 632,
     CHINESE_RENMINBI_SIGN = 633,
     INDIAN_RUPEE_SIGN = 634,
     RUSSIAN_RUBLE_SIGN = 635,
     AUSTRALIAN_DOLLAR_SIGN = 636,
     CANADIAN_DOLLAR_SIGN = 637,
     BRASILIAN_REAL_SIGN = 638,
     ROMANIAN_LEU_SIGN = 639,
     EURO_SIGN = 640,
     SWISS_FRANC_SIGN = 641,
     DANISH_KRONE_SIGN = 642,
     NORWEGIAN_KRONE_SIGN = 643,
     BULGARIAN_LEV_SIGN = 644,
     VIETNAMESE_DONG_SIGN = 645,
     CZECH_KORUNA_SIGN = 646,
     POLISH_ZLOTY_SIGN = 647,
     SWEDISH_KRONA_SIGN = 648,
     CROATIAN_KUNA_SIGN = 649,
     SERBIAN_DINAR_SIGN = 650,
     DOT = 651,
     RIGHT_ARROW = 652,
     STRCAT = 653,
     COMP_NOT_EQ = 654,
