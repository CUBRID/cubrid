...
pt_make_field_type_expr_node (PARSER_CONTEXT * parser)
{
  ...
  /* IF( type_id=22 , CONCAT(',',scale,')') , ')' ) */
  {
    ...
    pred_for_if = pt_make_pred_name_int_val (parser, PT_EQ, "type_id", DB_TYPE_NUMERIC /* 22 */ );
   ...
   * CONCAT(...) , '' ) */
  {
    ...
    /* CHAR */
    cond_item1 = pt_make_pred_name_int_val (parser, PT_EQ, "type_id", DB_TYPE_CHAR);
  ...
  /* IF ( type_id = 6 OR type_id = 7 OR type_id=8 , CONCAT( .. ),'') */
  {
    ...
    /* SET and MULTISET */
    cond_item1 = pt_make_pred_name_int_val (parser, PT_EQ, "type_id", DB_TYPE_SET /* 6 */ );
    cond_item2 = pt_make_pred_name_int_val (parser, PT_EQ, "type_id", DB_TYPE_MULTISET /* 7 */ );
    cond_item1 = parser_make_expression (parser, PT_OR, cond_item1, cond_item2, NULL);
    /* SEQUENCE */
    cond_item2 = pt_make_pred_name_int_val (parser, PT_EQ, "type_id", DB_TYPE_SEQUENCE /* 8 */ );
    cond_item1 = parser_make_expression (parser, PT_OR, cond_item1, cond_item2, NULL);
