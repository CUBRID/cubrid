  ...
  if (node->node_type == PT_FUNCTION)
    {
	  ...
	  function_type == F_ELT || function_type == F_JSON_OBJECT || function_type == F_JSON_ARRAY ||
	  function_type == F_JSON_INSERT || function_type == F_JSON_REMOVE || function_type == F_JSON_MERGE)
	{
	  return true;
	}
    }
