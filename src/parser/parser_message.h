...
#define MSGCAT_SEMANTIC_NOT_SUPPORT_TYPE_TO_DATE_LANG    MSGCAT_SEMANTIC_NO(325)
#define MSGCAT_SEMANTIC_SP_NOT_EXIST                            MSGCAT_SEMANTIC_NO(326)
...
#define MSGCAT_SEMANTIC_PARTITION_NAME_TOO_LONG            MSGCAT_SEMANTIC_NO(337)
#define MSGCAT_SEMANTIC_UUID_INVALID_ARG                MSGCAT_SEMANTIC_NO(338)
#define MSGCAT_SEMANTIC_CLASS_ATT_OR_SHARED_CANT_SET_STORAGE            MSGCAT_SEMANTIC_NO(339)
#define MSGCAT_SEMANTIC_STORAGE_REQUIRES_VARIABLE_NORMAL_ATT            MSGCAT_SEMANTIC_NO(340)
#define MSGCAT_SEMANTIC_SEMI_ANTI_JOIN_RHS_NOT_ALLOWED          MSGCAT_SEMANTIC_NO(341)
#define MSGCAT_SEMANTIC_SEMI_ANTI_JOIN_NEEDS_OUTER_PRED         MSGCAT_SEMANTIC_NO(342)
#define MSGCAT_SEMANTIC_SEMI_ANTI_JOIN_NOT_WITH_CONNECT_BY      MSGCAT_SEMANTIC_NO(343)
