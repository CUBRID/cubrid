...
#define MSGCAT_SEMANTIC_DEFAULT_EXPR_NOT_ALLOWED        MSGCAT_SEMANTIC_NO(226)
#define MSGCAT_SEMANTIC_UPDATE_DERIVED_TABLE	        MSGCAT_SEMANTIC_NO(227)
#define MSGCAT_SEMANTIC_UPDATE_MIX_CLASS_NON_CLASS	MSGCAT_SEMANTIC_NO(228)
#define MSGCAT_SEMANTIC_UPDATE_SUBVCLASS_NOT_ALLOWED	MSGCAT_SEMANTIC_NO(229)
#define MSGCAT_SEMANTIC_HOSTVAR_IN_DDL			MSGCAT_SEMANTIC_NO(230)
#define MSGCAT_SEMANTIC_INVALID_FILTER_INDEX		MSGCAT_SEMANTIC_NO(231)
#define MSGCAT_SEMANTIC_INVALID_FUNCTION_INDEX		MSGCAT_SEMANTIC_NO(232)
#define MSGCAT_SEMANTIC_INVALID_CREATE_INDEX		MSGCAT_SEMANTIC_NO(233)
