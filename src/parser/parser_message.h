...
#define MSGCAT_SEMANTIC_ONLY_ONE_UPDATE_SPEC_ALLOWED    MSGCAT_SEMANTIC_NO(273)
#define MSGCAT_SEMANTIC_MULTIPLE_INSERT_TARGETS         MSGCAT_SEMANTIC_NO(274)
#define MSGCAT_SEMANTIC_VIEW_CASCADE_CONSTRAINTS_NOT_ALLOWED		MSGCAT_SEMANTIC_NO(275)
#define MSGCAT_SEMANTIC_MEDIAN_FUNC_NOT_ALLOW_ORDER_BY  MSGCAT_SEMANTIC_NO(276)
#define MSGCAT_SEMANTIC_INVALID_CONSTANT_PARAMETER  MSGCAT_SEMANTIC_NO(277)
#define MSGCAT_SEMANTIC_NULL_ORDER_BY  MSGCAT_SEMANTIC_NO(278)
#define MSGCAT_SEMANTIC_UNMACHTED_ARG_ORDER  MSGCAT_SEMANTIC_NO(279)
#define MSGCAT_SEMANTIC_INVALID_FUNCTION_ORDERBY MSGCAT_SEMANTIC_NO(280)
