...
#define MSGCAT_SEMANTIC_NOT_SUPPORTED_SP_ARG_TYPE		MSGCAT_SEMANTIC_NO(318)
#define MSGCAT_SEMANTIC_NOT_SUPPORTED_SP_RET_TYPE		MSGCAT_SEMANTIC_NO(319)
#define MSGCAT_SEMANTIC_NOT_ALLOWED_PERCENT_TYPE 		MSGCAT_SEMANTIC_NO(320)
#define MSGCAT_SEMANTIC_UNDEFINED_TABLE_COLUMN   		MSGCAT_SEMANTIC_NO(321)
