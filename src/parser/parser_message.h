...
#define MSTCAT_SEMANTIC_SP_NOT_EXIST                            MSGCAT_SEMANTIC_NO(323)
#define MSGCAT_SEMANTIC_SP_OUT_DEFAULT_ARG_NOT_ALLOWED          MSGCAT_SEMANTIC_NO(324)
#define MSGCAT_SEMANTIC_SP_NON_TRAILING_OPTIONAL_PARAMS         MSGCAT_SEMANTIC_NO(325)
#define MSGCAT_SEMANTIC_SP_OUT_ARGS_EXISTS_IN_QUERY             MSGCAT_SEMANTIC_NO(326)
#define MSGCAT_SEMATNIC_AU_GRANT_OPTION_NOT_ALLOWED             MSGCAT_SEMANTIC_NO(327)
