...
#define MSGCAT_SYNTAX_RENAME_CANNOT_CHANGE_OWNER        MSGCAT_SYNTAX_NO(131)
#define MSGCAT_SYNTAX_INVALID_ALTER_SYNONYM             MSGCAT_SYNTAX_NO(132)
#define MSGCAT_SYNTAX_INVALID_CREATE_SYNONYM            MSGCAT_SYNTAX_NO(133)
#define MSGCAT_SYNTAX_INVALID_DROP_SYNONYM              MSGCAT_SYNTAX_NO(134)
#define MSGCAT_SYNTAX_INVALID_RENAME_SYNONYM            MSGCAT_SYNTAX_NO(135)
