...
#define MSGCAT_SYNTAX_INVALID_REGEXP_SUBSTR		MSGCAT_SYNTAX_NO(131)
#define MSGCAT_SYNTAX_INVALID_REGEXP_INSTR		MSGCAT_SYNTAX_NO(132)
#define MSGCAT_SYNTAX_INVALID_REGEXP_COUNT		MSGCAT_SYNTAX_NO(133)
