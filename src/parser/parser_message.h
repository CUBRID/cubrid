...
#define MSGCAT_SEMANTIC_FUNCTYPECHECK_NO_SIGNATURES     MSGCAT_SEMANTIC_NO(301)
#define MSGCAT_SEMANTIC_FUNCTYPECHECK_INCOMPATIBLE_TYPE MSGCAT_SEMANTIC_NO(302)
#define MSGCAT_SEMANTIC_FUNCTYPECHECK_ARGS_COUNT        MSGCAT_SEMANTIC_NO(303)
#define MSGCAT_SEMANTIC_FUNCTYPECHECK_NO_SIGNATURE      MSGCAT_SEMANTIC_NO(304)
