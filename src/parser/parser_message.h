...
#define MSTCAT_SEMANTIC_SP_NOT_EXIST                    MSGCAT_SEMANTIC_NO(318)
#define MSGCAT_SEMANTIC_SP_OUT_DEFAULT_ARG_NOT_ALLOWED  MSGCAT_SEMANTIC_NO(319)
#define MSGCAT_SEMANTIC_SP_NON_TRAILING_OPTIONAL_PARAMS MSGCAT_SEMANTIC_NO(320)
