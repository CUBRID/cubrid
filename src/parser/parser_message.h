...
#define MSGCAT_SEMANTIC_INVALID_VECTOR_DISTANCE_METRIC          MSGCAT_SEMANTIC_NO(334)

/* CREATE INDEX ... USING <algorithm> diagnostics */
#define MSGCAT_SEMANTIC_INVALID_INDEX_ALGORITHM                 MSGCAT_SEMANTIC_NO(335)
#define MSGCAT_SEMANTIC_INDEX_METRIC_ON_NON_VECTOR              MSGCAT_SEMANTIC_NO(336)
#define MSGCAT_SEMANTIC_VECTOR_INDEX_NO_METRIC                  MSGCAT_SEMANTIC_NO(337)
#define MSGCAT_SEMANTIC_VECTOR_INDEX_NO_UNIQUE                  MSGCAT_SEMANTIC_NO(338)
#define MSGCAT_SEMANTIC_VECTOR_INDEX_NO_REVERSE                 MSGCAT_SEMANTIC_NO(339)
#define MSGCAT_SEMANTIC_VECTOR_INDEX_NO_BUILD_OPTION            MSGCAT_SEMANTIC_NO(340)
#define MSGCAT_SEMANTIC_VECTOR_INDEX_NO_PARTIAL                 MSGCAT_SEMANTIC_NO(341)
#define MSGCAT_SEMANTIC_INDEX_BUILD_OPTION_ON_NON_VECTOR        MSGCAT_SEMANTIC_NO(342)
#define MSGCAT_SEMANTIC_VECTOR_INDEX_UNKNOWN_OPTION             MSGCAT_SEMANTIC_NO(343)
#define MSGCAT_SEMANTIC_VECTOR_INDEX_DUP_OPTION                 MSGCAT_SEMANTIC_NO(344)
