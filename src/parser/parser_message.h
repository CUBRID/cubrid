...
#define MSGCAT_SEMANTIC_CREATE_TABLE_VIEW_NOT_OWNER     MSGCAT_SEMANTIC_NO(307)
#define MSGCAT_SEMANTIC_SYNONYM_INVALID_NAME            MSGCAT_SEMANTIC_NO(308)
#define MSGCAT_SEMANTIC_SYNONYM_NOT_OWNER               MSGCAT_SEMANTIC_NO(309)
#define MSGCAT_SEMANTIC_SYNONYM_PUBLIC_ALREADY_EXIST    MSGCAT_SEMANTIC_NO(310)
#define MSGCAT_SEMANTIC_SYNONYM_PUBLIC_NOT_EXIST        MSGCAT_SEMANTIC_NO(311)
#define MSGCAT_SEMANTIC_SYNONYM_ALREADY_EXIST           MSGCAT_SEMANTIC_NO(312)
#define MSGCAT_SEMANTIC_SYNONYM_NOT_EXIST               MSGCAT_SEMANTIC_NO(313)
#define MSGCAT_SEMANTIC_SYNONYM_RENAME_CANNOT_CHANGE_OWNER	MSGCAT_SEMANTIC_NO(314)
#define MSGCAT_SEMANTIC_SYNONYM_RENAME_CANNOT_SAME_NAME		MSGCAT_SEMANTIC_NO(315)
