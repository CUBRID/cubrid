...
#define MSGCAT_SEMATNIC_SP_PARAM_DEFAULT_STR_TOO_BIG            MSGCAT_SEMANTIC_NO(330)

#define MSGCAT_SEMATNIC_INVALID_HOST_EXPR            MSGCAT_SEMANTIC_NO(331)
#define MSGCAT_SEMANTIC_INVALID_VECTOR_DISTANCE_METRIC          MSGCAT_SEMANTIC_NO(332)
