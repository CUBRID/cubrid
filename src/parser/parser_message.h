...
#define MSGCAT_SYNTAX_INVALID_CFILE_TO_CHAR		MSGCAT_SYNTAX_NO(119)
...
#define MSGCAT_SYNTAX_INVALID_CLOB_TO_CHAR		MSGCAT_SYNTAX_NO(140)
...
#define MSGCAT_SEMANTIC_CLASS_ATT_OR_SHARED_CANT_SET_STORAGE            MSGCAT_SEMANTIC_NO(338)
#define MSGCAT_SEMANTIC_FORCE_OUTLINE_REQUIRES_VARIABLE_NORMAL_ATT      MSGCAT_SEMANTIC_NO(339)
