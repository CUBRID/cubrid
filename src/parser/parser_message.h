...
#define MSGCAT_SEMANTIC_ANTI_JOIN_RHS_NOT_ALLOWED               MSGCAT_SEMANTIC_NO(338)
#define MSGCAT_SEMANTIC_SEMI_ANTI_JOIN_NEEDS_OUTER_PRED         MSGCAT_SEMANTIC_NO(339)
#define MSGCAT_SEMANTIC_SEMI_ANTI_JOIN_NOT_WITH_CONNECT_BY      MSGCAT_SEMANTIC_NO(340)
