...
#define MSGCAT_SEMANTIC_SERVER_ALREADY_EXISTS           MSGCAT_SEMANTIC_NO(306)
#define MSGCAT_SEMANTIC_SERVER_MISSING_REQUIRED         MSGCAT_SEMANTIC_NO(307)
...
#define MSGCAT_RUNTIME_RT_SERVER_NOT_DEFINED            MSGCAT_RUNTIME_NO(83)
#define MSGCAT_RUNTIME_RT_SERVER_ALTER_NOT_ALLOWED      MSGCAT_RUNTIME_NO(84)
