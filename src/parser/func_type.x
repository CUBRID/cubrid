...
X(GENERIC               , NULL)
X(CLASS_OF              , NULL)
X(INSERT_SUSTRING       , &func_signature::insert)
X(ELT                   , &func_signature::elt)
X(JSON_OBJECT           , &func_signature::json_key_val_r_key_val)
X(JSON_ARRAY            , &func_signature::json_val_r_val)
X(JSON_MERGE            , &func_signature::json_doc_r_doc)
X(JSON_INSERT           , &func_signature::json_doc_path_doc_r_path_doc)
X(JSON_REMOVE           , &func_signature::json_doc_path_r_path)
X(JSON_ARRAY_APPEND     , &func_signature::json_doc_path_doc_r_path_doc)
X(JSON_GET_ALL_PATHS    , &func_signature::json_doc)
X(JSON_REPLACE          , &func_signature::json_doc_path_doc_r_path_doc)
X(JSON_SET              , &func_signature::json_doc_path_doc_r_path_doc)
