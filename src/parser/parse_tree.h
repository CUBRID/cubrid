...
enum pt_custom_print
{
  ...
  PT_PRINT_NAME_WITHOUT_CURRENT_USER_NAME = (0x1 << 23)
};
...
#define PT_NAME_USER_SPECIFIED_NAME 8192 /* resolved_name is added to original_name to make user_specified_name. */
