...
************************************************************************/	
PUBLIC RETCODE odbc_alloc_desc(ODBC_CONNECTION *conn,
						ODBC_DESC	**desc_ptr)
{
	ODBC_DESC	*desc_node;
								  ...
								  short *nullable_ptr)
{
	...
	odbc_get_desc_field(desc, rec_number, SQL_DESC_NAME,
		(void*)name, buffer_length, (long*)string_length_ptr);
...
* NOTE: 
************************************************************************/
PUBLIC RETCODE odbc_set_desc_rec(ODBC_DESC *desc,
								 short rec_number,
								 short type,
								 short subtype,
								 long length,
...
* NOTE: 
************************************************************************/
PUBLIC void odbc_set_ird(ODBC_STATEMENT *stmt,
						 short			column_number,
						 short			type,
						 char*			table_name,
						 char*			column_name,
