...
typedef enum
{
  ...
  SM_CLASS_CONSTRAINT_OPTIONAL_INFO_INDEX = -6,
  SM_CLASS_CONSTRAINT_STATUS_INDEX = -5,
  SM_CLASS_CONSTRAINT_INDEX_TYPE_INDEX = -4,
  SM_CLASS_CONSTRAINT_COMMENT_INDEX = -3,
  SM_CLASS_CONSTRAINT_CREATED_TIME_INDEX = -2,
  SM_CLASS_CONSTRAINT_UPDATED_TIME_INDEX = -1,

  SM_CLASS_CONSTRAINT_FIXED_FIELD_COUNT = 6	// Does not include OPTIONAL_INFO (optional field)
