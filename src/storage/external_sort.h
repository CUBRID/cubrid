...
struct SORTKEY_INFO
{
  ...
  QFILE_TUPLE_VALUE_TYPE_LIST key_tl;	/* layout descriptor of the key mini tuple: domp[i] = list domain of key[i].col
					 * (CBRD-27365 D-182-14). Read-only once built; shared by parallel sort workers. */
};
