 ...
 *
 * common.h - Definitions and data types of disk related stuffs
...
/* Volume purpose
 *
 * The VOLPURPOSE constants have been moved to api/dbdef.h because
 * they are visible through the API.  The type definition there
 * is DB_VOLPURPOSE.  I left the DISK_VOLPURPOSE definition here
 * so the current modules don't have to change. 
 */
...
extern LOCK lock_Conv[][9];	/* From lkbt.c */
...
{
  int printtoc;			/* True to show backup's table of contents */
