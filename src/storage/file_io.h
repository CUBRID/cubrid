...
/* lob_dir */
extern int xcreate_lob_dir (THREAD_ENTRY * thread_p, HFID * hfid, int *attrid_arr, int attrid_arr_length);
extern int xremove_lob_dir (THREAD_ENTRY * thread_p, HFID * hfid, int attrid);
