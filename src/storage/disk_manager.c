...
#if defined (SERVER_MODE)
static void disk_log_extend_elapsed (THREAD_ENTRY * thread_p, char * event, char *name, DB_VOLTYPE voltype, char *log);
#endif
 ...
 */
static void
disk_log_extend_elapsed (THREAD_ENTRY * thread_p, char * event, char *name, DB_VOLTYPE voltype, char *log)
{
  FILE *log_fp;
  int indent = 2;
