      ...
      if (perfmon_is_perf_tracking ())
        {
          ...
          // the function is also able to extract discrete detailed btree page types;
          // not interested in that but the mechanism is able to also accumulate and display those as well
