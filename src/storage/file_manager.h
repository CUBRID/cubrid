...
extern int file_spacedb (THREAD_ENTRY * thread_p, SPACEDB_FILES * spacedb, char **table_array, int table_array_length, SPACEDB_TABLE_SIZES_HEADER ** table_sizes_p, int *actual_count_p);
