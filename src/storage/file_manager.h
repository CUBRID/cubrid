...
extern int file_tracker_purge_invalid_heap_files (THREAD_ENTRY * thread_p);
extern int file_tracker_purge_target_file (THREAD_ENTRY * thread_p, const char *target_vfid_str);
