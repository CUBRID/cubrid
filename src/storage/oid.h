...
enum
{
  ...
  OID_CACHE_PACKAGE_CLASS_ID,
  OID_CACHE_PACKAGE_CODE_CLASS_ID,
  OID_CACHE_PACKAGE_VAR_CLASS_ID,
  OID_CACHE_PACKAGE_EXCEPTION_CLASS_ID,
  OID_CACHE_PACKAGE_CURSOR_CLASS_ID,
  OID_CACHE_PACKAGE_PROCEDURE_CLASS_ID,
  OID_CACHE_PACKAGE_RECORD_TYPE_CLASS_ID,
