...
static VPID *overflow_insert_internal (THREAD_ENTRY * thread_p, const VFID * ovf_vfid, VPID * ovf_vpid, RECDES * recdes,
				       OVERFLOW_LOGGING_TYPE logging_type, int *ovf_first_page, OID * mvcc_delete_oid);
/*
