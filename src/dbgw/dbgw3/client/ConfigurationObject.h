...
namespace dbgw
{
  ...
  class _ConfigurationObject
  {
  public:
    _ConfigurationObject(Configuration *pConfiguration);
    _ConfigurationObject(const _ConfigurationObject *pResource);
    virtual ~_ConfigurationObject();
