 ...
 * every match in O(n1 + n2) (PostgreSQL's eqjoinsel_inner does the same match with
 * a nested loop).
 */
template <typename T>
static void
 ...
 *   histograms, following PostgreSQL selfuncs.c eqjoinsel_inner.
 *
 ...
 *   formula degenerates to PG's no-MCV estimate:
