...
qo_validate_index_for_vector_index (QO_ENV * env, QO_NODE_INDEX_ENTRY * ni_entryp)
{
  ...
  // check arg1 and arg2
  {
    ...
    if (arg1->node_type == PT_NAME && (arg2->node_type == PT_VALUE || arg2->node_type == PT_HOST_VAR))
      {
        // ok
      }
    else if ((arg1->node_type == PT_VALUE || arg1->node_type == PT_HOST_VAR) && (arg2->node_type == PT_NAME))
      {
        // ok
      }
    else
