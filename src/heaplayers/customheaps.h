...
extern unsigned int hl_register_lea_heap ();
extern void hl_unregister_lea_heap (unsigned int heap_id);
extern void *hl_lea_alloc (unsigned int heap_id, size_t sz);
extern void *hl_lea_realloc (unsigned int heap_id, void *ptr,
				     size_t sz);
extern void hl_lea_free (unsigned int heap_id, void *ptr);
extern void hl_clear_lea_heap (unsigned int heap_id);
