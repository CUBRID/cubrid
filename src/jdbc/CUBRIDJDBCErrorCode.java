...
public static String[] err_msg =
	{
	  ...
	  /**
	   * 5
	   * 지원되지 않은 interface가 호출되었을 때 출력된다.
	   */
	  ...
	  /**
	   * 6
	   * Connection.setTransactionLevel(int level)에서
	   * 지원되지 않는 값이 넘어왔을 때 출력된다.
	   */
	  ...
	  /**
	   * 7
	   * CUBRIDDriver.connect(...)에서
	   * url을 parsing할 수 없을 때 출력된다.
	   */
	  "invalid URL",
	   ...
	   * 8
	   * CUBRIDDriver.connect(...)에서
	   * Database name이 주어지지 않았을 때 출력된다.
	   * Database name에는 default value가 없기 때문이다.
	   */
	  ...
	  /**
	   * 9
	   * Statement.executeQuery()에서
	   * update query가 넘어왔을 때 출력된다.
	   */
	  ...
	  /**
	   * 10
	   * Statement.executeUpdate()에서
	   * select query가 넘어왔을 때 출력된다.
	   */
	  ...
	  /**
	   * 11
	   * PreparedStatement.setAsciiStream(int, InputStream, int length)와
	  ...
	  /**
	   * 12
	   * PreparedStatement.setAsciiStream(int, InputStream x, int)와
	  ...
	  /**
	   * 13
	   * deprecated되어 지원되지 않는 interface가 호울되면 출력된다.
	   */
	  ...
	  /**
	   * 14
	   * PreparedStatement.setObject(int, Object x, int, int)에서
	   * x가 java.lang.Number class의 subclass가 아니면 출력된다.
	   */
	   ...
	   * 17
	   * ResultSet에서
	   * cursor가 before first나 after last인 경우
	   * 부적절한 함수가 호출되면 출력된다.
	   */
	  ...
	  /**
	   * 18
	   * CUBRIDResultSetWithoutQuery에서
	   * DB 값을 user가 요구하는 Java type으로 전환할 수 없을 때 출력된다.
	   */
	  ...
	  /**
	   * 19
	   * CUBRIDResultSetWithoutQuery.addTuple( Object[] tuple )에서
	  ...
	  /**
	   * 20
	   * max field size나 max rows나 query timeout등의 값이 잘못 넘어올 때 출력된다.
	   */
	  ...
	  /**
	   * 21
	   * CUBRIDResultSetMetaData에서 COLLECTION type이 아닌 column에 대해서
	  ...
	  /**
	   * 23
	   * Scrollable하지 않은 ResultSet의 Scrollability관련 메소드 호출시
	   */
	  ...
	  /**
	   * 27
	   * Statement.executeInsert()에서
	   * insert query가 아닐 때 출력된다.
	   */
	  ...
	  /**
	   * 29
	   * 비어 있는 InputStream을 argument로 받았을 때 발생한다.
	   */
	  ...
	  /**
	   * 30
	   * 비어 있는 Reader argument로 받았을 때 발생한다.
	   */
	  ...
	  /**
	   * 32
	   * TYPE_FORWARD_ONLY Statement의 setFetchDirection() 함수가 호출될 때 발생
	   */
...
}  // end of class CUBRIDJDBCErrorCode
