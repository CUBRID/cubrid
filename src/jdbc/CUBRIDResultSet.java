...
protected CUBRIDResultSet(CUBRIDConnection c, CUBRIDStatement s, int t, int concur) throws SQLException
{
  con = c;
  stmt = s;
  u_stmt = s.u_stmt;
...
public synchronized void insertRow() throws SQLException
{
  try {
	...
	t_u_stmt.execute(false, 0, 0, false, false, false, false, false, null);
...
/**
 * Returns a <code>CUBRIDOID</code> object that represents the OID
 * of the current cursor.
 *
 * @return the <code>CUBRIDOID</code> object of the current cursor if OID is included,
 * <code>null</code> otherwise.
 * @exception SQLException if <code>this</code> object is closed.
 * @exception SQLException if the current cursor is on beforeFirst, afterLast
 * or the insert row
