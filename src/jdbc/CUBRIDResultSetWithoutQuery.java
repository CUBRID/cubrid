...
CUBRIDResultSetWithoutQuery(int columns, int[] types, String[] colnames, boolean[] isnull)
{
...
public synchronized String getString(int columnIndex) throws SQLException
{
  ...
  try {
	  return UGetTypeConvertedValue.getString(((Object[])rows.get(current_row))[columnIndex-1]);
  }
  catch (Exception e) {
...
public synchronized boolean getBoolean(int columnIndex) throws SQLException
{
  ...
  try {
    return UGetTypeConvertedValue.getBoolean(((Object[])rows.get(current_row))[columnIndex-1]);
  }
  catch (Exception e) {
    throw new CUBRIDException(CUBRIDJDBCErrorCode.conversion_error);
  }
...
public synchronized byte getByte(int columnIndex) throws SQLException
{
  ...
  try {
    return UGetTypeConvertedValue.getByte(((Object[])rows.get(current_row))[columnIndex-1]);
  }
  catch (Exception e) {
    throw new CUBRIDException(CUBRIDJDBCErrorCode.conversion_error);
  }
...
public synchronized short getShort(int columnIndex) throws SQLException
{
  ...
  try {
    return UGetTypeConvertedValue.getShort(((Object[])rows.get(current_row))[columnIndex-1]);
  }
  catch (Exception e) {
    throw new CUBRIDException(CUBRIDJDBCErrorCode.conversion_error);
  }
...
public synchronized int getInt(int columnIndex) throws SQLException
{
  ...
  try {
    return UGetTypeConvertedValue.getInt(((Object[])rows.get(current_row))[columnIndex-1]);
  }
  catch (Exception e) {
    throw new CUBRIDException(CUBRIDJDBCErrorCode.conversion_error);
  }
...
public synchronized long getLong(int columnIndex) throws SQLException
{
  ...
  try {
    return UGetTypeConvertedValue.getLong(((Object[])rows.get(current_row))[columnIndex-1]);
  }
  catch (Exception e) {
    throw new CUBRIDException(CUBRIDJDBCErrorCode.conversion_error);
  }
...
public synchronized float getFloat(int columnIndex) throws SQLException
{
  ...
  try {
    return UGetTypeConvertedValue.getFloat(((Object[])rows.get(current_row))[columnIndex-1]);
  }
  catch (Exception e) {
    throw new CUBRIDException(CUBRIDJDBCErrorCode.conversion_error);
  }
...
public synchronized double getDouble(int columnIndex) throws SQLException
{
  ...
  try {
    return UGetTypeConvertedValue.getDouble(((Object[])rows.get(current_row))[columnIndex-1]);
  }
  catch (Exception e) {
    throw new CUBRIDException(CUBRIDJDBCErrorCode.conversion_error);
  }
...
public synchronized byte[] getBytes(int columnIndex) throws SQLException
{
  ...
  try {
	  return UGetTypeConvertedValue.getBytes(((Object[])rows.get(current_row))[columnIndex-1]);
  }
  catch (Exception e) {
	  throw new CUBRIDException(CUBRIDJDBCErrorCode.conversion_error);
  }
...
public synchronized Date getDate(int columnIndex) throws SQLException
{
  ...
  try {
    return UGetTypeConvertedValue.getDate(((Object[])rows.get(current_row))[columnIndex-1]);
  }
  catch (Exception e) {
    throw new CUBRIDException(CUBRIDJDBCErrorCode.conversion_error);
  }
...
public synchronized Time getTime(int columnIndex) throws SQLException
{
  ...
  try {
    return UGetTypeConvertedValue.getTime(((Object[])rows.get(current_row))[columnIndex-1]);
  }
  catch (Exception e) {
    throw new CUBRIDException(CUBRIDJDBCErrorCode.conversion_error);
  }
...
public synchronized Timestamp getTimestamp(int columnIndex) throws SQLException
{
  ...
  try {
    return UGetTypeConvertedValue.getTimestamp(((Object[])rows.get(current_row))[columnIndex-1]);
  }
  catch (Exception e) {
    throw new CUBRIDException(CUBRIDJDBCErrorCode.conversion_error);
  }
	...
	throws SQLException
{
  ...
  try {
    return UGetTypeConvertedValue.getBigDecimal(((Object[])rows.get(current_row))[columnIndex-1]);
  }
  catch (Exception e) {
    throw new CUBRIDException(CUBRIDJDBCErrorCode.conversion_error);
  }
...
}  // end of class CUBRIDResultSetWithoutQuery
