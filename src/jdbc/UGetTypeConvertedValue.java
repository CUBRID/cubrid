...
/**
* class Object의 instance를 parameter로 받아 jdbc에서 getXXX method를 통해
* type converting이 가능하다고 정의된 type으로 parameter를 convert하여 return하여
* 주는 class이다. 만약 type conversion이 불가능한 object가 parameter로써
* 넘어올 경우 Exception을 throw한다.
*
* since 1.0
*/
 ...
 * Conversion가능한 instance type
 * BigDecimal, String, Byte, Boolean, Short, Integer, Double, Float
 */

static public BigDecimal getBigDecimal(Object data)
 ...
 * Conversion가능한 instance type
 * Boolean, String, Byte, byte [], Short, Integer, Double, Float, BigDecimal
 */

static public boolean getBoolean(Object data)
	throws UJciException
{
  if (data == null)
    return false;
 ...
 * Conversion가능한 instance type
 * Byte, String, Boolean, Short, Integer, Double, Float, BigDecimal
 */

static public byte getByte(Object data)
	throws UJciException
{
  if (data == null)
    return (byte) 0;
 ...
 * Conversion가능한 instance type
 * Double, String, Byte, Boolean, Short, Integer, Float, BigDecimal
 */
 
static public double getDouble(Object data)
	throws UJciException
{
  if (data == null)
    return (double) 0;
...
/*
 * parameter data를 float type으로 conversion하여 return한다.
 * Conversion가능한 instance type
 * Float, String, Byte, Boolean, Short, Integer, Double, BigDecimal
 */

static public float getFloat(Object data)
	throws UJciException
{
  if (data == null)
    return (float) 0;
...
/*
 * parameter data를 int type으로 conversion하여 return한다.
 * Conversion가능한 instance type
 * Integer, String, Byte, Boolean, Short, Double, Float, BigDecimal
 */

static public int getInt(Object data)
	throws UJciException
{
  if (data == null)
    return 0;
...
/*
 * parameter data를 long type으로 conversion하여 return한다.
 *   Conversion가능한 instance type
 *   String, Byte, Boolean, Short, Integer, Double, Float, BigDecimal
 */
 
static public long getLong(Object data)
	throws UJciException
{
  if (data == null)
    return (long) 0;
...
/*
 * parameter data를 short type으로 conversion하여 return한다.
 *   Conversion가능한 instance type
 *   Short, String, Byte, Boolean, Integer, Double, Float, BigDecimal
 */

static public short getShort(Object data)
	throws UJciException
{
  if (data == null)
    return (short) 0;
...
static public String getString(Object data)
	throws UJciException
{
  if (data == null)
    return null;
...
static private String getBinaryDecimalString(int precision, byte[] data)
{
  ...
  for(int i=0 ; i< data.length ; i++){
    ...
    aByteString="";
    for(int j=0 ; j<8 ; j++){
      aByteString = String.valueOf(temp%2) + aByteString;
      temp /= 2;
    }
    stringData += aByteString;
  }
  return stringData.substring(0, precision);
}
*/

}  // end of class UGetTypeConvertedValue
