...
extern void css_read_remaining_bytes (CSS_CONN_ENTRY *conn, int len);

extern int css_net_recv (CSS_CONN_ENTRY *conn, char *buffer, int *maxlen, int timeout);
...
extern int css_net_read_header (CSS_CONN_ENTRY *conn, char *buffer, int *maxlen, int timeout);
...
class connection_support:public connection_list_cl
{
  public:
    ...
    int css_send_request_with_data_buffer (CSS_CONN_ENTRY *conn, int request, unsigned short *rid,
					   const char *arg_buffer, int arg_buffer_size, char *data_buffer,
					   int data_buffer_size);
    int css_send_request_with_data_buffer_with_padding (CSS_CONN_ENTRY *conn, int request, unsigned short *rid,
	const char *arg_buffer, int arg_buffer_size, char *data_buffer,
	int data_buffer_size);

    int css_send_data_with_padding (CSS_CONN_ENTRY *conn, unsigned short rid, const char *buffer, int buffer_size);
    int css_send_error_with_padding (CSS_CONN_ENTRY *conn, unsigned short rid, const char *buffer, int buffer_size);


    int css_send_request (CSS_CONN_ENTRY *conn, int request, unsigned short *request_id, const char *arg_buffer,
			  int arg_buffer_size);

    int css_send_request_no_reply (CSS_CONN_ENTRY *conn, int request, unsigned short *request_id, char *arg_buffer,
				   int arg_size);
    int css_send_req_with_2_buffers (CSS_CONN_ENTRY *conn, int request, unsigned short *request_id,
				     char *arg_buffer, int arg_size, char *data_buffer, int data_size,
				     char *reply_buffer, int reply_size);
    int css_send_req_with_3_buffers (CSS_CONN_ENTRY *conn, int request, unsigned short *request_id,
...
#if 0
    int css_send_req_with_large_buffer (CSS_CONN_ENTRY *conn, int request, unsigned short *request_id,
