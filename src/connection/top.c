 ...
 *
 * top.c - higher level of interface routines to the client
 *
 * Note:
 * We provide a "connectionless" interface, which allows us to open or close
 * connections as required. We do this by queuing connections to the host and
