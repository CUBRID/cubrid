...
static STATDUMP_PROP statdump_offset[] = {
  ...
  {"Num_btree_copy_leaf_nolatch_success", offsetof (T_CM_DB_EXEC_STAT, bt_copy_leaf_nolatch_success_cnt)},
  {"Num_btree_copy_leaf_nolatch_fails", offsetof (T_CM_DB_EXEC_STAT, bt_copy_leaf_nolatch_fails_cnt)},
  {"Num_btree_copy_leaf_nolatch_retries", offsetof (T_CM_DB_EXEC_STAT, bt_copy_leaf_nolatch_retries_cnt)},
  {"Num_btree_acquire_tran_bcb_area_success", offsetof (T_CM_DB_EXEC_STAT, bt_acquire_tran_bcb_area_success_cnt)},
  {"Num_btree_acquire_tran_bcb_area_fails", offsetof (T_CM_DB_EXEC_STAT, bt_acquire_tran_bcb_area_fails_cnt)},
  ...
  {"Num_heap_copy_nolatch_success", offsetof (T_CM_DB_EXEC_STAT, heap_copy_nolatch_success_cnt)},
  {"Num_heap_copy_nolatch_retries", offsetof (T_CM_DB_EXEC_STAT, heap_copy_nolatch_retries_cnt)},
  {"Num_heap_copy_nolatch_fails", offsetof (T_CM_DB_EXEC_STAT, heap_copy_nolatch_fails_cnt)},
  {"Num_heap_acquire_tran_bcb_area_success", offsetof (T_CM_DB_EXEC_STAT, heap_acquire_tran_bcb_area_success_cnt)},
  {"Num_heap_acquire_tran_bcb_area_fails", offsetof (T_CM_DB_EXEC_STAT, heap_acquire_tran_bcb_area_success_fails_cnt)},
