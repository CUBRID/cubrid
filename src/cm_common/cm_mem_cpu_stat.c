...
static STATDUMP_PROP statdump_offset[] = {
  ...
  {"Num_file_page_allocs",
   offsetof (T_CM_DB_EXEC_STAT, file_num_page_allocs)},
  {"Num_file_page_deallocs",
   offsetof (T_CM_DB_EXEC_STAT, file_num_page_deallocs)},
  ...
  {"Num_data_page_hash_anchor_waits",
   offsetof (T_CM_DB_EXEC_STAT, pb_num_hash_anchor_waits)},
  {"Time_data_page_hash_anchor_wait",
   offsetof (T_CM_DB_EXEC_STAT, pb_time_hash_anchor_wait)},
  {"Num_data_page_fixed",
   offsetof (T_CM_DB_EXEC_STAT, pb_fixed_cnt)},
  {"Num_data_page_dirty",
   offsetof (T_CM_DB_EXEC_STAT, pb_dirty_cnt)},
  {"Num_data_page_lru1",
   offsetof (T_CM_DB_EXEC_STAT, pb_lru1_cnt)},
  {"Num_data_page_lru2",
   offsetof (T_CM_DB_EXEC_STAT, pb_lru2_cnt)},
  {"Num_data_page_ain",
   offsetof (T_CM_DB_EXEC_STAT, pb_ain_cnt)},
  {"Num_data_page_avoid_dealloc",
   offsetof (T_CM_DB_EXEC_STAT, pb_avoid_dealloc_cnt)},
  {"Num_data_page_avoid_victim",
   offsetof (T_CM_DB_EXEC_STAT, pb_avoid_victim_cnt)},
  ...
  {"Num_vacuum_prefetch_requests_log_pages",
   offsetof (T_CM_DB_EXEC_STAT, vac_num_prefetch_requests_log_pages)},
  {"Num_vacuum_prefetch_hits_log_pages",
   offsetof (T_CM_DB_EXEC_STAT, vac_num_prefetch_hits_log_pages)},
  ...
  {"Num_heap_assign_inserts",
   offsetof (T_CM_DB_EXEC_STAT, heap_assign_inserts)},
  {"Num_heap_home_deletes", offsetof (T_CM_DB_EXEC_STAT, heap_home_deletes)},
  {"Num_heap_home_mvcc_deletes",
   offsetof (T_CM_DB_EXEC_STAT, heap_home_mvcc_deletes)},
  {"Num_heap_home_to_rel_deletes",
   offsetof (T_CM_DB_EXEC_STAT, heap_home_to_rel_deletes)},
  {"Num_heap_home_to_big_deletes",
   offsetof (T_CM_DB_EXEC_STAT, heap_home_to_big_deletes)},
  {"Num_heap_rel_deletes", offsetof (T_CM_DB_EXEC_STAT, heap_rel_deletes)},
  {"Num_heap_rel_mvcc_deletes",
   offsetof (T_CM_DB_EXEC_STAT, heap_rel_mvcc_deletes)},
  {"Num_heap_rel_to_home_deletes",
   offsetof (T_CM_DB_EXEC_STAT, heap_rel_to_home_deletes)},
  {"Num_heap_rel_to_big_deletes",
   offsetof (T_CM_DB_EXEC_STAT, heap_rel_to_big_deletes)},
  {"Num_heap_rel_to_rel_deletes",
   offsetof (T_CM_DB_EXEC_STAT, heap_rel_to_rel_deletes)},
  {"Num_heap_big_deletes", offsetof (T_CM_DB_EXEC_STAT, heap_big_deletes)},
  {"Num_heap_big_mvcc_deletes",
   offsetof (T_CM_DB_EXEC_STAT, heap_big_mvcc_deletes)},
  {"Num_heap_new_ver_inserts",
   offsetof (T_CM_DB_EXEC_STAT, heap_new_ver_inserts)},
  {"Num_heap_home_updates", offsetof (T_CM_DB_EXEC_STAT, heap_home_updates)},
  {"Num_heap_home_to_rel_updates",
   offsetof (T_CM_DB_EXEC_STAT, heap_home_to_rel_updates)},
  {"Num_heap_home_to_big_updates",
   offsetof (T_CM_DB_EXEC_STAT, heap_home_to_big_updates)},
  {"Num_heap_rel_updates", offsetof (T_CM_DB_EXEC_STAT, heap_rel_updates)},
  {"Num_heap_rel_to_home_updates",
   offsetof (T_CM_DB_EXEC_STAT, heap_rel_to_home_updates)},
  {"Num_heap_rel_to_rel_updates",
   offsetof (T_CM_DB_EXEC_STAT, heap_rel_to_rel_updates)},
  {"Num_heap_rel_to_big_updates",
   offsetof (T_CM_DB_EXEC_STAT, heap_rel_to_big_updates)},
  ...
  {"Num_heap_insid_vacuums",
   offsetof (T_CM_DB_EXEC_STAT, heap_insid_vacuums)},
  {"Num_heap_remove_vacuums",
   offsetof (T_CM_DB_EXEC_STAT, heap_remove_vacuums)},
  {"Num_heap_next_ver_vacuums",
   offsetof (T_CM_DB_EXEC_STAT, heap_next_ver_vacuums)},
  {"Time_heap_insert_prepare",
   offsetof (T_CM_DB_EXEC_STAT, heap_insert_prepare)},
  {"Time_heap_insert_execute",
   offsetof (T_CM_DB_EXEC_STAT, heap_insert_execute)},
  {"Time_heap_insert_log", offsetof (T_CM_DB_EXEC_STAT, heap_insert_log)},
  {"Time_heap_delete_prepare",
   offsetof (T_CM_DB_EXEC_STAT, heap_delete_prepare)},
  {"Time_heap_delete_execute",
   offsetof (T_CM_DB_EXEC_STAT, heap_delete_execute)},
  {"Time_heap_delete_log", offsetof (T_CM_DB_EXEC_STAT, heap_delete_log)},
  {"Time_heap_update_prepare",
   offsetof (T_CM_DB_EXEC_STAT, heap_update_prepare)},
  {"Time_heap_update_execute",
   offsetof (T_CM_DB_EXEC_STAT, heap_update_execute)},
  {"Time_heap_update_log", offsetof (T_CM_DB_EXEC_STAT, heap_update_log)},
  {"Time_heap_vacuum_prepare",
   offsetof (T_CM_DB_EXEC_STAT, heap_vacuum_prepare)},
  {"Time_heap_vacuum_execute",
   offsetof (T_CM_DB_EXEC_STAT, heap_vacuum_execute)},
  ...
  {"Num_bt_undo_mvcc_delete",
   offsetof (T_CM_DB_EXEC_STAT, bt_undo_mvcc_delete_cnt)},
  {"Num_bt_undo_update_sk",
   offsetof (T_CM_DB_EXEC_STAT, bt_undo_update_sk_cnt)},
  ...
  {"Num_bt_vacuum_update_sk",
   offsetof (T_CM_DB_EXEC_STAT, bt_vacuum_update_sk_cnt)},
  {"Num_bt_fix_ovf_oids", offsetof (T_CM_DB_EXEC_STAT, bt_fix_ovf_oids_cnt)},
  {"Num_bt_unique_rlocks",
   offsetof (T_CM_DB_EXEC_STAT, bt_unique_rlocks_cnt)},
  {"Num_bt_unique_wlocks",
   offsetof (T_CM_DB_EXEC_STAT, bt_unique_wlocks_cnt)},
  ...
  {"Time_bt_undo_mvcc_delete",
   offsetof (T_CM_DB_EXEC_STAT, bt_undo_mvcc_delete)},
  ...
  {"Time_bt_vacuum_update_sk",
   offsetof (T_CM_DB_EXEC_STAT, bt_vacuum_update_sk)},
  {"Time_bt_traverse", offsetof (T_CM_DB_EXEC_STAT, bt_traverse)},
  {"Time_bt_find_unique_traverse",
   offsetof (T_CM_DB_EXEC_STAT, bt_find_unique_traverse)},
  {"Time_bt_range_search_traverse",
   offsetof (T_CM_DB_EXEC_STAT, bt_range_search_traverse)},
  {"Time_bt_insert_traverse",
   offsetof (T_CM_DB_EXEC_STAT, bt_insert_traverse)},
  {"Time_bt_delete_traverse",
   offsetof (T_CM_DB_EXEC_STAT, bt_delete_traverse)},
  {"Time_bt_mvcc_delete_traverse",
   offsetof (T_CM_DB_EXEC_STAT, bt_mvcc_delete_traverse)},
  {"Time_bt_mark_delete_traverse",
   offsetof (T_CM_DB_EXEC_STAT, bt_mark_delete_traverse)},
  {"Time_bt_update_sk_traverse",
   offsetof (T_CM_DB_EXEC_STAT, bt_update_sk_traverse)},
  {"Time_bt_undo_insert_traverse",
   offsetof (T_CM_DB_EXEC_STAT, bt_undo_insert_traverse)},
  {"Time_bt_undo_delete_traverse",
   offsetof (T_CM_DB_EXEC_STAT, bt_undo_delete_traverse)},
  {"Time_bt_undo_mvcc_delete_traverse",
   offsetof (T_CM_DB_EXEC_STAT, bt_undo_mvcc_delete_traverse)},
  {"Time_bt_undo_update_sk_traverse",
   offsetof (T_CM_DB_EXEC_STAT, bt_undo_update_sk_traverse)},
  {"Time_bt_vacuum_traverse",
   offsetof (T_CM_DB_EXEC_STAT, bt_vacuum_traverse)},
  {"Time_bt_vacuum_insid_traverse",
   offsetof (T_CM_DB_EXEC_STAT, bt_vacuum_insid_traverse)},
  {"Time_bt_vacuum_update_sk_traverse",
   offsetof (T_CM_DB_EXEC_STAT, bt_vacuum_update_sk_traverse)},
  ...
  {"Time_vac_master",
   offsetof (T_CM_DB_EXEC_STAT, vac_master)},
  {"Time_vac_worker_process_log",
   offsetof (T_CM_DB_EXEC_STAT, vac_worker_process_log)},
  {"Time_vac_worker_execute",
   offsetof (T_CM_DB_EXEC_STAT, vac_worker_execute)},
