 ...
 *
 * The message catalog file should be generated by gencat utility.
 *
 * The message catalog format is similar to the format used by POSIX.
...
#define MSGCAT_GENERAL_RELEASE_NAME     4
