...
/* CUBRID local changes: comment out the #include "config-int.h", and include
 * the C99 <stdint.h> header instead. For Visual C++, which is missing this header,
 * manually define uint32_t (which appears to be the only type used from that header).
 */
...
/* CLASSPATH LOCAL */
/* cubrid local changes: comment out the #include "namespace.h",
 * the included file is generated and is found to be empty */
/* #include "namespace.h" */
