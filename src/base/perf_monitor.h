...
typedef enum
{
  ...
  PSTAT_TRANSACTION_TOTAL_SLOTS,
  PSTAT_TRANSACTION_TARGET_SLOTS,
  PSTAT_TRANSACTION_BUSY_SLOTS,
  PSTAT_TRANSACTION_TOTAL_WORKERS,
  PSTAT_TRANSACTION_TARGET_WORKERS,
  PSTAT_TRANSACTION_BUSY_WORKERS,
