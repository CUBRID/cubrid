...
typedef enum
{
  ...
  PERFMON_ACTIVATION_FLAG_LOG_RECOVERY_REDO = 0x00000100,

  /* must update when adding new conditions */
  PERFMON_ACTIVATION_FLAG_LAST = PERFMON_ACTIVATION_FLAG_LOG_RECOVERY_REDO,
...
typedef enum
{
  ...
  PSTAT_RV_MAIN_FETCH_PAGE,
  PSTAT_RV_MAIN_READ_LOG,
  //PSTAT_RV_MAIN_REDO_OR_PUSH,
  PSTAT_RV_MAIN_REDO_OR_PUSH_PREP,
  PSTAT_RV_MAIN_REDO_OR_PUSH_WAIT_IDLE,
  PSTAT_RV_MAIN_REDO_OR_PUSH_SYNC,
  PSTAT_RV_MAIN_REDO_OR_PUSH_ASYNC,
