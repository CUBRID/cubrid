...
typedef enum
{
  ...
  PSTAT_PB_VICTIM_ASSIGN_DIRECT_VOID,
  PSTAT_PB_VICTIM_ASSIGN_DIRECT_LRU2,
  ...
  PSTAT_PB_VICTIM_LRU_GOOD_HINT,
  PSTAT_PB_VICTIM_LRU_NO_HINT,
  ...
  PSTAT_PB_VICTIMIZE_BCB,
  PSTAT_PB_VICTIMIZE_BCB_FAIL,
  ...
  PSTAT_PB_UNFIX_LRU_TWO_KEEP,
  PSTAT_PB_UNFIX_LRU_TWO_TO_TOP,
  ...
  PSTAT_PB_UNFIX_LRU_TWO_OWN_PRV_TO_MID_VAC,
