...
typedef enum
{
  ...
  PSTAT_PB_FLUSH_COLLECT_AIN,
  PSTAT_PB_FLUSH_COLLECT_ALL_LRU,
  PSTAT_PB_FLUSH_COLLECT_ONE_LRU,

  /* allocate and victim assignments */
  PSTAT_PB_ALLOC_BCB,
  PSTAT_PB_ALLOC_BCB_COND_WAIT_HAS_WAITERS,
  PSTAT_PB_ALLOC_BCB_COND_WAIT_HAS_LATCH,
  PSTAT_PB_ALLOC_BCB_COND_WAIT_NO_LATCH,
  PSTAT_PB_ALLOC_BCB_PRIORITIZE_VACUUM,
  PSTAT_PB_ALLOC_BCB_PENALIZE,
  PSTAT_PB_VICTIM_USE_INVALID_BCB,
  /* direct assignments */
  PSTAT_PB_VICTIM_ASSIGN_DIRECT_VACUUM,
  ...
  PSTAT_PB_VICTIM_AIN_SUCCESS,
  /* failed searches */
  PSTAT_PB_VICTIM_SHARED_LRU_FAIL,
  PSTAT_PB_VICTIM_OWN_PRIVATE_LRU_FAIL,
  PSTAT_PB_VICTIM_OTHER_PRIVATE_LRU_FAIL,
  PSTAT_PB_VICTIM_ALL_LRU_FAIL,   /* todo: remove me */
  PSTAT_PB_VICTIM_AIN_FAIL,

  /* search lru's */
  PSTAT_PB_VICTIM_LRU_END_ZONE_2,
  PSTAT_PB_VICTIM_LRU_BAD_HINT,
  PSTAT_PB_VICTIM_LRU_HINT_BOTTOM,
  PSTAT_PB_VICTIM_LRU_ADVANCE_HINT,
  PSTAT_PB_VICTIM_LRU_NULL_HINT,
  PSTAT_PB_VICTIM_LRU_ADVANCE_HINT_WITH_VICTIM,
  PSTAT_PB_VICTIM_LRU_NULL_HINT_WITH_VICTIM,
  PSTAT_PB_VICTIM_LRU_ADD_VICTIM_KEEP_HINT,
  PSTAT_PB_VICTIM_LRU_ADD_VICTIM_CHANGE_HINT,
  PSTAT_PB_VICTIM_LRU_REM_VICTIM_NULL_HINT,
  PSTAT_PB_VICTIM_LRU_REM_VICTIM_ADVANCE_HINT,
  PSTAT_PB_VICTIM_LRU_REM_BCB_NULL_HINT,
  PSTAT_PB_VICTIM_LRU_REM_BCB_ADVANCE_HINT,
  PSTAT_PB_VICTIM_LRU_SUCCESS_DIRTY_CNT,
  PSTAT_PB_VICTIM_LRU_SUCCESS_SEARCH_CNT,
  PSTAT_PB_VICTIM_LRU_FAIL_DIRTY_CNT,
  PSTAT_PB_VICTIM_LRU_FAIL_SEARCH_CNT,
  PSTAT_PB_VICTIM_LRU_TRYLOCK_FAILED,
  PSTAT_PB_VICTIM_LRU_TRYLOCK_SUCCESS_NOT_VICT,
  PSTAT_PB_VICTIM_LRU_EARLY_OUT_EMPTY,
  PSTAT_PB_VICTIM_LRU_EARLY_OUT_NO_VICT_CAND,
  PSTAT_PB_VICTIM_LRU_EARLY_OUT_NULL_HINT,
  PSTAT_PB_VICTIM_LRU_EARLY_OUT_SKIP_VICTIM,

  PSTAT_PB_VICTIM_LRU_INVALIDATE_CANDIDATE,

  PSTAT_PB_VICTIM_LRU_INC_PRIVATE_IDX,
  PSTAT_PB_VICTIM_LRU_INC_PRIVATE_SUCCESS,
  PSTAT_PB_VICTIM_LRU_INC_PRIVATE_FAIL,
  PSTAT_PB_VICTIM_LRU_INC_PRIVATE_LOOPS,
  PSTAT_PB_VICTIM_LRU_INC_SHARED_IDX,
  PSTAT_PB_VICTIM_LRU_INC_SHARED_SUCCESS,
  PSTAT_PB_VICTIM_LRU_INC_SHARED_FAIL,
  PSTAT_PB_VICTIM_LRU_INC_SHARED_LOOPS,
  ...
  PSTAT_PB_NUM_FLUSH_ERROR,
  PSTAT_PB_FLUSH_FORCE_LOG_FLUSH,
  PSTAT_PB_COMPENSATE_FLUSH,
  PSTAT_PB_NUM_COMPENSTATE_FLUSH,
  ...
  PSTAT_PB_UNFIX_VOID_TO_PRIVATE_MID_VAC,
  PSTAT_PB_UNFIX_LRU_ONE_KEEP_VAC,
  PSTAT_PB_UNFIX_LRU_TWO_KEEP_VAC,
  PSTAT_PB_UNFIX_LRU_THREE_KEEP_VAC,

  PSTAT_PB_LFCQ_LRU_PRV_ADD_ADJUST_QUOTA,
  PSTAT_PB_LFCQ_LRU_PRV_ADD_ADD_VICTIM,
  PSTAT_PB_LFCQ_LRU_PRV_GET_READD,
  PSTAT_PB_LFCQ_LRU_PRV_GET_DONT_ADD,
  PSTAT_PB_LFCQ_LRU_PRV_GET_CALLS,
  PSTAT_PB_LFCQ_LRU_PRV_GET_EMPTY,

  PSTAT_PB_LFCQ_LRU_SHR_ADD_ADJUST_QUOTA,
  PSTAT_PB_LFCQ_LRU_SHR_ADD_ADD_VICTIM,
  PSTAT_PB_LFCQ_LRU_SHR_GET_READD,
  PSTAT_PB_LFCQ_LRU_SHR_GET_DONT_ADD,
