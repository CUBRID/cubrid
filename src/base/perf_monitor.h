...
typedef enum
{
  ...
  PSTAT_REQUEST_CONCURRENCY_TOTAL,
  PSTAT_REQUEST_CONCURRENCY_TARGET,
  PSTAT_REQUEST_CONCURRENCY_BUSY,
  PSTAT_REQUEST_WORKER_TOTAL,
  PSTAT_REQUEST_WORKER_TARGET,
  PSTAT_REQUEST_WORKER_BUSY,
