...
typedef enum
{
  ...
  PSTAT_THREAD_TOTAL_SLOTS,
  PSTAT_THREAD_TARGET_SLOTS,
  PSTAT_THREAD_BUSY_SLOTS,
  PSTAT_THREAD_TOTAL_WORKERS,
  PSTAT_THREAD_TARGET_WORKERS,
  PSTAT_THREAD_BUSY_WORKERS,
