...
typedef enum
{
  ...
  /* flushed direct assignments failures. todo: remove completely before merging quota */
  PSTAT_PB_VICTIM_ASSIGN_DIRECT_FLUSH_DIRTY,
  PSTAT_PB_VICTIM_ASSIGN_DIRECT_FLUSH_FIXED,
  PSTAT_PB_VICTIM_ASSIGN_DIRECT_FLUSH_WRONG_ZONE,
  PSTAT_PB_VICTIM_ASSIGN_DIRECT_FLUSH_TO_VACUUM,
  PSTAT_PB_VICTIM_ASSIGN_DIRECT_FLUSH_PRV_UNDER_QUOTA,
  PSTAT_PB_VICTIM_ASSIGN_DIRECT_FLUSH_NO_WAITER,

  PSTAT_PB_FLUSH_SEND_FOR_DIRECT_VICTIM,
  PSTAT_PB_FLUSH_MARK_FLUSHED,
  /* successful searches */
  ...
  /* search lru's */
  PSTAT_PB_VICTIM_LRU_CALL,
  PSTAT_PB_VICTIM_LRU_SEARCH,
  ...
  PSTAT_PB_VICTIM_LRU_ADD_VICTIM_CHANGE_NULL_HINT,
  ...
  PSTAT_PB_VICTIM_LRU_SKIP_TO_VACUUM,
  PSTAT_PB_VICTIM_LRU_RESTART,
  PSTAT_PB_VICTIM_LRU_FOUND_ON_RESTART,

  PSTAT_PB_VICTIM_LRU_INVALIDATE_CANDIDATE,
  PSTAT_PB_VICTIMIZE_TO_VACUUM,
