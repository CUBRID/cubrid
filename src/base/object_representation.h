...
enum
{
  ORC_UNIQUE_NAME_INDEX = 0,
  ORC_NAME_INDEX = 1,
  ORC_LOADER_COMMANDS_INDEX = 2,
  ORC_REPRESENTATIONS_INDEX = 3,
  ORC_SUBCLASSES_INDEX = 4,
  ORC_SUPERCLASSES_INDEX = 5,
  ORC_ATTRIBUTES_INDEX = 6,
  ORC_SHARED_ATTRS_INDEX = 7,
  ORC_CLASS_ATTRS_INDEX = 8,
  ORC_METHODS_INDEX = 9,
  ORC_CLASS_METHODS_INDEX = 10,
  ORC_METHOD_FILES_INDEX = 11,
  ORC_RESOLUTIONS_INDEX = 12,
  ORC_QUERY_SPEC_INDEX = 13,
  ORC_TRIGGERS_INDEX = 14,
  ORC_PROPERTIES_INDEX = 15,
  ORC_COMMENT_INDEX = 16,
  ORC_PARTITION_INDEX = 17,
