...
/* 
 * CLASS FLAGS FOR TDE ALGORITHM
 */ 
#define ORC_CLASSFLAG_ENC_MASK        0x00030000 
#define ORC_CLASSFLAG_ENC_AES_MASK    0x00010000
#define ORC_CLASSFLAG_ENC_ARIA_MASK   0x00020000

#define ORC_CLASSFLAG_ENCRYPTED(flags)      ((flags) & ORC_CLASSFLAG_ENC_MASK)
#define ORC_CLASSFLAG_ENCRYPTED_AES(flags)  ((flags) & ORC_CLASSFLAG_ENC_AES_MASK)
#define ORC_CLASSFLAG_ENCRYPTED_ARIA(flags) ((flags) & ORC_CLASSFLAG_ENC_ARIA_MASK)
