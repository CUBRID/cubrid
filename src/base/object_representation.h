...
//DB_TYPE st_hidden_type[4] = { DB_TYPE_BIGINT, DB_TYPE_INTEGER, DB_TYPE_SHORT, DB_TYPE_SHORT };
//#define HIDDEN_INDEX_COL_GET_TYPE(mode, level)  (level = 0) ? st_hidden_type[mode] :   
