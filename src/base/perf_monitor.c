...
PSTAT_METADATA pstat_Metadata[] = {
  ...
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_PB_ALLOC_BCB_COND_WAIT_HAS_WAITERS, "Num_alloc_bcb_cond_wait_has_waiters"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_PB_ALLOC_BCB_COND_WAIT_HAS_LATCH, "Num_alloc_bcb_cond_wait_has_latch"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_PB_ALLOC_BCB_COND_WAIT_NO_LATCH, "Num_alloc_bcb_cond_wait_no_latch"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_PB_VICTIM_USE_INVALID_BCB, "Num_victim_use_invalid_bcb"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_PB_VICTIM_ASSIGN_DIRECT_VOID, "Num_victim_assign_direct_void_bcb"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_PB_VICTIM_ASSIGN_DIRECT_LRU2, "Num_victim_assign_direct_lru2_bcb"),
  ...
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_PB_VICTIM_LRU_GOOD_HINT, "Num_victim_lru_good_hint"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_PB_VICTIM_LRU_NO_HINT, "Num_victim_lru_no_hint"),
  ...
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_PB_VICTIMIZE_BCB, "victimize_bcb_success"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_PB_VICTIMIZE_BCB_FAIL, "Num_victimize_bcb_fail"),
  ...
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_PB_UNFIX_LRU_TWO_KEEP, "Num_unfix_lru2_any_keep"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_PB_UNFIX_LRU_TWO_TO_TOP, "Num_unfix_lru2_any_to_top"),
  ...
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_PB_UNFIX_LRU_TWO_OWN_PRV_TO_MID_VAC, "Num_unfix_lru2_private_to_mid_vacuum"),
