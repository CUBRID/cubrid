...
PSTAT_METADATA pstat_Metadata[] = {
  ...
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_DWB_FLUSH_BLOCK_HELPER_BIG_VOLUME_CHANGES_TIME_COUNTERS,
				  "Time_DWB_flush_block_helper_big_volume_changes_time"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_DWB_FLUSH_BLOCK_HELPER_SMALL_VOLUME_CHANGES_TIME_COUNTERS,
				  "Time_DWB_flush_block_helper_small_volume_changes_time"),
