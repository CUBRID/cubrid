...
PSTAT_METADATA pstat_Metadata[] = {
  ...
  PSTAT_METADATA_INIT_COUNTER_TIMER (PSTAT_PB_VICTIM_USE_INVALID_BCB, "victim_use_invalid_bcb"),
  PSTAT_METADATA_INIT_COUNTER_TIMER (PSTAT_PB_VICTIM_SHARED_LRU_SUCCESS, "victim_shared_lru_success"),
  PSTAT_METADATA_INIT_COUNTER_TIMER (PSTAT_PB_VICTIM_SHARED_LRU_FAIL, "victim_shared_lru_fail"),
  PSTAT_METADATA_INIT_COUNTER_TIMER (PSTAT_PB_VICTIM_PRIVATE_LRU_SUCCESS, "victim_private_lru_success"),
  PSTAT_METADATA_INIT_COUNTER_TIMER (PSTAT_PB_VICTIM_PRIVATE_LRU_FAIL, "victim_private_lru_fail"),
  ...
  PSTAT_METADATA_INIT_COUNTER_TIMER (PSTAT_PB_VICTIM_ALL_LRU_FAIL, "victim_all_lru_fail"),
  ...
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_PB_NUM_FLUSH_FORCE_LOG_FLUSH, "Num_flush_force_log_flush"),
