...
PSTAT_METADATA pstat_Metadata[] = {
  ...
  /* HNSW statistics. */
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_HNSW_NUM_VISITED_NODE, "Num_hnsw_visited_node"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_HNSW_NUM_VISITED_NODE_L0, "Num_hnsw_visited_node_l0"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_HNSW_NUM_COMPUTED_DISTANCES, "Num_hnsw_computed_distances"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_HNSW_NUM_COMPUTED_DISTANCES_L0, "Num_hnsw_computed_distances_l0"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_HNSW_TIME_COMPUTED_DISTANCES_USEC, "Time_hnsw_computed_distances_usec"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_HNSW_TIME_COMPUTED_DISTANCES_USEC_L0, "Time_hnsw_computed_distances_usec_l0"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_HNSW_NUM_COMPUTED_DISTANCES_INT8, "Num_hnsw_computed_distances_int8"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_HNSW_NUM_COMPUTED_DISTANCES_INT8_L0, "Num_hnsw_computed_distances_int8_l0"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_HNSW_TIME_COMPUTED_DISTANCES_INT8_USEC, "Time_hnsw_computed_distances_int8_usec"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_HNSW_TIME_COMPUTED_DISTANCES_INT8_USEC_L0, "Time_hnsw_computed_distances_int8_usec_l0"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_HNSW_NUM_PREFILTER_CHECKED, "Num_hnsw_prefilter_checked"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_HNSW_NUM_PREFILTER_CHECKED_L0, "Num_hnsw_prefilter_checked_l0"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_HNSW_NUM_PREFILTER_PASSED_TO_FP32, "Num_hnsw_prefilter_passed_to_fp32"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_HNSW_NUM_PREFILTER_PASSED_TO_FP32_L0, "Num_hnsw_prefilter_passed_to_fp32_l0"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_HNSW_NUM_PREFILTER_REJECTED, "Num_hnsw_prefilter_rejected"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_HNSW_NUM_PREFILTER_REJECTED_L0, "Num_hnsw_prefilter_rejected_l0"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_HNSW_NUM_COMPUTED_DISTANCES_IN_REFINES,
				  "Num_hnsw_computed_distances_in_refines"),
  ...
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_HNSW_NUM_PAGE_ACCESS, "Num_hnsw_page_access"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_HNSW_NUM_PAGE_ACCESS_L0, "Num_hnsw_page_access_l0"),

  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_HNSW_NUM_VECTOR_ACCESS, "Num_hnsw_vector_access"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_HNSW_NUM_VECTOR_ACCESS_L0, "Num_hnsw_vector_access_l0"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_HNSW_NUM_VECTOR_CACHE_HIT, "Num_hnsw_vector_cache_hit"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_HNSW_NUM_VECTOR_CACHE_HIT_L0, "Num_hnsw_vector_cache_hit_l0"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_HNSW_NUM_VECTOR_CACHE_MISS, "Num_hnsw_vector_cache_miss"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_HNSW_NUM_VECTOR_CACHE_MISS_L0, "Num_hnsw_vector_cache_miss_l0"),

  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_HNSW_NUM_ENTRYPOINT_UPDATES, "Num_hnsw_entrypoint_updates"),

  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_HNSW_NUM_CANDIDATES_PUSH, "Num_hnsw_candidates_push"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_HNSW_NUM_CANDIDATES_PUSH_L0, "Num_hnsw_candidates_push_l0"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_HNSW_NUM_CANDIDATES_POP, "Num_hnsw_candidates_pop"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_HNSW_NUM_CANDIDATES_POP_L0, "Num_hnsw_candidates_pop_l0"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_HNSW_NUM_CANDIDATES_PRUNE, "Num_hnsw_candidates_prune"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_HNSW_NUM_CANDIDATES_PRUNE_L0, "Num_hnsw_candidates_prune_l0"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_HNSW_NUM_NEIGHBORS_SCAN, "Num_hnsw_neighbors_scan"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_HNSW_NUM_NEIGHBORS_SCAN_L0, "Num_hnsw_neighbors_scan_l0"),
  ...
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_HNSW_NUM_NEIGHBORS_CACHE_HIT_L0, "Num_hnsw_neighbors_cache_hit_l0"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_HNSW_NUM_NEIGHBORS_PAGE_FIX_L0, "Num_hnsw_neighbors_page_fix_l0"),
