...
PSTAT_METADATA pstat_Metadata[] = {
  ...
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_OOS_VACUUM_DELETES, "Num_oos_vacuum_deletes"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_OOS_VACUUM_FORWARD_WALK_FAILURES, "Num_oos_vacuum_forward_walk_failures"),
