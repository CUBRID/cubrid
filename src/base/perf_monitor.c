...
PSTAT_METADATA pstat_Metadata[] = {
  ...
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_BT_FIND_UNIQUE_CNT, "Num_bt_find_unique"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_BT_RANGE_SEARCH_CNT, "Num_btrange_search"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_BT_INSERT_CNT, "Num_bt_insert_obj"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_BT_DELETE_CNT, "Num_bt_delete_obj"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_BT_MVCC_DELETE_CNT, "Num_bt_mvcc_delete"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_BT_MARK_DELETE_CNT, "Num_bt_mark_delete"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_BT_UNDO_INSERT_CNT, "Num_bt_undo_insert"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_BT_UNDO_DELETE_CNT, "Num_bt_undo_delete"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_BT_UNDO_MVCC_DELETE_CNT, "Num_bt_undo_mvcc_delete"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_BT_VACUUM_CNT, "Num_bt_vacuum"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_BT_VACUUM_INSID_CNT, "Num_bt_vacuum_insid"),
  /* TODO: Move out of this block to other b-tree stats. */
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_BT_FIX_OVF_OIDS_CNT, "Num_bt_fix_ovf_oids_cnt"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_BT_UNIQUE_RLOCKS_CNT, "Num_bt_unique_rlocks_cnt"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_BT_UNIQUE_WLOCKS_CNT, "Num_bt_unique_wlocks_cnt"),

  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_BT_FIND_UNIQUE, "Time_bt_find_unique"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_BT_RANGE_SEARCH, "Time_bt_range_search"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_BT_INSERT, "Time_bt_insert"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_BT_DELETE, "Time_bt_delete"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_BT_MVCC_DELETE, "Time_bt_mvcc_delete"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_BT_MARK_DELETE, "Time_bt_mark_delete"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_BT_UNDO_INSERT, "Time_bt_undo_insert"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_BT_UNDO_DELETE, "Time_bt_undo_delete"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_BT_UNDO_MVCC_DELETE, "Time_bt_undo_mvcc_delete"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_BT_VACUUM, "Time_bt_vacuum"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_BT_VACUUM_INSID, "Time_bt_vacuum_insid"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_BT_TRAVERSE, "Time_bt_traverse"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_BT_FIND_UNIQUE_TRAVERSE, "Time_bt_find_unique_traverse"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_BT_RANGE_SEARCH_TRAVERSE, "Time_bt_range_search_traverse"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_BT_INSERT_TRAVERSE, "Time_bt_insert_traverse"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_BT_DELETE_TRAVERSE, "Time_bt_delete_traverse"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_BT_MVCC_DELETE_TRAVERSE, "Time_bt_mvcc_delete_traverse"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_BT_MARK_DELETE_TRAVERSE, "Time_bt_mark_delete_traverse"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_BT_UNDO_INSERT_TRAVERSE, "Time_bt_undo_insert_traverse"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_BT_UNDO_DELETE_TRAVERSE, "Time_bt_undo_delete_traverse"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_BT_UNDO_MVCC_DELETE_TRAVERSE, "Time_bt_undo_mvcc_delete_traverse"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_BT_VACUUM_TRAVERSE, "Time_bt_vacuum_traverse"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_BT_VACUUM_INSID_TRAVERSE, "Time_bt_vacuum_insid_traverse"),
