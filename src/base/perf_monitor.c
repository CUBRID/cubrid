...
PSTAT_METADATA pstat_Metadata[] = {
  ...
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_PB_ALLOC_BCB_LOOPS, "Num_alloc_bcb_loops"),
  ...
  /* search lru's */
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_PB_VICTIM_LRU_CALL, "Num_victim_lru_call"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_PB_VICTIM_LRU_SEARCH, "Num_victim_lru_search"),
  ...
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_PB_VICTIM_LRU_RESTART, "Num_victim_lru_restart"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_PB_VICTIM_LRU_FOUND_ON_RESTART, "Num_victim_lru_found_on_restart"),
