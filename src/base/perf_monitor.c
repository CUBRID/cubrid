...
PSTAT_METADATA pstat_Metadata[] = {
  ...
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_BT_NUM_COPY_LEAF_NOLATCH_RETRIES, "Num_btree_copy_leaf_nolatch_retries"),
  ...
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_HEAP_NUM_COPY_NOLATCH_RETRIES, "Num_heap_copy_nolatch_retries"),
