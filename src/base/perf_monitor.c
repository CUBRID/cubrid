...
PSTAT_METADATA pstat_Metadata[] = {
  ...
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_PB_VICTIM_LRU_INC_PRIVATE_SUCCESS, "Num_victim_lru_inc_shared_success"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_PB_VICTIM_LRU_INC_PRIVATE_FAIL, "Num_victim_lru_inc_shared_fail"),
