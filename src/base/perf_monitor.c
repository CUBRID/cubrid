...
PSTAT_METADATA pstat_Metadata[] = {
  ...
  PSTAT_METADATA_INIT_COUNTER_TIMER (PSTAT_RV_MAIN_FETCH_PAGE, "Log_redo_main_fetch_page_if_needed"),
  PSTAT_METADATA_INIT_COUNTER_TIMER (PSTAT_RV_MAIN_READ_LOG, "Log_redo_main_read_from_log"),
  //PSTAT_METADATA_INIT_COUNTER_TIMER (PSTAT_RV_MAIN_REDO_OR_PUSH, "Log_redo_main_do_redo_or_push"),
  PSTAT_METADATA_INIT_COUNTER_TIMER (PSTAT_RV_MAIN_REDO_OR_PUSH_PREP, "Log_redo_main_do_redo_or_push_prep"),
  PSTAT_METADATA_INIT_COUNTER_TIMER (PSTAT_RV_MAIN_REDO_OR_PUSH_WAIT_IDLE, "Log_redo_main_do_redo_or_push_wait_idle"),
  PSTAT_METADATA_INIT_COUNTER_TIMER (PSTAT_RV_MAIN_REDO_OR_PUSH_SYNC, "Log_redo_main_do_redo_or_push_sync"),
  PSTAT_METADATA_INIT_COUNTER_TIMER (PSTAT_RV_MAIN_REDO_OR_PUSH_ASYNC, "Log_redo_main_do_redo_or_push_async"),
