...
PSTAT_METADATA pstat_Metadata[] = {
  ...
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_PB_VICTIM_GARBAGE_LRU_SUCCESS, "Num_victim_garbage_lru_success"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_PB_VICTIM_GARBAGE_LRU_FAIL, "Num_victim_garbage_lru_fail"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_PB_VICTIM_PRIVATE_LRU_SUCCESS, "Num_victim_private_lru_success"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_PB_VICTIM_PRIVATE_LRU_FAIL, "Num_victim_private_lru_fail"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_PB_VICTIM_OVF_PRIVATE_LRU_SUCCESS, "Num_victim_overflow_private_lru_success"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_PB_VICTIM_OVF_PRIVATE_LRU_FAIL, "Num_victim_overflow_private_lru_fail"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_PB_VICTIM_FORCE_PRIVATE_LRU_FAIL, "Num_victim_force_private_lru_fail"),
