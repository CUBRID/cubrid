...
PSTAT_METADATA pstat_Metadata[] = {
  ...
  /* LOB (external file) statistics */
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_ELO_CREATE_FILE, "Num_elo_file_create"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_ELO_DELETE_FILE, "Num_elo_file_delete"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_ELO_COPY_FILE, "Num_elo_file_copy"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_ELO_READS, "Num_elo_reads"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_ELO_WRITES, "Num_elo_writes"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_ELO_BYTES_READ, "Num_elo_bytes_read"),
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_ELO_BYTES_WRITE, "Num_elo_bytes_write"),
