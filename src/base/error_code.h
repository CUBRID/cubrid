...
#define ER_PKG_ALREADY_EXIST                        -1370
#define ER_PKG_BODY_ALREADY_EXIST                   -1371
#define ER_PKG_NOT_EXIST                            -1372
#define ER_PKG_BODY_NOT_EXIST                       -1373
#define ER_PKG_COMPILE_ERROR                        -1374
#define ER_PKG_DDL_NOT_ALLOWED_PRIVILEGES           -1375
#define ER_PKG_DROP_NOT_ALLOWED_SYSTEM_GENERATED    -1376
#define ER_PKG_PROC_UNIQ_NAME_TOO_LONG              -1377
