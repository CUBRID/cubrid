...
#define ER_TDE_DK_SHARING_SOCK_LISTEN               -1258
#define ER_TDE_DK_SHARING_SOCK_ACCEPT               -1259
#define ER_TDE_DK_SHARING_SOCK_CONNECT              -1260
#define ER_TDE_DK_SHARING_SOCK_READ                 -1261
