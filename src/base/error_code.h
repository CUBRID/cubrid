...
#define ER_TOOL_INVALID_WITH_REMOTE_STORAGE         -1270
#define ER_COMMAND_INVALID_WITH_REMOTE_STORAGE      -1271
#define ER_NET_TRANSACTION_SERVER_CONNECTION        -1272
...
#define ER_ATOMIC_REPL_ERROR                        -1277
#define ER_DECOMPRESS_FAILED_W_DETAILS              -1278
#define ER_CONN_NO_PAGE_SERVER_AVAILABLE            -1279
