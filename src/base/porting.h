...
template < typename T > inline T interlocked_exchange_add_helper32 (volatile T * ptr, T amount, Bool2Type < true > b)
{
...
template < typename T > inline T interlocked_exchange_add_helper64 (volatile T * ptr, T amount, Bool2Type < true > b)
{
...
{
  return InterlockedCompareExchange64 (reinterpret_cast < volatile INT64 * >(ptr), static_cast < INT64 > (swap_val),
