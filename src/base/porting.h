...
/*
 * Whole-word load/store with acquire/release ordering for a 64bit trivially-copyable value, such as a struct of
 * bit-fields. ATOMIC_LOAD_64 below is integer-only and built on a read-modify-write.
 */
