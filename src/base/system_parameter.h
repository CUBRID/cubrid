...
#define SERVER_SESSION_CHKR  ((PRM_FOR_SESSION | PRM_FOR_SERVER) | PRM_CLIENT_SESSION)	// 0x00000904
#define SERVER_SESSION_MASK  ((PRM_FOR_SESSION | PRM_FOR_SERVER) & ~PRM_CLIENT_SESSION)	// 0x00000104
#define PRM_SERVER_SESSION(id)  (((GET_PRM (id))->static_flag & SERVER_SESSION_CHKR) == SERVER_SESSION_MASK)
