...
enum
{
  ...
  LANG_COLL_BINARY = 9,
  LANG_COLL_ISO_BINARY_TS = 10,
  LANG_COLL_UTF8_BINARY_TS = 11,
  LANG_COLL_ISO_EN_CS_TS = 12,
  LANG_COLL_UTF8_KO_CS_TS = 17,
  LANG_COLL_EUCKR_BINARY_TS = 18
};

#define LANG_GET_BINARY_COLLATION(c) (((c) == INTL_CODESET_UTF8) \
  ? LANG_COLL_UTF8_BINARY_TS :					 \
  (((c) == INTL_CODESET_KSC5601_EUC) ? LANG_COLL_EUCKR_BINARY_TS :  \
  (((c) == INTL_CODESET_ISO88591) ? LANG_COLL_ISO_BINARY_TS :	 \
    LANG_COLL_BINARY)))
