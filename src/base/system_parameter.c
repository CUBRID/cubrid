...
#define PRM_NAME_ER_LOG_CATCH_UP "er_log_catch_up"
...
bool PRM_ER_LOG_CATCH_UP = true;
static bool prm_er_log_catch_up_default = false;
static unsigned int prm_er_log_catch_up_flag = 0;
...
SYSPRM_PARAM prm_Def[] = {
  ...
  {PRM_ID_ER_LOG_CATCH_UP,
   PRM_NAME_ER_LOG_CATCH_UP,
   (PRM_HIDDEN | PRM_FOR_SERVER | PRM_USER_CHANGE),
   PRM_BOOLEAN,
   &prm_er_log_catch_up_flag,
   (void *) &prm_er_log_catch_up_default,
   (void *) &PRM_ER_LOG_CATCH_UP,
   (void *) NULL,
   (void *) NULL,
   (char *) NULL,
   (DUP_PRM_FUNC) NULL,
