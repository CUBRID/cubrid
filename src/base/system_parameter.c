...
#define PRM_NAME_SCAL_PERF_PS_REPL_SPAGE_COMPACT "scal_perf_ps_repl_spage_compact"
...
static unsigned int prm_scal_perf_ps_repl_spage_compact_flag = 0;
static const bool prm_scal_perf_ps_repl_spage_compact_default = false;
bool PRM_SCAL_PERF_PS_REPL_SPAGE_COMPACT_VALUE = prm_scal_perf_ps_repl_spage_compact_default;
...
SYSPRM_PARAM prm_Def[] = {
  ...
  {PRM_ID_ER_LOG_CALC_REPL_DELAY,
   PRM_NAME_ER_LOG_CALC_REPL_DELAY,
   (PRM_HIDDEN | PRM_FOR_SERVER | PRM_USER_CHANGE),
   PRM_BOOLEAN,
   &prm_er_log_calc_repl_delay_flag,
   (void *) &prm_er_log_calc_repl_delay_default,
   (void *) &PRM_ER_LOG_CALC_REPL_DELAY,
   (void *) NULL,
   (void *) NULL,
   (char *) NULL,
   (DUP_PRM_FUNC) NULL,
  ...
  {PRM_ID_REPLICATION_PARALLEL_COUNT,
   PRM_NAME_REPLICATION_PARALLEL_COUNT,
   (PRM_FOR_SERVER),
   PRM_INTEGER,
   &prm_replication_parallel_count_flag,
   (void *) &prm_replication_parallel_count_default,
  ...
  {PRM_ID_SCAL_PERF_PS_REPL_THREAD_IGNORE_UNFIX,
   ...
   (DUP_PRM_FUNC) NULL,
   (DUP_PRM_FUNC) NULL},
  {PRM_ID_SCAL_PERF_PS_REPL_SPAGE_COMPACT, // TODO: .._SPAGE_ZEROING .. or remove
   PRM_NAME_SCAL_PERF_PS_REPL_SPAGE_COMPACT,
   (PRM_HIDDEN | PRM_FOR_SERVER),
   PRM_BOOLEAN,
   &prm_scal_perf_ps_repl_spage_compact_flag,
   (void *) &prm_scal_perf_ps_repl_spage_compact_default,
   (void *) &PRM_SCAL_PERF_PS_REPL_SPAGE_COMPACT_VALUE,
   (void *) NULL,
   (void *) NULL,
   (char *) NULL,
   (DUP_PRM_FUNC) NULL,
