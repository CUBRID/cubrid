...
#define PRM_NAME_HA_UPDATE_SERVER_STATE_INTERVAL_IN_MSEC "ha_update_server_state_interval_in_msecs"
...
int PRM_HA_UPDATE_SERVER_STATE_INTERVAL_IN_MSECS = HB_DEFAULT_UPDATE_SERVER_STATE_INTERVAL_IN_MSECS;
static int prm_ha_update_server_state_interval_in_msecs_default = HB_DEFAULT_UPDATE_SERVER_STATE_INTERVAL_IN_MSECS;
static unsigned int prm_ha_update_server_state_interval_in_msecs_flag = 0;
...
static SYSPRM_PARAM prm_Def[] = {
  ...
  {PRM_ID_HA_CHECK_DISK_FAILURE_INTERVAL_IN_SECS,
   ...
   (DUP_PRM_FUNC) prm_msec_to_sec,
   (DUP_PRM_FUNC) prm_sec_to_msec},
  {PRM_ID_HA_UPDATE_SERVER_STATE_INTERVAL_IN_MSECS,
   PRM_NAME_HA_UPDATE_SERVER_STATE_INTERVAL_IN_MSEC,
   (PRM_FOR_CLIENT | PRM_HIDDEN | PRM_FOR_HA),
   PRM_INTEGER,
   &prm_ha_update_server_state_interval_in_msecs_flag,
   (void *) &prm_ha_update_server_state_interval_in_msecs_default,
   (void *) &PRM_HA_UPDATE_SERVER_STATE_INTERVAL_IN_MSECS,
   (void *) NULL, (void *) NULL,
   (char *) NULL,
   (DUP_PRM_FUNC) NULL,
   (DUP_PRM_FUNC) NULL},
