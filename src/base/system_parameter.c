...
#define PRM_NAME_LOGPB_LOGGING "logpb_logging"
...
bool PRM_LOGPB_LOGGING = false;
static bool prm_logpb_logging_default = false;
static unsigned int prm_logpb_logging_flag = 0;
...
static SYSPRM_PARAM prm_Def[] = {
  ...
  {PRM_NAME_LOG_UNIQUE_STATS,
   ...
   (DUP_PRM_FUNC) NULL,
   (DUP_PRM_FUNC) NULL},
  {PRM_NAME_LOGPB_LOGGING,
   (PRM_FOR_SERVER),
   PRM_BOOLEAN,
   (void *) &prm_logpb_logging_flag,
   (void *) &prm_logpb_logging_default,
   (void *) &PRM_LOGPB_LOGGING,
   (void *) NULL, (void *) NULL,
   (char *) NULL,
   (DUP_PRM_FUNC) NULL,
   (DUP_PRM_FUNC) NULL},
