...
#define PRM_NAME_VECTOR_INDEX_I8_ONLY_BUILD "hnsw_i8_only_build"
#define PRM_NAME_VECTOR_INDEX_DEBUG "hnsw_debug"

#define PRM_NAME_BOOT_PERF_TRACE "boot_perf_trace"
...
SYSPRM_PARAM prm_Def[] = {
  ...
  {PRM_ID_VECTOR_INDEX_I8_PREFILTER_MULTIPLIER,
   ...
   (DUP_PRM_FUNC) NULL,
   (DUP_PRM_FUNC) NULL},
  {PRM_ID_VECTOR_INDEX_I8_ONLY_BUILD,
   PRM_NAME_VECTOR_INDEX_I8_ONLY_BUILD,
   (PRM_FOR_SESSION | PRM_USER_CHANGE | PRM_FOR_SERVER | PRM_FOR_CLIENT),
   PRM_BOOLEAN,
   PRM_CLEAR_DYNAMIC_FLAG,
   {false, {.b = false}},
  ...
  {PRM_ID_VECTOR_INDEX_DEBUG,
   ...
   (DUP_PRM_FUNC) NULL,
   (DUP_PRM_FUNC) NULL},
  {PRM_ID_BOOT_PERF_TRACE,
   PRM_NAME_BOOT_PERF_TRACE,
   (PRM_FOR_CLIENT | PRM_FOR_SERVER | PRM_USER_CHANGE | PRM_HIDDEN),
   PRM_BOOLEAN,
   PRM_CLEAR_DYNAMIC_FLAG,
   {false, {.b = false}},
