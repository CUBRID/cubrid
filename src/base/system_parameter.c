...
#define PRM_NAME_USE_DBLINK_CORR_PUSHDOWN "use_dblink_corr_pushdown"
...
SYSPRM_PARAM prm_Def[] = {
  ...
  {PRM_ID_USE_DBLINK_CORR_PUSHDOWN,
   PRM_NAME_USE_DBLINK_CORR_PUSHDOWN,
   (PRM_FOR_CLIENT | PRM_FOR_SESSION | PRM_FOR_SERVER | PRM_USER_CHANGE | PRM_FOR_QRY_STRING),
   PRM_BOOLEAN,
   PRM_CLEAR_DYNAMIC_FLAG,
   {false, {.b = false}},
   {false, {.b = false}},
