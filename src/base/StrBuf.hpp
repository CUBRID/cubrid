...
#endif
#include <stdio.h>
#if 0 //!!! snprintf() and _sprintf_p() return different values when buffer capacity is exceeded !!! (disabled until further testing)
#ifdef _WIN32
#define snprintf _sprintf_p//snprintf() on Windows doesn't support positional parms but there is a similar function; snprintf_p(); on Linux supports positional parms by default
#endif
#endif
