...
#define BEGIN_PROPSET_MAP(Class) \
  static ATL::UPROPSET * _GetPropSet (ULONG * pNumPropSets, ULONG * pcElemPerSupported, ATL::UPROPSET * pSet =
				      NULL, GUID * pguidSet = NULL) \ 
  {
...
#define BEGIN_PROPERTY_SET_EX(guid, flags) \
	...
	\pSet[nCurProp].bIsChained = false;
      \}
    \static const ATL::UPROPINFO aProperty
##guid[] = \
    {
...
#define END_PROPERTY_SET(guid) \
    ...
    \if (pNumPropSets != NULL)
      \
      {
	\pSet[nCurProp].pUPropInfo = (ATL::UPROPINFO *) aProperty
##guid; \
	  pSet[nCurProp].cUPropInfo = sizeof (aProperty
##guid) / sizeof(ATL::UPROPINFO); \
...
#define CHAIN_PROPERTY_SET(ChainClass) \
					      ULONG cPropSets
##ChainClass, cElsSupported##ChainClass; \
					      int cSets
##ChainClass = (int)(DWORD_PTR)ChainClass::_GetPropSet(NULL, &cElsSupported##ChainClass); \
					      if (pNumPropSets != NULL) \ 
					      {
					      \ATL::UPROPSET * pSetA =
					      (ATL::UPROPSET *) _alloca (sizeof (ATL::UPROPSET) * cSets
##ChainClass); \
									 ATL::UPROPSET * pSetTemp =
									 ChainClass::_GetPropSet (&cPropSets
##ChainClass, &cElsSupported##ChainClass, pSetA); \
												  cElemsMax =
												  (cElemsMax <
												   cElsSupported
##ChainClass) ? cElsSupported##ChainClass : cElemsMax; \
												   ATLASSERT (pSetTemp);
												   \for (ULONG iSet =
													  nCurProp;
													  iSet <
...
// For DataSource flags IDBInitialize::m_dwStatus
													  enum
													  DATASOURCE_FLAGS
													  { DSF_MASK_INIT = 0xFFFFF00F,	// Mask 
													  // for 
													  // stuff 
													  // lasting 
													  // over 
													  // init/uninit.
													  DSF_PERSIST_DIRTY = 0x00000001,	// Set 
													  // if 
													  // init 
													  // string 
													  // changes.
													  DSF_INITIALIZED = 0x00000010,	// Have 
													  // we 
													  // been 
													  // initialized.
													  }; 
...
// Implementation Class 
													  ...
													  *(pdbidSrc->
													  ...
													  (&spIDCInfo);
													       ...
													       S_OK) 
													  {
													  V_UI4 (&rgInfo->vData) = 0x200;	// OLEDB 
													  // Version 
													  // 02.00
													  spIDCInfo->
													  SetInfo (1,
...
template < class T, class SessionClass > class ATL_NO_VTABLE IDBCreateSessionImpl:			  public
													  IDBCreateSession
...
// IDBInitializeImpl
template < class T > class ATL_NO_VTABLE IDBInitializeImpl:						  public
													  IDBInitialize
...
// Implementation Class 
													  ...
													  DBINTERNFLAGS_CHANGED
													  = 0x00000001;
													  
// Rules for GetPropertiesArgChk
													  const DWORD
													  ARGCHK_PROPERTIESINERROR
													  = 0x00000001;
...
template < class T > class CUtlPropInfo:								  public
													  ...
													  {
													  GETPROPINFO_ALLPROPIDS
													  = 0x0001,
													  GETPROPINFO_NOTSUPPORTED
													  = 0x0002,
													  GETPROPINFO_ERRORSOCCURRED
													  = 0x0004,
													  GETPROPINFO_VALIDPROP
													  = 0x0008 
													  };
													  ...
													  *
													  ...
													  // ulIndex =
													  // ulCurrentInitSet;
													  // pPropInfoSet[ulSet].guidPropertySet 
													  // = *pGuid;
													  pPropInfoSet[ulSet].guidPropertySet = *(m_pUPropSet[ulCurrentInitSet].pPropSet); GetPropertySetIndex (&pPropInfoSet[ulSet].guidPropertySet);	// Need 
													  // to 
													  // set 
													  // the 
													  // m_cPropSetDex 
...
//                                              !(InlineIsEqualGUID(pPropInfoSet[ulSet].guidPropertySet, DBPROPSET_DBINITALL))))
													  ...
													  *pcPropertyInfoSets
													  ...
													  CComAutoCriticalSection m_oCriticalSection;	// critical 
													  // section 
													  // to 
													  // synchronize 
													  // access 
													  ...
													  // the 
													  // class
													  ULONG m_cUPropSet;	// count 
													  // of 
													  // UPropSet 
													  // items
													  UPROPSET * m_pUPropSet;	// Pointer 
													  // to 
													  // UPropset 
													  // items
													  ULONG m_cPropSetDex;	// count 
													  // of 
													  // UPropSet 
													  // Indexes
													  CAutoVectorPtr < ULONG > m_rgiPropSetDex;	// array 
													  // of 
													  // UPropSet 
													  // Index 
													  // values
													  ULONG m_cElemPerSupported;	// number 
													  // of 
													  // DWORDS 
													  // per 
													  // UPropSet 
													  ...
													  // supported 
													  // UPropIds
													  CAutoVectorPtr < DWORD > m_rgdwSupported;	// array 
													  // of 
													  // DWORDs 
													  // indicating 
													  // supported 
...
class ATL_NO_VTABLE CUtlPropsBase:									  public
													  CBitFieldOps,
													  public
													  CDBIDOps 
													  {
													  ...
													  // UPropset 
													  // items
													  CAutoVectorPtr < UPROP > m_pUProp; ULONG m_cUPropSetHidden;	// Count 
													  // of 
													  // Hidden 
													  // items
													  DWORD m_dwFlags;	// Configuration 
													  // flags
													  ULONG m_cPropSetDex;	// count 
													  // of 
													  // UPropSet 
													  // Indexes
													  CAutoVectorPtr < ULONG > m_rgiPropSetDex;	// pointer 
													  // to 
													  // Array 
													  // of 
													  // UPropSet 
													  ...
													  // supported 
													  // UPropIds
													  CAutoVectorPtr < DWORD > m_rgdwSupported;	// pointer 
													  // to 
													  // array 
													  // of 
													  // DWORDs 
													  ...
													  // UPropIds 
													  // 
													  CAutoVectorPtr < DWORD > m_rgdwPropsInError;	// pointer 
													  // to 
													  // array 
													  // of 
													  // DWORDs 
													  ...
													  = 0x0001,
													  GETPROP_NOTSUPPORTED
													  = 0x0002,
													  GETPROP_ERRORSOCCURRED
													  = 0x0004,
													  GETPROP_VALIDPROP
													  = 0x0008,
													  GETPROP_PROPSINERROR
													  = 0x0010 
													  };
													  ...
													  = 0x0001,
													  SETPROP_NOTSUPPORTED
													  = 0x0002,
													  SETPROP_VALIDPROP
													  = 0x0004,
													  SETPROP_ERRORS
													  = 0x0008,
													  SETPROP_COLUMN_LEVEL
													  = 0x0010,
													  SETPROP_WAS_REQUIRED
													  = 0x0020 
													  };
													  ...
													  S_FALSE; }
													  virtual HRESULT IsValidValue (ULONG	/* iCurSet 
																		 */
																	  ,
																	  DBPROP
																	  *
													  ...
													  HRESULT SetProperties (const DWORD	/* dwStatus 
																		 */
																   ,
																   const
																   ULONG
													  ...
													  if (SetProperty (ulCurSet, ulCurProp,	/* pUPropInfo, 
																			 */
															     &
															     (rgDBProp
															      [ulProp]))
													  ...
													  GetCountofWritablePropsInPropSet
													  (ULONG
													   iPropSet) 
													  {
													  ...
													  InternalInitUPropSetsSupported
													  (PGetPropSet
													   pfnGetSet) 
													  {
...
//              ULONG*                  piIndex = NULL;
													  ...
													  E_OUTOFMEMORY;
														...
														l++) 
													  {
													  if (piSetIndex[l] != m_cUPropSet)	// this 
													  // is 
													  // an 
													  // invalid 
													  // index
...
// Implementation Class 
template < class T > class ATL_NO_VTABLE CUtlProps:							  public
													  CUtlPropsBase
...
template < class T > class ATL_NO_VTABLE IDBPropertiesImpl:						  public
													  IDBProperties,
													  public
													  CUtlProps <
													  T > 
...
#define END_SCHEMA_MAP() \
													  ...
													  E_INVALIDARG;
													  \}
template < class SessionClass > class ATL_NO_VTABLE IDBSchemaRowsetImpl:				  public
													  IDBSchemaRowset
													  ...
													  * pT =
													  ...
													  if (InlineIsEqualGUID (rguidSchema, DBSCHEMA_PROVIDER_TYPES))  ulType = 2; if (ulType < 3)	// I.E. 
													  // we 
													  // found 
													  // one 
													  // of 
...
template < class T, class CommandClass > class ATL_NO_VTABLE IDBCreateCommandImpl:			  public
													  IDBCreateCommand
...
// IGetDataSourceImpl
template < class T > class ATL_NO_VTABLE IGetDataSourceImpl:						  public
													  IGetDataSource
...
template < class T > class ATL_NO_VTABLE IColumnsInfoImpl:						  public
													  ...
													  *ppStringsBuffer
													  ...
													  // 찾을 수
													  // 있도록
													  // IColumnsInfoImpl::MapColumnIDs의 
													  // 내용을
													  // 복사
													  // 수정했다.
													  // 또한
													  ...
													  // end
													  // hr =
													  // CompareDBIDs(&(pInfo[iColMapCur].columnid), 
													  // &(rgColumnIDs[iColId]));
													  bDone =
													  (hr == S_OK
													   ||
...
//IConvertTypeImpl
template < class T > class ATL_NO_VTABLE IConvertTypeImpl:						  public
													  IConvertType,
													  public
													  CConvertHelper
...
template < class T, class CommandBase = ICommand > class ATL_NO_VTABLE ICommandImpl:		  public
													  CommandBase
...
//              for (iBind = 0; iBind < pT->m_rgBindings.GetCount(); iBind++)
													  ...
													  // if
													  // (!pRowsetObj->m_rgBindings.SetAt(pPair->m_key, 
													  // pBind))
													  // {
													  // ATLTRACE(atlTraceDBProvider, 
													  // 2,
													  // _T("Failed 
													  // to add
													  // hAccessor
...
*/ 
													  ...
													  *ppRowset =
													  ...
													  hrExecute; }
unsigned m_bIsExecuting: 1; unsigned m_bCancelWhenExecuting: 1; unsigned m_bCancel: 1; unsigned m_bRowsetReturned: 1; }; template < class T > class ATL_NO_VTABLE ICommandTextImpl:public
													  ICommandImpl <
													  T,
													  ICommandText >
...
// Implementation Class 
template < class BindType > class ATL_NO_VTABLE IAccessorImplBase:					  public
													  IAccessor
...
template < class T, class BindType = ATLBINDINGS, class BindingVector = CAtlMap < HACCESSOR, BindType * >>class ATL_NO_VTABLE IAccessorImpl:public
													  ...
													  * pColInfo =
													  ...
													  (DBCOUNTITEM
													   ...
													   iBinding++) 
													  {
													  const DBBINDING & rBindCur = rgBindings[iBinding]; DBORDINAL iOrdAdjusted; if (bHasBookmarks)  iOrdAdjusted = rBindCur.iOrdinal;	// Bookmarks 
													  // start 
													  // with 
													  // ordinal 
													  // 0
													  else
													  iOrdAdjusted = rBindCur.iOrdinal - 1;	// Non-bookmarks 
													  // start 
													  // w/ 
													  // ordinal 
													  // 1
													  ...
													  phAccessor; 
													  // hr =
													  // m_rgBindings.SetAt((HACCESSOR)pBind, 
													  // pBind) ?
													  // S_OK :
													  // E_OUTOFMEMORY;
													  _ATLTRY 
...
// Implementation Class 
													  ...
													  (DBCOUNTITEM
													   iRowsetCur) 
													  {
													  m_dwRef = 0; m_pData = NULL; m_iRowset = iRowsetCur; m_iOriginalRowset = iRowsetCur;	// used 
													  // for 
													  // stronger 
													  // identity 
													  // tests
													  ...
													  Increment ((LPLONG) & m_dwRef);}
													  DWORD
													  ReleaseRow ()
													  {
													  return
													  CComObjectThreadModel::
													  Decrement ((LPLONG) & m_dwRef);}
													  ...
													  // & 
													  // IRowsetUpdate
													  DBPENDINGSTATUS m_status;	// NEW: 
													  // For 
													  // IRowsetUpdate
													  KeyType m_iOriginalRowset;	// NEW: 
													  // For 
													  // IRowsetChange 
													  // & 
													  // IRowsetUpdate
													  ...
													  SendColumnSetFailureNotification
													  (T * pT,
													   HROW
													   hNotifyRow,
													   typename T::
													  ...
													  SendRowsFirstChangeFailureNotification
													  (T * pT,
													   RowClass *
													   pRow,
													   HROW *
													  ...
													  // hNotifyRow 
													  // =
													  // pT->m_rgRowHandles.ReverseLookup(pRow);
													  {
													  ...
													  pT->
													  m_rgBindings.
													  Lookup ((INT_PTR) hAccessor, pBinding); if (!bFound || pBinding == NULL) 
													  {
													  ...
													  *pSrcData;
													  ...
													  (void *)
													  &(pT->
													    m_rgRowData[(LONG) pRow->m_iRowset]); } 
													  else
													  ...
													  *((DBSTATUS
													  ...
													  lstrlenA ((LPSTR) (((BYTE *) pSrcData) + pColCur->cbOffset)); 
													  else
													  ...
													  *((DBLENGTH
													  ...
													  cbCol = lstrlenA ((LPSTR) (pSrcTemp));	// was 
													  // cbDst
													  if (cbCol >=
													       cbDst) 
													  {
													  if (cbCol > (cbDst + 1))	// over 
													  // maximum 
													  // case
													  {
													  ...
													  *((DBSTATUS
													  ...
													  lstrlenW ((LPWSTR) (((BYTE *) pSrcData) + pColCur->cbOffset)) * sizeof (WCHAR); 
													  else
													  ...
													  *((DBLENGTH
													  ...
													  lstrlenW ((LPWSTR) (pSrcData)) * sizeof (WCHAR); if (cbCol >= cbDst) 
													  {
...
template < class T, class Storage, class BaseInterface = IRowsetChange, class RowClass = CSimpleRow, class MapClass = CAtlMap < RowClass::KeyType, RowClass * >>class ATL_NO_VTABLE IRowsetChangeImpl:public
													  BaseInterface
...
//                              if(!pT->m_rgRowData.RemoveAt(pRow->m_iRowset))
													  ...
													  * pInfo =
													  ...
													  pT->
													  CreateRow ((LONG_PTR) lSize, ulRowsObtained, &hInsertedRow); if (FAILED (hr)) 
													  {
													  ...
													  m_rgRowHandles.
													  RemoveKey ((RowClass::KeyType) hInsertedRow); return DB_E_CANCELED; }
...
// IRowsetImpl
template < class T, class RowsetInterface, class RowClass = CSimpleRow, class MapClass = CAtlMap < RowClass::KeyType, RowClass * >>class ATL_NO_VTABLE IRowsetImpl:public
													  RowsetInterface
													  ...
													  // for (int i 
													  // = 0; i <
													  // m_rgRowHandles.GetCount(); 
													  // i++)
													  // delete
													  // (m_rgRowHandles.GetValueAt(i));
													  POSITION pos =
													  m_rgRowHandles.
													  GetStartPosition
													  ();
													  ...
													  m_rgRowHandles.
													  Lookup ((RowClass::KeyType) hRowCur, pRow); if (!bFound || pRow == NULL) 
													  {
													  ...
													  RemoveKey ((RowClass::KeyType) hRowCur); }
...
//              *ppBinding = (void*)pT->m_rgBindings.Lookup((INT_PTR)hAccessor);
													  ...
													  *pcRowsObtained
													  ...
													  nCurrentRow = nFetchStartPosition;	// we 
													  // already 
													  // calculated 
													  // the 
													  // 'start 
													  ...
													  (m_rgRowHandles.
													   Lookup ((*prghRows)[ulActivated], pActiveRow) && (pActiveRow != NULL && pActiveRow->m_dwRef == 1)) 
													  {
													  _ATLTRY 
													  {
													  rgActivated.
													  Add ((*prghRows)[ulActivated]); }
													  ...
													  m_iRowset = nCurrentRow; if (*pcRowsObtained < (DBCOUNTITEM) cRows)	// we 
													  // could 
													  // not 
													  // fetch 
													  // the 
...
///////////////////////////////////////////////////////////////////////////
// IRowsetIdentityImpl 
template < class T, class RowClass = CSimpleRow > class ATL_NO_VTABLE IRowsetIdentityImpl:		  public
													  IRowsetIdentity
...
template < class T > class ATL_NO_VTABLE IInternalConnectionImpl:					  public
													  IInternalConnection
...
template < class T > class ATL_NO_VTABLE IInternalCommandConnectionImpl:				  public
													  IInternalConnection
...
template < class T > class ATL_NO_VTABLE IObjectWithSiteSessionImpl:				  public
													  IObjectWithSiteImpl
													  < T > 
													  {
...
template < class T > class ATL_NO_VTABLE IRowsetCreatorImpl:					  public
													  IObjectWithSiteImpl
													  < T > 
													  {
...
// Binding Maps
													  ...
													  m_szSourcesParseName
													  [256];
													  WCHAR
													  m_szSourcesDescription
													  [256];
...
// class IRowsetUpdateImpl
template < class T, class Storage, class UpdateArray = CAtlArray < Storage >, class RowClass = CSimpleRow, class MapClass = CAtlMap < RowClass::KeyType, RowClass * >>class IRowsetUpdateImpl:public
													  IRowsetChangeImpl
													  < T, Storage,
													  IRowsetUpdate,
													  RowClass,
													  ...
													  // void*
													  // pData =
													  // (void*)m_mapCachedData.Lookup(hRow, 
													  // pTemp);
													  Storage *
													  pData;
													  ...
													  *((DBSTATUS
													  ...
													  // ulRowHandles 
													  // =
													  // (DBROWCOUNT)pT->m_rgRowHandles.GetCount();
													  ...
													  *prgPendingStatus
													   ...
													   * status pRow 
													   * =
													   * pT->m_rgRowHandles.GetValueAt(iRowset);
													   ...
													   * Add the output row pRow->AddRefRow();
													   * if (prgPendingRows)
													   * ((*prgPendingRows)[ulRows]) =
													   * (HROW)pT->m_rgRowHandles.GetKeyAt(iRowset);
													   * if (prgPendingStatus)
													   * ((*prgPendingStatus)[ulRows]) =
													   * (DBPENDINGSTATUS)pRow->m_status; ulRows++;
													   * } } */ 
													  if
													  (pcPendingRows
													   !=
...
case DBPENDINGSTATUS_UNCHANGED:	// Row is not changed
													  ...
													  *prgRowStatus
													  ...
													  // *prgRowStatus 
													  // =
													  // (DBROWSTATUS*)_alloca(ulRowUpdate 
													  // *
													  // sizeof(DBROWSTATUS));
													  spTempRowStatus.
													  Allocate
...
//                                      pRow->ReleaseRow();
													  ...
													  *prgRowStatus
													  ...
													  // Callback
													  // functions
													  HRESULT IsUpdateAllowed (DBPENDINGSTATUS	/* [in] 
																    *//* status 
																    */
																   , 
																   /* [in] 
