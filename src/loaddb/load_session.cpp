...
namespace cubload
{
    ...
    , m_temp_task (NULL)
  {
	...
	if (intl_identifier_lower_string_size (m_args.table_name.c_str ()) >= SM_MAX_IDENTIFIER_LENGTH_287)
	  {
	    // This is an error.
	    m_driver->get_error_handler ().on_error (LOADDB_MSG_EXCEED_MAX_LEN, SM_MAX_IDENTIFIER_LENGTH_287 - 1);
	    return;
	  }
