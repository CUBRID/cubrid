  ...
  *consumed = sizeof (int32_t);
  ...
  switch (type)
    ...
    case DB_TYPE_VARCHAR:
      db_make_varchar (val, field_len, data, field_len, LANG_SYS_CODESET, LANG_SYS_COLLATION);
      break;

    case DB_TYPE_CHAR:
      db_make_char (val, field_len, data, field_len, LANG_SYS_CODESET, LANG_SYS_COLLATION);
      break;
