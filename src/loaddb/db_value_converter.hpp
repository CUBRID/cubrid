...
/*
 * db_value_converter.hpp - TODO CBRD-21654
 */
...
namespace cubload
{
  ...
  db_value_t to_db_null (const char *str, const Attr *attr);

  template <typename Attr>
  db_value_t to_db_short (const char *str, const Attr *attr);

  template <typename Attr>
  db_value_t to_db_int (const char *str, const Attr *attr);

  template <typename Attr>
  db_value_t to_db_bigint (const char *str, const Attr *attr);

  template <typename Attr>
  db_value_t to_db_char (const char *str, const Attr *attr);

  template <typename Attr>
  db_value_t to_db_varchar (const char *str, const Attr *attr);

  template <typename Attr>
  db_value_t to_db_float (const char *str, const Attr *attr);

  template <typename Attr>
  db_value_t to_db_double (const char *str, const Attr *attr);

  template <typename Attr>
  db_value_t to_db_date (const char *str, const Attr *attr);

  template <typename Attr>
  db_value_t to_db_time (const char *str, const Attr *attr);

  template <typename Attr>
  db_value_t to_db_timeltz (const char *str, const Attr *attr);

  template <typename Attr>
  db_value_t to_db_timetz (const char *str, const Attr *attr);

  template <typename Attr>
  db_value_t to_db_timestamp (const char *str, const Attr *attr);

  template <typename Attr>
  db_value_t to_db_timestampltz (const char *str, const Attr *attr);

  template <typename Attr>
  db_value_t to_db_timestamptz (const char *str, const Attr *attr);

  template <typename Attr>
  db_value_t to_db_datetime (const char *str, const Attr *attr);

  template <typename Attr>
  db_value_t to_db_datetimeltz (const char *str, const Attr *attr);

  template <typename Attr>
  db_value_t to_db_datetimetz (const char *str, const Attr *attr);

  template <typename Attr>
  db_value_t to_db_json (const char *str, const Attr *attr);

  template <typename Attr>
  db_value_t to_db_monetary (const char *str, const Attr *attr);
...
namespace cubload
{
  ...
  template <typename Attr>
  db_value_t
  to_db_null (const char *str, const Attr *attr)
  {
    db_value_t val;
    db_make_null (&val);
  ...
  template <typename Attr>
  db_value_t
  to_db_short (const char *str, const Attr *attr)
  {
    int result = 0;
    db_value_t val;
    char *str_ptr;
  ...
  template <typename Attr>
  db_value_t
  to_db_int (const char *str, const Attr *attr)
  {
    int result = 0;
    char *str_ptr;
    db_value_t val;
  ...
  template <typename Attr>
  db_value_t
  to_db_bigint (const char *str, const Attr *attr)
  {
    int result = 0;
    db_value_t val;
    size_t str_len = strlen (str);
  ...
  template <typename Attr>
  db_value_t
  to_db_char (const char *str, const Attr *attr)
  {
    int char_count = 0;
    db_value_t val;
    int str_len = (int) strlen (str);

    assert (attr != NULL && attr->domain != NULL);

    int precision = attr->domain->precision;
    unsigned char codeset = attr->domain->codeset;
  ...
  template <typename Attr>
  db_value_t
  to_db_varchar (const char *str, const Attr *attr)
  {
    db_value_t val;
    int char_count = 0;
    int str_len = (int) strlen (str);
  ...
  template <typename Attr>
  db_value_t
  to_db_float (const char *str, const Attr *attr)
  {
    double d;
    char *str_ptr;
    db_value_t val;
  ...
  template <typename Attr>
  db_value_t
  to_db_double (const char *str, const Attr *attr)
  {
    double d;
    char *str_ptr;
    db_value_t val;
  ...
  template <typename Attr>
  db_value_t
  to_db_date (const char *str, const Attr *attr)
  {
    int ret;
    db_value_t val;
  ...
  template <typename Attr>
  db_value_t
  to_db_time (const char *str, const Attr *attr)
  {
    int ret;
    db_value_t val;
  ...
  template <typename Attr>
  db_value_t
  to_db_timeltz (const char *str, const Attr *attr)
  {
    int ret;
    db_value_t val;
    DB_TIMETZ timetz;
  ...
  template <typename Attr>
  db_value_t
  to_db_timetz (const char *str, const Attr *attr)
  {
    int ret;
    bool has_zone;
    db_value_t val;
  ...
  template <typename Attr>
  db_value_t
  to_db_timestamp (const char *str, const Attr *attr)
  {
    int ret;
    db_value_t val;
  ...
  template <typename Attr>
  db_value_t
  to_db_timestampltz (const char *str, const Attr *attr)
  {
    int ret;
    db_value_t val;
  ...
  template <typename Attr>
  db_value_t
  to_db_timestamptz (const char *str, const Attr *attr)
  {
    int ret;
    bool has_zone;
    db_value_t val;
  ...
  template <typename Attr>
  db_value_t
  to_db_datetime (const char *str, const Attr *attr)
  {
    int ret;
    db_value_t val;
  ...
  template <typename Attr>
  db_value_t
  to_db_datetimeltz (const char *str, const Attr *attr)
  {
    int ret;
    db_value_t val;
    DB_DATETIME datetime;
  ...
  template <typename Attr>
  db_value_t
  to_db_datetimetz (const char *str, const Attr *attr)
  {
    int ret;
    bool has_zone;
    db_value_t val;
  ...
  template <typename Attr>
  db_value_t
  to_db_json (const char *str, const Attr *attr)
  {
  ...
  template <typename Attr>
  db_value_t
  to_db_monetary (const char *str, const Attr *attr)
  {
    char *str_ptr;
    double amt;
    db_value_t val;
