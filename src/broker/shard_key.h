 ...
 ************************************************************************/
  ...
  typedef enum
  {
    ...
    SHARD_U_TYPE_BFILE = 23,
    SHARD_U_TYPE_CFILE = 24,
    SHARD_U_TYPE_BLOB = 25,
    SHARD_U_TYPE_CLOB = 26,
    SHARD_U_TYPE_ENUM = 27,
    SHARD_U_TYPE_USHORT = 28,
    SHARD_U_TYPE_UINT = 29,
    SHARD_U_TYPE_UBIGINT = 30,
