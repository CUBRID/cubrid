...
extern int ux_end_tran (int tran_type, bool reset_con_status, DB_QUERY_EXECUTION_TYPE latest_query_execution_type);
...
#endif /* !CAS_FOR_ORACLE && !CAS_FOR_MYSQL */
extern void ux_free_result (void *res, DB_QUERY_EXECUTION_TYPE query_execution_type);
