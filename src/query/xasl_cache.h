...
struct xasl_cache_ent
{
  ...
  XASL_CACHE_ENTRY *lru_prev;	/* query result(list file) cache victim candidate list - prev */
  XASL_CACHE_ENTRY *lru_next;	/* query result(list file) cache victim candidate list - next */
