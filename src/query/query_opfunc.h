...
static int qdata_json_depth_dbval_helper (JSON_VALUE & doc);
extern int qdata_json_search_dbval (DB_VALUE * dbval1_p, DB_VALUE * dbval2_p, DB_VALUE * dbval3_p, DB_VALUE * result_p,
				    TP_DOMAIN * domain_p);
static void qdata_json_search_dbval_helper (JSON_VALUE & whole_doc, JSON_VALUE & doc, const char *current_path,
					    const char *search_str, int one_or_all,
