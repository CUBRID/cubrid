...
enum
{
  NOT_FROM_RESULT_CACHE = (1 << 0),
  RESULT_CACHE_REQUIRED = (1 << 1),
  RESULT_CACHE_INHIBITED = (1 << 2),
  RESULT_HOLDABLE = (1 << 3),
  DONT_COLLECT_EXEC_STATS = (1 << 4),
  MRO_CANDIDATE = (1 << 5),
  MRO_IS_USED = (1 << 6),
  SORT_LIMIT_CANDIDATE = (1 << 7),
  SORT_LIMIT_USED = (1 << 8),
  XASL_TRACE_TEXT = (1 << 9),
  XASL_TRACE_JSON = (1 << 10),
  TRIGGER_IS_INVOLVED = (1 << 11),
  RETURN_GENERATED_KEYS = (1 << 12),
  XASL_CACHE_PINNED_REFERENCE = (1 << 13),
  EXECUTE_QUERY_WITHOUT_DATA_BUFFERS = (1 << 14),
  EXECUTE_QUERY_WITH_COMMIT = (1 << 15),
  TRAN_AUTO_COMMIT = (1 << 16),
  SKIP_ORDERBY_CANDIDATE = (1 << 17),
  SKIP_ORDERBY_USED = (1 << 18)
};
