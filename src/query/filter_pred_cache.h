...
extern int fpcache_retire (THREAD_ENTRY * thread_p, BTID * btid, PRED_EXPR_WITH_CONTEXT * filter_pred);
extern int fpcache_remove_by_class (THREAD_ENTRY * thread_p, OID * class_oid);
