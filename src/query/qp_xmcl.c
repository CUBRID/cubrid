...
xts_save_string (const char *string)
{
  ...
  string_length = or_packed_string_length ((char *) string);
...
xts_process_xasl_node (char *ptr, const XASL_NODE * xasl)
{
  ...
  ptr = or_pack_int (ptr, xasl->iscan_order);
...
xts_process_fetch_proc (char *ptr, const FETCH_PROC_NODE * obj_set_fetch_proc)
{
  ...
  ptr = or_pack_int (ptr, obj_set_fetch_proc->fetch_res);
  ...
  ptr = or_pack_int (ptr, obj_set_fetch_proc->ql_flag);
