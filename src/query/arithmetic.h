...
extern int db_json_arrayagg_dbval (DB_VALUE * dbval, DB_VALUE * res, bool expand = false);
extern int db_json_objectagg_dbval (DB_VALUE * json_key, DB_VALUE * json_val, DB_VALUE * json_res);
extern int db_json_objectagg_dbval (DB_VALUE * json_object, DB_VALUE * json_res);
