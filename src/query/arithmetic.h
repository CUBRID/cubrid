...
extern int db_json_contains_dbval (DB_VALUE * result, DB_VALUE * const *arg, int const num_args);
extern int db_json_type_dbval (DB_VALUE * result, DB_VALUE * const *args, int num_args);
extern int db_json_extract_dbval (DB_VALUE * result, DB_VALUE * const *args, int num_args);
extern int db_json_extract_multiple_paths (DB_VALUE * result, DB_VALUE * const *args, int num_args);
extern int db_json_valid_dbval (DB_VALUE * result, DB_VALUE * const *args, int num_args);
extern int db_json_length_dbval (DB_VALUE * result, DB_VALUE * const *args, int num_args);
extern int db_json_depth_dbval (DB_VALUE * result, DB_VALUE * const *args, int num_args);
