...
typedef enum
{
  ...
  APPLYINFO_MSG_NO_QUERY_RESULTS = 57 APPLYINFO_MSG_HA_NOT_SUPPORT = 58,
...
typedef enum
{
  ...
  FLASHBACK_MSG_EXCEED_MAX_CLASSNAME_LENGTH = 15,
  FLASHBACK_MSG_INVALID_CLASSNAME_FORMAT = 16,
