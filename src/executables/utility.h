...
typedef enum
{
  MEMMON_MSG_EXCLUSIVE_OPTION = 1,
  MEMMON_MSG_NOT_SUPPORTED = 2,
  MEMMON_MSG_NO_MATCHING_MODULE = 3,
  MEMMON_MSG_INVALID_TRAN_COUNT_OPTION = 4,
  MEMMON_MSG_NEGATIVE_TRAN_COUNT_NUMBER = 5,
