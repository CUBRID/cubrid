...
typedef enum
{
  ...
  FLASHBACK_MSG_EXCEED_MAX_OWNER_CLASS_LENGTH = 15,
  FLASHBACK_MSG_INVALID_CLASS_LENGTH = 16,
  FLASHBACK_MSG_INVALID_OWNER_LENGTH = 17,
  FLASHBACK_MSG_OWNER_NOT_SPECIFIED = 18,
