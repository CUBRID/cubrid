 ...
 *
 * iqutil.c : Utilities for sqlx module
 *
 */
...
static CSQL_ERR_MSG_MAP csql_Err_msg_map[] = {
  ...
  {CSQL_ERR_SQLX_CMD_NOT_FOUND, CSQL_E_SQLXCMDNOTFOUND_TEXT},
  {CSQL_ERR_SQLX_CMD_AMBIGUOUS, CSQL_E_SQLXCMDAMBIGUOUS_TEXT},
...
csql_errmsg (int code)
{
  ...
  else if (code == CSQL_ERR_SQLX_ERROR)
    {
