 ...
 *
 * iqresult.c : Query execution / result handling routine
 *
 */
...
typedef struct
{
  ...
  SQLX_CMD_TYPE curr_stmt_type;
  int curr_stmt_line_no;
} CUR_RESULT_INFO;

typedef struct
{
  SQLX_CMD_TYPE stmt_type;
  const char *cmd_string;
} CSQL_CMD_STRING_TABLE;

static CSQL_CMD_STRING_TABLE csql_Cmd_string_table[] = {
  {SQLX_CMD_SELECT, "SELECT"},
  {SQLX_CMD_SELECT_UPDATE, "SELECT"},
  {SQLX_CMD_CALL, "CALL"},
  {SQLX_CMD_EVALUATE, "EVALUATE"},
  {SQLX_CMD_GET_ISO_LVL, "GET ISOLATION LEVEL"},
  {SQLX_CMD_GET_TIMEOUT, "GET LOCK TIMEOUT"},
  {SQLX_CMD_GET_OPT_LVL, "GET OPTIMIZATION"},
  {SQLX_CMD_GET_TRIGGER, "GET TRIGGER"},
  {SQLX_CMD_UPDATE, "UPDATE"},
  {SQLX_CMD_DELETE, "DELETE"},
  {SQLX_CMD_INSERT, "INSERT"},
  {SQLX_CMD_ALTER_CLASS, "ALTER"},
  {SQLX_CMD_COMMIT_WORK, "COMMIT"},
  {SQLX_CMD_CREATE_CLASS, "CREATE"},
  {SQLX_CMD_CREATE_INDEX, "CREATE INDEX"},
  {SQLX_CMD_DROP_DATABASE, "DROP LDB"},
  {SQLX_CMD_DROP_CLASS, "DROP"},
  {SQLX_CMD_DROP_INDEX, "DROP INDEX"},
  {SQLX_CMD_ALTER_INDEX, "ALTER INDEX"},
  {SQLX_CMD_DROP_LABEL, "DROP "},
  {SQLX_CMD_RENAME_CLASS, "RENAME"},
  {SQLX_CMD_ROLLBACK_WORK, "ROLLBACK"},
  {SQLX_CMD_GRANT, "GRANT"},
  {SQLX_CMD_REVOKE, "REVOKE"},
  {SQLX_CMD_CREATE_USER, "CREATE USER"},
  {SQLX_CMD_DROP_USER, "DROP USER"},
  {SQLX_CMD_ALTER_USER, "ALTER USER"},
  {SQLX_CMD_UPDATE_STATS, "UPDATE STATISTICS"},
  {SQLX_CMD_GET_STATS, "GET STATISTICS"},
  {SQLX_CMD_SCOPE, "SCOPE"},
  {SQLX_CMD_REGISTER_DATABASE, "REGISTER"},
  {SQLX_CMD_CREATE_TRIGGER, "CREATE TRIGGER"},
  {SQLX_CMD_DROP_TRIGGER, "DROP TRIGGER"},
  {SQLX_CMD_SET_OPT_LVL, "SET OPTIMIZATION"},
  {SQLX_CMD_SET_SYS_PARAMS, "SET SYSTEM PARAMETERS"},
  {SQLX_CMD_SET_TRIGGER, "SET TRIGGER"},
  {SQLX_CMD_SAVEPOINT, "SAVEPOINT"},
  {SQLX_CMD_PREPARE, "PREPARE"},
  {SQLX_CMD_ATTACH, "ATTACH"},
  {SQLX_CMD_USE, "USE/EXCLUDE"},
  {SQLX_CMD_REMOVE_TRIGGER, "REMOVE TRIGGER"},
  {SQLX_CMD_RENAME_TRIGGER, "RENAME TRIGGER"},
  {SQLX_CMD_ON_LDB, "ON LDB"},
  {SQLX_CMD_GET_LDB, "GET LDB"},
  {SQLX_CMD_SET_LDB, "SET LDB"},
  {SQLX_CMD_ALTER_SERIAL, "ALTER SERIAL"},
  {SQLX_CMD_CREATE_SERIAL, "CREATE SERIAL"},
  {SQLX_CMD_DROP_SERIAL, "DROP SERIAL"},
  {SQLX_CMD_CREATE_STORED_PROCEDURE, "CREATE PROCEDURE"},
  {SQLX_CMD_DROP_STORED_PROCEDURE, "DROP PROCEDURE"}
};
...
static const char *csql_cmd_string (SQLX_CMD_TYPE stmt_type,
...
csql_results (const CSQL_ARGUMENT * csql_arg, DB_QUERY_RESULT * result,
	      DB_QUERY_TYPE * attr_spec, int line_no, SQLX_CMD_TYPE stmt_type)
{
  int i;
 ...
 */
static const char *
csql_cmd_string (SQLX_CMD_TYPE stmt_type, const char *default_string)
{
  int i;
...
display_empty_result (int stmt_type, int line_no)
{
  ...
  sprintf (csql_Scratch_text, msgcat_message (MSGCAT_CATALOG_CSQL,
	   ...
	   csql_cmd_string ((SQLX_CMD_TYPE) stmt_type, ""), line_no);
...
get_current_result (int **lengths, const CUR_RESULT_INFO * result_info)
{
  ...
  DB_VALUE db_value;
  SQLX_CMD_TYPE stmt_type = result_info->curr_stmt_type;
  ...
  for (i = 0; i < num_attrs; i++)
	...
	default:		/* other types */
	   ...
	   */
	  if (stmt_type == SQLX_CMD_GET_ISO_LVL)
	    {
	  ...
	  else if ((stmt_type == SQLX_CMD_GET_TIMEOUT) &&
 ...
 *   result_info(in): pointer to current query result info structure
 *
 * Note: This function may set csql_Error_code CSQL_ERR_SQLX_ERROR to indicate
 *       the error
 */
static int
