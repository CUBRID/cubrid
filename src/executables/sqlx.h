...
enum
{
  ...
  CSQL_E_SQLXCMDNOTFOUND_TEXT = 192,
  CSQL_E_SQLXCMDAMBIGUOUS_TEXT = 193,
...
enum
{
  ...
  CSQL_ERR_SQLX_CMD_NOT_FOUND,
  CSQL_ERR_SQLX_CMD_AMBIGUOUS,
...
extern int sqlx (const char *argv0, CSQL_ARGUMENT * csql_arg);
...
extern void csql_help_syntax (DB_HELP_COMMAND sqlx_cmd_no);
