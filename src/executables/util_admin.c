...
static UTIL_ARG_MAP ua_Unload_Option_Map[] = {
  ...
  {UNLOAD_STRING_BUFFER_SIZE_S, {ARG_INTEGER}, {(void *) 1}},
  {UNLOAD_REQUEST_DATASIZE_S, {ARG_INTEGER}, {(void *) 200}},
  {UNLOAD_MT_PROCESS_S, {ARG_STRING}, {0}},
  {UNLOAD_TIME_TEST_S, {ARG_INTEGER}, {(void *) (-1)}},
  {0, {0}, {0}}
};
...
static GETOPT_LONG ua_Unload_Option[] = {
  ...
  {UNLOAD_REQUEST_DATASIZE_L, 1, 0, UNLOAD_REQUEST_DATASIZE_S},
  {UNLOAD_MT_PROCESS_L, 1, 0, UNLOAD_MT_PROCESS_S},
  {UNLOAD_TIME_TEST_L, 1, 0, UNLOAD_TIME_TEST_S},
  {0, 0, 0, 0}
};
