...
static UTIL_ARG_MAP ua_Create_Option_Map[] = {
  ...
  {CREATE_REMOTE_STORAGE_S, {ARG_BOOLEAN}, {0}},
  {0, {0}, {0}}
};
...
static GETOPT_LONG ua_Create_Option[] = {
  ...
  {CREATE_REMOTE_STORAGE_L, no_argument, 0, CREATE_REMOTE_STORAGE_S},
  {0, 0, 0, 0}
};
...
static UTIL_ARG_MAP ua_Backup_Option_Map[] = {
  ...
  {BACKUP_PAGE_SERVER_S, {ARG_BOOLEAN}, {0}},
  {0, {0}, {0}}
};
...
static GETOPT_LONG ua_Backup_Option[] = {
  ...
  {BACKUP_PAGE_SERVER_L, 0, 0, BACKUP_PAGE_SERVER_S},
  {0, 0, 0, 0}
};
...
static UTIL_ARG_MAP ua_Paramdump_Option_Map[] = {
  ...
  {PARAMDUMP_PAGE_SERVER_S, {ARG_BOOLEAN}, {0}},
  {0, {0}, {0}}
};
...
static GETOPT_LONG ua_Paramdump_Option[] = {
  ...
  {PARAMDUMP_PAGE_SERVER_L, 0, 0, PARAMDUMP_PAGE_SERVER_S},
  {0, 0, 0, 0}
};
...
static UTIL_ARG_MAP ua_Statdump_Option_Map[] = {
  ...
  {STATDUMP_PAGE_SERVER_S, {ARG_BOOLEAN}, {0}},
  {0, {0}, {0}}
};
...
static GETOPT_LONG ua_Statdump_Option[] = {
  ...
  {STATDUMP_PAGE_SERVER_L, 0, 0, STATDUMP_PAGE_SERVER_S},
  {0, 0, 0, 0}
};
