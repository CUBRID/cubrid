...
static UTIL_ARG_MAP ua_Unload_Option_Map[] = {
  ...
  {UNLOAD_THREAD_COUNT_S, {ARG_INTEGER}, {0}},
  {UNLOAD_VARCHAR_ALLOC_SIZE_S, {ARG_INTEGER}, {0}},
  {UNLOAD_MODULAR_VALUE_S, {ARG_INTEGER}, {0}},
  {UNLOAD_REMAINDER_VALUE_S, {ARG_INTEGER}, {0}},
  {UNLOAD_PRINT_TO_STDOUT_S, {ARG_BOOLEAN}, {0}},
  {0, {0}, {0}}
};
...
static GETOPT_LONG ua_Unload_Option[] = {
  ...
  {UNLOAD_VARCHAR_ALLOC_SIZE_L, 1, 0, UNLOAD_VARCHAR_ALLOC_SIZE_S},
  {UNLOAD_MODULAR_VALUE_L, 1, 0, UNLOAD_MODULAR_VALUE_S},
  {UNLOAD_REMAINDER_VALUE_L, 1, 0, UNLOAD_REMAINDER_VALUE_S},
  {UNLOAD_PRINT_TO_STDOUT_L, 0, 0, UNLOAD_PRINT_TO_STDOUT_S},
  {0, 0, 0, 0}
};
