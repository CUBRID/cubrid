...
static UTIL_ARG_MAP ua_Create_Option_Map[] = {
  ...
  {CREATE_LOBFILE_PATH_S, {ARG_STRING}, {0}},
...
static GETOPT_LONG ua_Create_Option[] = {
  ...
  {CREATE_LOBFILE_PATH_L, 1, 0, CREATE_LOBFILE_PATH_S},
...
static UTIL_ARG_MAP ua_Copy_Option_Map[] = {
  ...
  {COPY_LOBFILE_PATH_S, {ARG_STRING}, {0}},
  {COPY_COPY_LOBFILE_PATH_S, {ARG_BOOLEAN}, {0}},
  {0, {0}, {0}}
};
...
static GETOPT_LONG ua_Copy_Option[] = {
  ...
  {COPY_LOBFILE_PATH_L, 1, 0, COPY_LOBFILE_PATH_S},
  {COPY_COPY_LOBFILE_PATH_L, 0, 0, COPY_COPY_LOBFILE_PATH_S},
  {0, 0, 0, 0}
};
