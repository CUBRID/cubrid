 ...
 *
 * network_interface_sky.c - Interface functions for client requests.
 *
 * Note:
 */
...
{
  return or_packed_string_length (((char *) cstring));
}
#endif /* CS_MODE */
		  ...
		  int cache_attr_id, const char *fk_name)
{
  ...
  request_size = or_align_length_for_btree (OR_BTID_SIZE)
    ...
    + or_packed_string_length ((char *) fk_name);
