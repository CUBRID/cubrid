...
<<<<<<< HEAD
extern int hnsw_add_index (BTID * btid, OID * oid, int attr_id, int dimension, int hnsw_M, int hnsw_efConstruction,
			   int metric);
=======
extern int hnsw_add_index (BTID * btid, OID * class_oid, int attr_id, int dimension, int hnsw_M,
			   int hnsw_efConstruction, int metric);
>>>>>>> yj/CUBVEC-135
