...
extern int netcl_spacedb (SPACEDB_ALL * spaceall, SPACEDB_ONEVOL ** spacevols, SPACEDB_FILES * spacefiles, SPACEDB_TABLE_SIZES_HEADER ** table_sizes_p, int *actual_count_p, char **table_list, int table_list_length);
