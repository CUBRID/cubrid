 ...
 *
 *      network_interface_earth.h -
 *
 * Note:
 *   Overview: Definitions for server network support.
 *             Do not put any client support functions here.  They
 *             belong in network_interface_earth.h.  Any definitions to support
 *             both client and server belong in network.h.
 */

#ifndef _NETWORK_INTERFACE_EARTH_H_
#define _NETWORK_INTERFACE_EARTH_H_

#ident "$Id$"

#include "qp_xdata.h"		/* for VACOMM stuff */
...
#endif /* _NETWORK_INTERFACE_EARTH_H_ */
