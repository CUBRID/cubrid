...
#define NET_SERVER_REQUEST_LIST \
  ...
  NET_SERVER_REQUEST_ITEM(NET_SERVER_INTERNAL_LOB_READ) \
  ...
  NET_SERVER_REQUEST_ITEM(NET_SERVER_INTERNAL_LOB_UPLOAD_BEGIN) \
  NET_SERVER_REQUEST_ITEM(NET_SERVER_INTERNAL_LOB_UPLOAD_APPEND) \
  NET_SERVER_REQUEST_ITEM(NET_SERVER_INTERNAL_LOB_UPLOAD_END) \
  NET_SERVER_REQUEST_ITEM(NET_SERVER_INTERNAL_LOB_UPLOAD_ABORT) \
  \
