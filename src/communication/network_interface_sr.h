...
extern void screate_lob_dir (THREAD_ENTRY * thread_p, unsigned int rid, char *request, int reqlen);
extern void sremove_lob_dir (THREAD_ENTRY * thread_p, unsigned int rid, char *request, int reqlen);
