...
extern void sjsp_restart (THREAD_ENTRY * thread_p, unsigned int rid, char *request, int reqlen);
extern void sjsp_status (THREAD_ENTRY * thread_p, unsigned int rid, char *request, int reqlen);
