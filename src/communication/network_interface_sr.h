...
extern void slocator_get_proxy_command (THREAD_ENTRY * thread_p, unsigned int rid, char *request, int reqlen);
extern void slocator_send_proxy_buffer (THREAD_ENTRY * thread_p, unsigned int rid, char *request, int reqlen);
...
extern void sreplication_copy_slave (THREAD_ENTRY * thread_p, unsigned int rid, char *request, int reqlen);
