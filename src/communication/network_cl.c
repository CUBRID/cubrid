...
net_histo_setup_names (void)
{
  ...
  net_Req_buffer[NET_SERVER_LOG_READER_GET_LOG_REFINED_INFO].name = "NET_SERVER_LOG_READER_GET_LOG_REFINED_INFO";
  net_Req_buffer[NET_SERVER_LOG_READER_GET_LOG_REFINED_INFO_2].name = "NET_SERVER_LOG_READER_GET_LOG_REFINED_INFO_2";
  net_Req_buffer[NET_SERVER_LOG_READER_FINALIZE].name = "NET_SERVER_LOG_READER_FINALIZE";
}
