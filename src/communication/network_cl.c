...
net_histo_setup_names (void)
{
  ...
  net_Req_buffer[NET_SERVER_FILEMGR_DUMP_FILE_LIST].name = "NET_SERVER_FILEMGR_DUMP_FILE_LIST";
  net_Req_buffer[NET_SERVER_FILEMGR_PURGE_INVALID_HEAP_FILES].name = "NET_SERVER_FILEMGR_PURGE_INVALID_HEAP_FILES";
  net_Req_buffer[NET_SERVER_FILEMGR_PURGE_TARGET_FILE].name = "NET_SERVER_FILEMGR_PURGE_TARGET_FILE";
}
