...
net_histo_setup_names (void)
{
  ...
  net_Req_buffer[NET_SERVER_CDC_SET_CONFIGURATION].name = "NET_SERVER_CDC_SET_CONFIGURATION";
  net_Req_buffer[NET_SERVER_CDC_GET_LSA].name = "NET_SERVER_CDC_GET_LSA";
  net_Req_buffer[NET_SERVER_CDC_GET_LOGITEM_INFO].name = "NET_SERVER_CDC_GET_LOGITEM_INFO";
  net_Req_buffer[NET_SERVER_CDC_GET_LOGITEM].name = "NET_SERVER_CDC_GET_LOGITEM";
  net_Req_buffer[NET_SERVER_CDC_FINALIZE].name = "NET_SERVER_CDC_FINALIZE";
}
