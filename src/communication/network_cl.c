...
net_histo_setup_names (void)
{
  ...
  net_Req_buffer[NET_SERVER_CLEANFILEDB_DUMP_FILE_LIST].name = "NET_SERVER_CLEANFILEDB_DUMP_FILE_LIST";
  net_Req_buffer[NET_SERVER_CLEANFILEDB_CLEAN_INVALID_FILE].name = "NET_SERVER_CLEANFILEDB_CLEAN_INVALID_FILE";
  net_Req_buffer[NET_SERVER_CLEANFILEDB_DELETE_TARGET_FILE].name = "NET_SERVER_CLEANFILEDB_DELETE_TARGET_FILE";
}
