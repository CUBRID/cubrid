...
/* sprintf(SR_NAME, "%s_ai_%s", class_full_name, attribute_name) */
#define AUTO_INCREMENT_SERIAL_NAME_MAX_LENGTH ((DB_MAX_FULL_CLASS_LENGTH - 1) + AUTO_INCREMENT_SERIAL_NAME_EXTRA_LENGTH + (DB_MAX_IDENTIFIER_LENGTH - 1) + NULL_TERM_LENGTH)
#define MAX_SERIAL_NAME_LENGTH                (AUTO_INCREMENT_SERIAL_NAME_MAX_LENGTH)
