...
typedef enum
{
  ...
  CT_CLASS_INST_ATTR_COUNT_INDEX = 1,
  CT_CLASS_SHARED_ATTR_COUNT_INDEX = 2,
  CT_CLASS_INST_METH_COUNT_INDEX = 3,
  CT_CLASS_CLASS_METH_COUNT_INDEX = 4,
  CT_CLASS_CLASS_ATTR_COUNT_INDEX = 5,
  CT_CLASS_IS_SYSTEM_CLASS_INDEX = 6,
  CT_CLASS_CLASS_TYPE_INDEX = 7,
  CT_CLASS_OWNER_INDEX = 8,
  CT_CLASS_COLLATION_ID_INDEX = 9,
  CT_CLASS_TDE_ALGORITHM_INDEX = 10,
  CT_CLASS_STATISTICS_STRATEGY_INDEX = 11,
  CT_CLASS_CREATED_TIME_INDEX = 12,
  CT_CLASS_UPDATED_TIME_INDEX = 13,
  CT_CLASS_CHECKED_TIME_INDEX = 14,
  CT_CLASS_UNIQUE_NAME_INDEX = 15,
  CT_CLASS_CLASS_NAME_INDEX = 16,
  CT_CLASS_SUB_CLASSES_INDEX = 17,
  CT_CLASS_SUPER_CLASSES_INDEX = 18,
  CT_CLASS_INST_ATTRS_INDEX = 19,
  CT_CLASS_SHARED_ATTRS_INDEX = 20,
  CT_CLASS_CLASS_ATTRS_INDEX = 21,
  CT_CLASS_INST_METHS_INDEX = 22,
  CT_CLASS_CLASS_METHS_INDEX = 23,
  CT_CLASS_METH_FILES_INDEX = 24,
  CT_CLASS_QUERY_SPECS_INDEX = 25,
  CT_CLASS_INDEXES_INDEX = 26,
  CT_CLASS_COMMENT_INDEX = 27,
  CT_CLASS_PARTITION_INDEX = 28,
} CT_ATTR_CLASS_INDEX;
