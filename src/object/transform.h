...
#define DOT_LENGTH 1
#define SERIAL_NAME_MAX_LENGTH (DB_MAX_USER_LENGTH - 1) + DOT_LENGTH + ((DB_MAX_IDENTIFIER_LENGTH - 1) * 2) + AUTO_INCREMENT_SERIAL_NAME_EXTRA_LENGTH + NULL_TERM_LENGTH
#define AUTO_INCREMENT_SERIAL_NAME_MAX_LENGTH SERIAL_NAME_MAX_LENGTH
