...
const char *sm_define_view_partitions_spec (void)
{
  ...
  snprintf (stmt, sizeof (stmt),
    "SELECT "
      ...
      "estimated_table_rows (" CT_CLASS_UNIQUE_NAME_EXPR ("[part_cls].") ") AS [table_rows], "
      "estimated_avg_row_length (" CT_CLASS_UNIQUE_NAME_EXPR ("[part_cls].") ") AS [avg_row_length], "
      "estimated_data_length (" CT_CLASS_UNIQUE_NAME_EXPR ("[part_cls].") ") AS [data_length], "
      "estimated_data_free (" CT_CLASS_UNIQUE_NAME_EXPR ("[part_cls].") ") AS [data_free], "
  ...
  snprintf (stmt, sizeof (stmt),
    "SELECT "
      ...
      "CASE "
        ...
        "ELSE NULL "
      "END AS [table_type], "
      "estimated_table_rows (" CT_CLASS_UNIQUE_NAME_EXPR ("[cls].") ") AS [table_rows], "
      "estimated_avg_row_length (" CT_CLASS_UNIQUE_NAME_EXPR ("[cls].") ") AS [avg_row_length], "
      "estimated_data_length (" CT_CLASS_UNIQUE_NAME_EXPR ("[cls].") ") AS [data_length], "
      "estimated_data_free (" CT_CLASS_UNIQUE_NAME_EXPR ("[cls].") ") AS [data_free], "
      "CASE "
