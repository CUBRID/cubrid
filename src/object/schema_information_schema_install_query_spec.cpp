...
const char *sm_define_view_partitions_spec (void)
{
  ...
  snprintf (stmt, sizeof (stmt),
    "SELECT "
      ...
      "estimated_table_rows (IF ([part_cls].[is_system_class] = 0, CONCAT (LOWER ([part_cls].[owner].[name]), '.', [part_cls].[class_name]), [part_cls].[class_name])) AS [table_rows], "
      "estimated_avg_row_length (IF ([part_cls].[is_system_class] = 0, CONCAT (LOWER ([part_cls].[owner].[name]), '.', [part_cls].[class_name]), [part_cls].[class_name])) AS [avg_row_length], "
      "estimated_data_length (IF ([part_cls].[is_system_class] = 0, CONCAT (LOWER ([part_cls].[owner].[name]), '.', [part_cls].[class_name]), [part_cls].[class_name])) AS [data_length], "
      "estimated_data_free (IF ([part_cls].[is_system_class] = 0, CONCAT (LOWER ([part_cls].[owner].[name]), '.', [part_cls].[class_name]), [part_cls].[class_name])) AS [data_free], "
  ...
  snprintf (stmt, sizeof (stmt),
    "SELECT "
      ...
      "CAST (INDEX_CARDINALITY ("
        "IF ([cls].[is_system_class] = 0, CONCAT (LOWER ([cls].[owner].[name]), '.', [cls].[class_name]), [cls].[class_name]), "
        "[idx].[index_name], "
        "[idx_key].[key_order]"
  ...
  snprintf (stmt, sizeof (stmt),
    "SELECT "
      ...
      "CASE "
        ...
        "ELSE NULL "
      "END AS [table_type], "
      "estimated_table_rows (IF ([cls].[is_system_class] = 0, CONCAT (LOWER ([cls].[owner].[name]), '.', [cls].[class_name]), [cls].[class_name])) AS [table_rows], "
      "estimated_avg_row_length (IF ([cls].[is_system_class] = 0, CONCAT (LOWER ([cls].[owner].[name]), '.', [cls].[class_name]), [cls].[class_name])) AS [avg_row_length], "
      "estimated_data_length (IF ([cls].[is_system_class] = 0, CONCAT (LOWER ([cls].[owner].[name]), '.', [cls].[class_name]), [cls].[class_name])) AS [data_length], "
      "estimated_data_free (IF ([cls].[is_system_class] = 0, CONCAT (LOWER ([cls].[owner].[name]), '.', [cls].[class_name]), [cls].[class_name])) AS [data_free], "
      "CASE "
