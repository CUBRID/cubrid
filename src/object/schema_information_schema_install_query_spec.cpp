...
const char *sm_define_view_partitions_spec (void)
{
  ...
  snprintf (stmt, sizeof (stmt),
    "SELECT "
      ...
      "estimated_table_rows ([part_cls].[class_of]) AS [table_rows], "
      "estimated_avg_row_length ([part_cls].[class_of]) AS [avg_row_length], "
      "estimated_data_length ([part_cls].[class_of]) AS [data_length], "
      "estimated_data_free ([part_cls].[class_of]) AS [data_free], "
  ...
  snprintf (stmt, sizeof (stmt),
    "SELECT "
      ...
      "CASE "
        ...
        "ELSE NULL "
      "END AS [table_type], "
      "estimated_table_rows ([cls].[class_of]) AS [table_rows], "
      "estimated_avg_row_length ([cls].[class_of]) AS [avg_row_length], "
      "estimated_data_length ([cls].[class_of]) AS [data_length], "
      "estimated_data_free ([cls].[class_of]) AS [data_free], "
      "CASE "
