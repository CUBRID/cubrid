...
put_class_attributes (OR_BUF * buf, SM_CLASS * class_)
{
  ...
  or_put_datetime (buf, &class_->create_time);
  or_put_datetime (buf, &class_->update_time);
  or_put_datetime (buf, &class_->check_time);
...
disk_to_class (OR_BUF * buf, SM_CLASS ** class_ptr)
{
  ...
  or_get_datetime (buf, &class_->create_time);
  or_get_datetime (buf, &class_->update_time);
  or_get_datetime (buf, &class_->check_time);
