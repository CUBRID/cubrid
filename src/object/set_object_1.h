 ...
 *
 * set_object_1.h - Set management
 * TODO: rename this file to set_object.h
 * TODO: include set_object_2.h and remove it
 */
...
#include "locator_bt.h"		/* for LC_OIDSET */
...
extern long col_has_null (COL * col);
