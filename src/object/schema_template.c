...
/*
 * smt_is_attribute_all_invisible() - Check whether all attributes of template are invisible
 *
 ...
 */
int
smt_is_attribute_all_invisible (SM_TEMPLATE * ctemplate, const char *class_name)
{
  SM_ATTRIBUTE *attr;
