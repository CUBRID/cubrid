...
static META_ATTRIBUTE class_atts[] = {
  ...
  {"create_time", DB_TYPE_DATETIME, 1, NULL, 0, 0, NULL},
  {"update_time", DB_TYPE_DATETIME, 1, NULL, 0, 0, NULL},
  {"check_time", DB_TYPE_DATETIME, 1, NULL, 0, 0, NULL},
  {"name", DB_TYPE_STRING, 1, NULL, 0, 0, NULL},
...
static CT_ATTR ct_class_atts[] = {
  ...
  {"create_time", NULL_ATTRID, DB_TYPE_DATETIME},
  {"update_time", NULL_ATTRID, DB_TYPE_DATETIME},
  {"check_time", NULL_ATTRID, DB_TYPE_DATETIME},
