...
static META_ATTRIBUTE class_atts[] = {
  ...
  {"class_flags", DB_TYPE_INTEGER, 1, NULL, 0, 0, NULL},
  ...
  {"statistics_strategy", DB_TYPE_INTEGER, 0, NULL, 0, 0, NULL},
  {"created_time", DB_TYPE_DATETIME, 0, NULL, 0, 0, NULL},
  {"updated_time", DB_TYPE_DATETIME, 0, NULL, 0, 0, NULL},
  {"checked_time", DB_TYPE_DATETIME, 0, NULL, 0, 0, NULL},
  {"name", DB_TYPE_STRING, 1, NULL, 0, 0, NULL},
...
static CT_ATTR ct_class_atts[] = {
  ...
  {"class_flags", NULL_ATTRID, DB_TYPE_INTEGER},
