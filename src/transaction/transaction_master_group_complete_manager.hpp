...
namespace cubtx
{
  ...
  class master_group_complete_manager : public group_complete_manager, public cubstream::stream_ack
  {
    ...
    private:
      ...
      std::atomic<cubstream::stream_position> m_latest_closed_group_start_stream_positon;
      std::atomic<cubstream::stream_position> m_latest_closed_group_end_stream_positon;
