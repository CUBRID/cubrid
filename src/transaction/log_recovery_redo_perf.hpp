...
enum PERF_STAT_RECOVERY_ID : cubperf::stat_id
{
  ...
  PERF_STAT_ID_REDO_OR_PUSH_POP_REUSABLE_YIELD,
...
class log_recovery_redo_perf_stat
{
  public:
      ...
      : m_definition
    {
      ...
      cubperf::stat_definition (PERF_STAT_ID_REDO_OR_PUSH_POP_REUSABLE_YIELD, cubperf::stat_definition::COUNTER_AND_TIMER,
				"Counter redo_or_push_pop_reusable_yield", "Timer redo_or_push_pop_reusable_yield (μs)"),
