...
enum PERF_STAT_RECOVERY_ID : cubperf::stat_id
{
  ...
  PERF_STAT_ID_REDO_OR_PUSH_POP_BUSY_WAIT,
...
class log_recovery_redo_perf_stat
{
  public:
      ...
      : m_definition
    {
      ...
      cubperf::stat_definition (PERF_STAT_ID_REDO_OR_PUSH_POP_BUSY_WAIT, cubperf::stat_definition::COUNTER_AND_TIMER,
				"Counter redo_or_push_new_pop_busy_wait", "Timer redo_or_push_new_pop_busy_wait (μs)"),
