 ...
 * ------------------------------------------------------------------------------------------------
 *         |    N/A NON2PL   NULL  SCH-S     IS      S     IX     BU    SIX      X  SCH-M
 * ------------------------------------------------------------------------------------------------
 ...
 *
 *  SCH-S  |    N/A    N/A   True   True   True   True   True   True   True   True  False
 *
 *     IS  |    N/A    N/A   True   True   True   True   True  False   True  False  False
 *
 *      S  |    N/A    N/A   True   True   True   True  False  False  False  False  False
 *
 *     IX  |    N/A    N/A   True   True   True  False   True  False  False  False  False
 *
 *     BU  |    N/A    N/A   True   True  False  False  False   True  False  False  False
 *
 *    SIX  |    N/A    N/A   True   True   True  False  False  False  False  False  False
 *
 *      X  |    N/A    N/A   True   True  False  False  False  False  False  False  False
 *
 *  SCH-M  |    N/A    N/A   True  False  False  False  False  False  False  False  False
 * ------------------------------------------------------------------------------------------------
 * N/A : not applicable
 */
 ...
 *  NON2PL |    N/A    N/A    N/A    N/A    N/A    N/A    N/A    N/A    N/A    N/A    N/A
 *
 *    NULL |    N/A    N/A   NULL  SCH-S     IS      S     IX     BU    SIX      X  SCH-M
 *
 *   SCH-S |    N/A    N/A  SCH-S  SCH-S     IS      S     IX     BU    SIX      X  SCH-M
 *
 *      IS |    N/A    N/A     IS     IS     IS      S     IX      X    SIX      X  SCH-M
 *
 *       S |    N/A    N/A      S      S      S      S    SIX      X    SIX      X  SCH-M
 *
 *      IX |    N/A    N/A     IX     IX     IX    SIX     IX      X    SIX      X  SCH-M
 *
 *      BU |    N/A    N/A     BU     BU     BU      X     BU     BU     BU      X  SCH-M
 *
 *     SIX |    N/A    N/A    SIX    SIX    SIX    SIX    SIX      X    SIX      X  SCH-M
 *
 *       X |    N/A    N/A      X      X      X      X      X      X      X      X  SCH-M
 *
 *   SCH-M |    N/A    N/A  SCH-M  SCH-M  SCH-M  SCH-M  SCH-M  SCH-M  SCH-M  SCH-M  SCH-M
 * ------------------------------------------------------------------------------------------------
 * N/A : not applicable
 */
