...
int lock_Comp[11][11] = {
  ...
  /* SCH-S */
  {DB_NA, DB_NA, true, true, true, true, true, true, DB_NA, true, false},
  /* IS */
  {DB_NA, DB_NA, true, true, true, true, true, true, DB_NA, false, false},
  /* S */
  {DB_NA, DB_NA, true, true, true, true, false, false, false, false, false},
  /* IX */
  {DB_NA, DB_NA, true, true, true, false, true, false, DB_NA, false, false},
  /* SIX */
  {DB_NA, DB_NA, true, true, true, false, false, false, DB_NA, false, false},
  /* U */
  {DB_NA, DB_NA, true, DB_NA, DB_NA, true, DB_NA, DB_NA, false, false, DB_NA},
  /* X */
  {DB_NA, DB_NA, true, true, false, false, false, false, false, false, false},
  /* SCH-M */
  {DB_NA, DB_NA, true, false, false, false, false, false, DB_NA, false, false}
};
