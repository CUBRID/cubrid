...
#define LC_FLAG_DO_TRIGGER_INVOLVED 0x08	/* Used for supplemental logging to know whether trigger is involved or not, 
						 * set if do_Trigger_involved is true */
...
#define LC_ONEOBJ_SET_DO_TRIGGER_INVOLVED(obj) \
  (obj)->flag |= LC_FLAG_DO_TRIGGER_INVOLVED

#define LC_ONEOBJ_IS_DO_TRIGGER_INVOLVED(obj) \
  (((obj)->flag & LC_FLAG_DO_TRIGGER_INVOLVED) != 0)
