...
extern void locator_put_class_name_entry (THREAD_ENTRY * thread_p, const char *classname, const OID * classoid);
extern void locator_remove_class_name_entry (THREAD_ENTRY * thread_p, const char *classname);
