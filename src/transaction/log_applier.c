...
static unsigned int log_pageid_hash (const void *key, unsigned int htsize, unsigned int *orig_hash_value);
 ...
 */
static unsigned int
log_pageid_hash (const void *key, unsigned int htsize, unsigned int *orig_hash_value)
{
  assert (key != NULL);
  ...
  *orig_hash_value = (*(const LOG_PAGEID *) key);
