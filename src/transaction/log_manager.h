...
extern int log_rv_bulk_build_durable_redo (THREAD_ENTRY * thread_p, LOG_RCV * rcv);
extern int log_rv_bulk_build_committed_redo (THREAD_ENTRY * thread_p, LOG_RCV * rcv);
#if defined(ENABLE_UNUSED_FUNCTION)
