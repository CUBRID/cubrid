...
extern int log_append_supplemental_info (THREAD_ENTRY * thread_p, SUPPLEMENT_REC_TYPE rec_type, int length,
					 const void *data);
...
extern int log_append_supplemental_image (THREAD_ENTRY * thread_p, const RECDES * image, LOG_LSA * image_lsa);
