...
void log_2pc_send_commit_decision (int gtrid, int num_particps, void *block_particps_ids);
void log_2pc_send_abort_decision (int gtrid, int num_particps, void *block_particps_ids);
