...
struct rvfun RV_fun[] = {
  ...
  {RVFL_CREATE_TMPFILE,		/* obsolete */
   "RVFL_CREATE_TMPFILE",
   NULL, NULL, NULL, NULL},
  {RVFL_FTAB_CHAIN,		/* obsolete */
   "RVFL_FTBCHAIN",
   NULL, NULL, NULL, NULL},
  {RVFL_IDSTABLE,		/* obsolete */
   "RVFL_IDSTABLE",
   NULL, NULL, NULL, NULL},
  {RVFL_MARKED_DELETED,		/* obsolete */
   "RVFL_MARKED_DELETED",
   NULL, NULL, NULL, NULL},
  {RVFL_ALLOCSET_SECT,		/* obsolete */
   "RVFL_ALLOCSET_SECT",
   NULL, NULL, NULL, NULL},
  {RVFL_ALLOCSET_PAGETB_ADDRESS,	/* obsolete */
   "RVFL_ALLOCSET_PAGETB_ADDRESS",
   NULL, NULL, NULL, NULL},
  {RVFL_ALLOCSET_NEW,		/* obsolete */
   "RVFL_ALLOCSET_NEW",
   NULL, NULL, NULL, NULL},
  {RVFL_ALLOCSET_LINK,		/* obsolete */
   "RVFL_ALLOCSET_LINK",
   NULL, NULL, NULL, NULL},
  {RVFL_ALLOCSET_ADD_PAGES,	/* obsolete */
   "RVFL_ALLOCSET_ADD_PAGES",
   NULL, NULL, NULL, NULL},
  {RVFL_ALLOCSET_DELETE_PAGES,	/* obsolete */
   "RVFL_ALLOCSET_DELETE_PAGES",
   NULL, NULL, NULL, NULL},
  {RVFL_ALLOCSET_SECT_SHIFT,	/* obsolete */
   "RVFL_ALLOCSET_SECT_SHIFT",
   NULL, NULL, NULL, NULL},
  {RVFL_ALLOCSET_COPY,		/* obsolete */
   "RVFL_ALLOCSET_COPY",
   NULL, NULL, NULL, NULL},
  {RVFL_FHDR,			/* obsolete */
   "RVFL_FHDR",
   NULL, NULL, NULL, NULL},
  {RVFL_FHDR_ADD_LAST_ALLOCSET,	/* obsolete */
   "RVFL_FHDR_ADD_LAST_ALLOCSET",
   NULL, NULL, NULL, NULL},
  {RVFL_FHDR_REMOVE_LAST_ALLOCSET,	/* obsolete */
   "RVFL_FHDR_REMOVE_LAST_ALLOCSET",
   NULL, NULL, NULL, NULL},
  {RVFL_FHDR_CHANGE_LAST_ALLOCSET,	/* obsolete */
   "RVFL_FHDR_CHANGE_LAST_ALLOCSET",
   NULL, NULL, NULL, NULL},
  {RVFL_FHDR_ADD_PAGES,		/* obsolete */
   "RVFL_FHDR_ADD_PAGES",
   NULL, NULL, NULL, NULL},
  {RVFL_FHDR_MARK_DELETED_PAGES,	/* obsolete */
   "RVFL_FHDR_MARK_DELETED_PAGES",
   NULL, NULL, NULL, NULL},
  {RVFL_FHDR_DELETE_PAGES,	/* obsolete */
   "RVFL_FHDR_DELETE_PAGES",
   NULL, NULL, NULL, NULL},
  {RVFL_FHDR_FTB_EXPANSION,	/* obsolete */
  ...
  {RVFL_FILEDESC_UPD,
   ...
   log_rv_dump_char,
   log_rv_dump_char},
  {RVFL_DES_FIRSTREST_NEXTVPID,	/* obsolete */
   "RVFL_DES_FIRSTREST_NEXTVPID",
   NULL, NULL, NULL, NULL},
  {RVFL_DES_NREST_NEXTVPID,	/* obsolete */
   "RVFL_DES_NREST_NEXTVPID",
   NULL, NULL, NULL, NULL},
  {RVFL_TRACKER_REGISTER,	/* obsolete */
   "RVFL_TRACKER_REGISTER",
   NULL, NULL, NULL, NULL},
  {RVFL_LOGICAL_NOOP,		/* obsolete */
   "RVFL_LOGICAL_NOOP",
   NULL, NULL, NULL, NULL},
  {RVFL_FILEDESC_INS,		/* obsolete */
   "RVFL_FILEDESC_INS",
   NULL, NULL, NULL, NULL},
  {RVFL_POSTPONE_DESTROY_FILE,	/* obsolete */
   "RVFL_POSTPONE_DESTROY_FILE",
   NULL, NULL, NULL, NULL},
  {RVFL_FHDR_UPDATE_NUM_USER_PAGES,	/* obsolete */
