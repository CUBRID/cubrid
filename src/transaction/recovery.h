...
typedef enum
{
  ...
  RVVAC_REMOVE_REC_BIGONE = 129,
  RVVAC_LOG_BLOCK_REMOVE = 130,
  RVVAC_LOG_BLOCK_APPEND = 131,
  RVVAC_LOG_BLOCK_SAVE = 132,
  RVVAC_DROPPED_FILE_CLEANUP = 133,
  RVVAC_DROPPED_FILE_NEXT_PAGE = 134,
  RVVAC_DROPPED_FILE_ADD = 135,

  RVBT_MVCC_INCREMENTS_UPD = 136,

  RVBT_MVCC_NOTIFY_VACUUM = 137,

  RVES_NOTIFY_VACUUM = 138,

  RVHF_UPDATE_NOTIFY_VACUUM = 139,
  ...
  RVHF_MVCC_REMOVE_PARTITION_LINK = 143,

  RVBT_DELETE_INDEX = 144,
