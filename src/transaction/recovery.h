...
typedef enum
{
  ...
  RVHF_CREATE_HEADER_REUSE_OID = 97,
  ...
  RVFL_FHDR_UPDATE_NUM_USER_PAGES = 141,
  ...
  RVEH_INIT_NEW_DIR_PAGE = 149,

  RVBT_MARK_DEALLOC_PAGE = 150,

  RV_LAST_LOGID = RVBT_MARK_DEALLOC_PAGE,
