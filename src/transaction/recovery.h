...
typedef enum
{
  ...
  RVHF_MVCC_REMOVE_PARTITION_LINK = 61,
  RVHF_PARTITION_LINK_FLAG = 62,
  ...
  RVOVF_NEWPAGE_DELETE_RELOCATED = 71,
  ...
  RVVAC_HEAP_PAGE_VACUUM = 133,
  RVVAC_REMOVE_OVF_INSID = 134,
  RVVAC_LOG_BLOCK_REMOVE = 135,
  RVVAC_LOG_BLOCK_APPEND = 136,
  RVVAC_LOG_BLOCK_SAVE = 137,
  RVVAC_START_OR_END_JOB = 138,
  ...
  RVHF_MVCC_UPDATE_OVERFLOW = 148,

  RV_LAST_LOGID = RVHF_MVCC_UPDATE_OVERFLOW,
