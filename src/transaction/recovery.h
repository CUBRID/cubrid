...
typedef enum
{
  ...
  RVVAC_LOG_BLOCK_MODIFY = 132,
  RVVAC_LOG_BLOCK_SAVE = 133,
  RVVAC_DROPPED_FILE_CLEANUP = 134,
  RVVAC_DROPPED_FILE_NEXT_PAGE = 135,
  RVVAC_DROPPED_FILE_ADD = 136,

  RVBT_MVCC_INCREMENTS_UPD = 137,

  RVBT_MVCC_NOTIFY_VACUUM = 138,

  RVES_NOTIFY_VACUUM = 139,

  RV_LAST_LOGID = RVES_NOTIFY_VACUUM,
