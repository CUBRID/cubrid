...
typedef enum
{
  ...
  RVHF_MVCC_DELETE = 105,
  RVHF_MVCC_DELETE_RELOCATED = 106,
  RVHF_MVCC_DELETE_RELOCATION = 107,
  RVHF_MVCC_MODIFY_RELOCATION_LINK = 108,
  RVOVF_NEWPAGE_DELETE_RELOCATED = 109,

  RVBT_MVCC_DELETE_OBJECT = 110,

  RVVAC_REMOVE_HEAP_OIDS = 111,
  RVVAC_REMOVE_OVF_INSID = 112,
  RVVAC_REMOVE_REC_BIGONE = 113,
  RVVAC_LOG_BLOCK_REMOVE = 114,
  RVVAC_LOG_BLOCK_APPEND = 115,
  RVVAC_LOG_BLOCK_SAVE = 116,
  RVVAC_DROPPED_FILE_CLEANUP = 117,
  RVVAC_DROPPED_FILE_NEXT_PAGE = 118,
  RVVAC_DROPPED_FILE_ADD = 119,

  RVBT_MVCC_INCREMENTS_UPD = 120,

  RVBT_MVCC_NOTIFY_VACUUM = 121,

  RVES_NOTIFY_VACUUM = 122,

  RVHF_UPDATE_NOTIFY_VACUUM = 123,

  RVBO_DELVOL = 124,

  RVBT_LOG_GLOBAL_UNIQUE_STATS_COMMIT = 125,

  RVBT_DELETE_OBJECT_PHYSICAL = 126,
  RVBT_NON_MVCC_INSERT_OBJECT = 127,
  RVBT_MVCC_INSERT_OBJECT = 128,
  RVBT_RECORD_MODIFY_NO_UNDO = 129,
  RVBT_RECORD_MODIFY_COMPENSATE = 130,

  RVHF_MVCC_REMOVE_PARTITION_LINK = 131,

  RVBT_DELETE_INDEX = 132,

  RVHF_PARTITION_LINK_FLAG = 133,

  RV_LAST_LOGID = RVHF_PARTITION_LINK_FLAG,
