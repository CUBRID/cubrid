...
typedef enum
{
  ...
  RVFL_CREATE_TMPFILE = 14,	/* obsolete */
  RVFL_FTAB_CHAIN = 15,		/* obsolete */
  RVFL_IDSTABLE = 16,		/* obsolete */
  RVFL_MARKED_DELETED = 17,	/* obsolete */
  RVFL_ALLOCSET_SECT = 18,	/* obsolete */
  RVFL_ALLOCSET_PAGETB_ADDRESS = 19,	/* obsolete */
  RVFL_ALLOCSET_NEW = 20,	/* obsolete */
  RVFL_ALLOCSET_LINK = 21,	/* obsolete */
  RVFL_ALLOCSET_ADD_PAGES = 22,	/* obsolete */
  RVFL_ALLOCSET_DELETE_PAGES = 23,	/* obsolete */
  RVFL_ALLOCSET_SECT_SHIFT = 24,	/* obsolete */
  RVFL_ALLOCSET_COPY = 25,	/* obsolete */
  RVFL_FHDR = 26,		/* obsolete */
  RVFL_FHDR_ADD_LAST_ALLOCSET = 27,	/* obsolete */
  RVFL_FHDR_REMOVE_LAST_ALLOCSET = 28,	/* obsolete */
  RVFL_FHDR_CHANGE_LAST_ALLOCSET = 29,	/* obsolete */
  RVFL_FHDR_ADD_PAGES = 30,	/* obsolete */
  RVFL_FHDR_MARK_DELETED_PAGES = 31,	/* obsolete */
  RVFL_FHDR_DELETE_PAGES = 32,	/* obsolete */
  RVFL_FHDR_FTB_EXPANSION = 33,	/* obsolete */
  RVFL_FILEDESC_UPD = 34,
  RVFL_DES_FIRSTREST_NEXTVPID = 35,	/* obsolete */
  RVFL_DES_NREST_NEXTVPID = 36,	/* obsolete */
  RVFL_TRACKER_REGISTER = 37,	/* obsolete */
  RVFL_LOGICAL_NOOP = 38,	/* obsolete */
  RVFL_FILEDESC_INS = 39,	/* obsolete */
  RVFL_POSTPONE_DESTROY_FILE = 40,	/* obsolete */
  RVFL_FHDR_UPDATE_NUM_USER_PAGES = 41,	/* obsolete */
  ...
  RVHF_UPDATE = 48,
  RVHF_REUSE_PAGE = 49,
  RVHF_CREATE_HEADER_REUSE_OID = 50,	/* Obsolete */
  RVHF_NEWPAGE_REUSE_OID = 51,	/* Obsolete */
  ...
  RVHF_CREATE = 64,		/* Obsolete */
  RVHF_MVCC_REDISTRIBUTE = 65,

  RVOVF_NEWPAGE_LOGICAL_UNDO = 66,	/* Obsolete */
