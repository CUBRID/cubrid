...
#if defined (CS_MODE)
int la_applyinfo_applied_log_info (const char *database_name, const char *log_path, bool check_replica_info,
				   bool verbose, LOG_LSA * applied_final_lsa);
int la_applyinfo_copied_log_info (const char *database_name, const char *log_path, INT64 page_num, bool verbose,
