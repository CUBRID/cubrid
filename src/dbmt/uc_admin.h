...
typedef int (*T_UCA_GET_BR_DIAGCONFIG_WITH_OPENED_SHM) (void *shm_br,
							void *c_config,
							char *err_msg);
typedef int (*T_UCA_SET_BR_DIAGCONFIG_WITH_OPENED_SHM) (void *shm_br,
							void *c_config,
							char *err_msg);
#endif
...
#if 0				/* ACTIVITY PROFILE */
DLL_EXPORT int uc_get_br_diagconfig_with_opened_shm (void *shm_br,
						     void *c_config,
						     char *err_msg);
DLL_EXPORT int uc_set_br_diagconfig_with_opened_shm (void *shm_br,
						     void *c_config,
						     char *err_msg);
#endif
