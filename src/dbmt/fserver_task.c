...
/* TODO rename sqlx... */
#define SQLXINIT_PARAM_NUM 128
static T_SQLXINIT_PARAM default_sqlxinit[SQLXINIT_PARAM_NUM] = {
  {"error_log", "", 0x00},
  {"num_data_buffers", "500", 0x00},
#if 0
  {"flush_data_buffer_factor", "0.8", 0x00},
#endif
  {"lock_escalation", "100000", 0x00},
  {"deadlock_detection_interval", "1", 0x00},
  {"lock_timeout_in_secs", "-1", 0x00},
  {"lockf_enable", "1", 0x00},
  {"isolation_level", "\"TRAN_REP_CLASS_COMMIT_INSTANCE\"", 0x00},
  {"media_failures_are_supported", "1", 0x00},
  {"log_size", "-1", 0x00},
  {"log_reserve_space", "0", 0x00},
  {"log_prefix_name", "NULL", 0x00},
  {"log_path", "NULL", 0x00},
  {"num_log_buffers", "50", 0x00},
  {"checkpoint_interval", "100", 0x00},
  {"warn_outofspace_factor", "0.15", 0x00},
  {"unfill_factor", "0.10", 0x00},
  {"unfill_index_factor", "0.20", 0x00},
  {"max_quick_size", "256", 0x00},
  {"max_block_size", "128", 0x00},
  {"max_block_count", "128", 0x00},
  {"initial_workspace_table_size", "4092", 0x00},
  {"sr_buffers", "16", 0x00},
  {"optimization_level", "1", 0x00},
#if 0
  {"queryarea_factor", "0.10", 0x00},
#endif
  {"volext_path", "NULL", 0x00},
  {"auto_volext_factor", "1.0", 0x00},
  {"voltmp_path", "NULL", 0x00},
  {"maxtmp_pages", "-1", 0x00},
#if 0
  {"thread_quantum", "300", 0x00},
#endif
  {"commit_on_shutdown", "0", 0x00},
  {"cubrid_port_id", "1523", 0x00},
  {"network_service_name", "\"sqlx\"", 0x00},
  {"max_clients", "500", 0x00},
#if 0
  {"active_requests", "50", 0x00},
#endif
  {"max_threads", "50", 0x00},
  {"db_hosts", "", 0x00},
#if 0
  {"server_driver_version_check", "1", 0x00},
#endif
  {"client_timeout", "120", 0x00},
  {"max_ping_wait", "5", 0x00},
  {"connection_timeout", "3", 0x00},
  {"network_pagesize", "32768", 0x00},
  {"backup_max_volume_size", "-1", 0x00},
  {"backup_iobuffer_size", "1", 0x00},
#if 0
  {"event_handler", "", 0x00},
#endif
  {"initial_object_lock_table_size", "10000", 0x00},
  {"lock_timeout_message_dump_level", "0", 0x00},
  {"temp_mem_buffer_pages", "4", 0x00},
  {"gc_enable", "0", 0x00},
#if 0
  {"enable_histo", "0", 0x00},
#endif
  {"index_scan_order", "0", 0x00},
  {"call_stack_dump_disable", "", 0x70},
  {"call_stack_dump_enable", "", 0x70},
  {"call_stack_dump_on_error", "0", 0x70},
#if 0
  {"catalog_oid_table_size", "1024", 0x70},
  {"check_deleted_objects", "1", 0x70},
#endif
  {"checkpoint_interval_minutes", "1440", 0x70},
#if 0
  {"class_representation_cache", "100", 0x70},
  {"compactdb_page_reclaim_only", "0", 0x70},
  {"cpu_weight", "0.0025", 0x70},
  {"default_driver_dir", "", 0x70},
#endif
  {"disable_default_numeric_division_scale", "0", 0x70},
#if 0
  {"do_ldb_class", "0", 0x70},
  {"dont_reuse_heap_file", "0", 0x70},
  {"driver_page_fetch", "1", 0x70},
  {"driver_timeout", "-1", 0x70},
  {"event_handler", "", 0x70},
  {"gc_block_increment", "4", 0x70},
  {"inquire_on_exit", "", 0x70},
  {"io_volinfo_increment", "32", 0x70},
#endif
#if AIX
  {"is_pthread_scope_process", "1", 0x70},
#endif
#if 0
  {"ldb_driver_decay_constant", "300", 0x70},
  {"ldb_max_active_drivers", "10", 0x70},
  {"ldb_min_active_drivers", "1", 0x70},
  {"ldb_preconnect_list", "", 0x70},
  {"like_term_selectivity", "0.1", 0x70},
  {"max_classname_cache_entries", "1024", 0x70},
  {"max_entries_in_temp_file_cache", "1024", 0x70},
  {"max_index_scan_count", "32", 0x70},
  {"max_outer_card_of_idxjoin", "0", 0x70},
  {"max_pages_in_temp_file_cache", "1000", 0x70},
#endif
  {"maxlength_error_log", "3000 * 80", 0x70},
#if 0
  {"memory_report_level", "0", 0x70},
  {"memory_verification_level", "1", 0x70},
  {"min_num_rows_for_multi_delete", "20", 0x70},
  {"mutex_busy_waiting_cnt", "0", 0x70},
  {"new_classname_cache_size", "1025", 0x70},
  {"no_range_optimization", "0", 0x70},
  {"num_index_oid_buffers", "8", 0x70},
  {"num_LRU_chains", "0", 0x70},
  {"oid_batch_size", "2000", 0x70},
  {"optimization_limit", "32", 0x70},
  {"optimize_hostvars_at_runtime", "0", 0x70},
#endif
  {"oracle_style_empty_string", "0", 0x70},
#if 0
  {"oracle_style_outerjoin", "0", 0x70},
  {"qo_dump_level", "0", 0x70},
  {"reset_tr_parser_interval", "10", 0x70},
  {"server_inserts", "1", 0x70},
  {"session_mode_sync", "0", 0x70},
  {"sql_trace_critical_time", "300", 0x70},
  {"sql_trace_file_dir", "", 0x70},
  {"sql_trace_file_prefix", "\"trace.\"", 0x70},
  {"sql_trace_file_suffix", "\".log\"", 0x70},
  {"sql_trace_level", "0", 0x70},
  {"sql_trace_max_lines", "10000", 0x70},
  {"sql_trace_warning_time", "10", 0x70},
  {"suppress_fsync", "0", 0x70},
#endif
  {"thread_stacksize", "100K", 0x70},
#if 0
  {"ttvol_shrink_enable", "0", 0x70},
  {"use_oid_preflush", "1", 0x70},
#endif
  {"bwcomp_primary_key", "0", 0x70},
  {"disable_java_stored_procedure", "0", 0x70},
  {"is_replicated", "0", 0x70}
#if 0
  {"bytes_per_char", "0", 0x70}
#endif
};
...
static void _ts_lockdb_parse_us (nvplist * res, FILE * infile);
static void _ts_lockdb_parse_kr (nvplist * res, FILE * infile);
...
static void op_make_sqlx_param_default_val_to_5_2 (T_SQLXINIT_PARAM *
						   default_sqlxinit);
static void op_make_sqlx_param_default_val_delete (T_SQLXINIT_PARAM *
						   default_sqlxinit);
static void op_make_sqlx_param_to_6 (T_SQLXINIT_PARAM * default_sqlxinit);
static void op_auto_exec_query_get_newplan_id (char *id_buf, char *filename);
static char *op_get_cubrid_ver (char *buffer);

static int _ts_lockdb_parse_5_2_later_kr (nvplist * res, FILE * infile);
static int _ts_lockdb_parse_5_2_later_us (nvplist * res, FILE * infile);
...
ts2_get_logfile_info (nvplist * in, nvplist * out, char *_dbmt_error)
{
  ...
  while ((dirp = readdir (dp)) != NULL)
      ...
      if (strstr (cur_file, bname) != NULL)
	{
	  ...
	  else if (strstr (cur_file, "error") != NULL)
  ...
  sprintf (scriptdir, "%s/%s", logdir, UNICAS_SQL_LOG_DIR);
#ifdef WIN32
...
{
  FILE *outfile;
  char sqlxinit_path[512];
  char *conf, *confdata;
  int nv_len, i;

  sprintf (sqlxinit_path, "%s/conf/%s", sco.szCubrid, USQL_SQLX_INIT);

  if ((outfile = fopen (sqlxinit_path, "w")) == NULL)
    {
      return ERR_TMPFILE_OPEN_FAIL;
    }
...
{
  FILE *infile;
  char sqlxinit_path[512], strbuf[1024];

  sprintf (sqlxinit_path, "%s/conf/%s", sco.szCubrid, USQL_SQLX_INIT);

  if (access (sqlxinit_path, F_OK) < 0)
    {
      return ERR_FILE_OPEN_FAIL;
    }

  infile = fopen (sqlxinit_path, "r");
  if (infile == NULL)
    {
      strcpy (_dbmt_error, sqlxinit_path);
      return ERR_FILE_OPEN_FAIL;
    }
...
tsCreateDB (nvplist * req, nvplist * res, char *_dbmt_error)
{
  ...
  if ((overwrite_config_file == NULL)	/* for backword compatibility */
      || (strcasecmp (overwrite_config_file, "NO") != 0))
    {
      ...
      sprintf (dstrbuf, "%s/conf/%s", sco.szCubrid, USQL_SQLX_INIT);
      ...
      if (infile == NULL)
	{
      ...
      sprintf (dstrbuf, "%s/%s", targetdir, USQL_SQLX_INIT);
  ...
  if (0)
    {
      ...
      sprintf (oldfilename, "%s/%s", targetdir, USQL_SQLX_INIT);
  ...
  if ((overwrite_config_file == NULL)	/* for backword compatibility */
      || (strcasecmp (overwrite_config_file, "NO") != 0))
    {
      ...
      sprintf (strbuf, "%s/%s", targetdir, USQL_SQLX_INIT);
      unlink (strbuf);
    }
...
ts_copydb (nvplist * req, nvplist * res, char *_dbmt_error)
{
  ...
  strcat (src_conf_file, USQL_SQLX_INIT);
  ...
  strcat (dest_conf_file, USQL_SQLX_INIT);
...
ts_backupdb (nvplist * req, nvplist * res, char *_dbmt_error)
{
  ...
  if (read_sqlx_error_file (cubrid_err_file, _dbmt_error, DBMT_ERROR_MSG_SIZE)
      < 0)
    {
      return ERR_WITH_MSG;
    }
...
ts_unloaddb (nvplist * req, nvplist * res, char *_dbmt_error)
{
  ...
  if ((infile = fopen (infofile, "rt")) == NULL)
      ...
      else if (!strcmp (target, "object"))
	{
      ...
      sprintf (buf, "%s/%s%s", targetdir, dbname, USQL_UNLOAD_EXT_INDEX);
      if (stat (buf, &statbuf) == 0)
	{
	  fprintf (outfile, "index %s/%s%s\n", targetdir, dbname,
		   USQL_UNLOAD_EXT_INDEX);
	}
      /* check trigger file and append if exist */
      sprintf (buf, "%s/%s%s", targetdir, dbname, USQL_UNLOAD_EXT_TRIGGER);
      if (stat (buf, &statbuf) == 0)
	{
	  fprintf (outfile, "trigger %s/%s%s\n", targetdir, dbname,
		   USQL_UNLOAD_EXT_TRIGGER);
	}
      fclose (outfile);
    }
  else
      ...
      if (flag == 0)
	{
	  ...
	  /* check index file and append if exist */
	  sprintf (temp, "%s/%s%s", targetdir, dbname, USQL_UNLOAD_EXT_INDEX);
	  if (stat (temp, &statbuf) == 0)
	    {
	      fprintf (outfile, "index %s/%s%s\n", targetdir, dbname,
		       USQL_UNLOAD_EXT_INDEX);
...
ts_get_dbsize (nvplist * req, nvplist * res, char *_dbmt_error)
{
  ...
  while ((dp = readdir (dirp)) != NULL)
#endif
    {
	  ...
	  || !strcmp (cur_file + baselen, USQL_ACT_LOG_EXT)
	  || !strncmp (cur_file + baselen, USQL_ARC_LOG_EXT,
		       USQL_ARC_LOG_EXT_LEN))
	{
...
ts_backupdb_info (nvplist * req, nvplist * res, char *_dbmt_error)
{
  ...
  sprintf (vinf, "%s/%s%s", log_dir, dbname, USQL_BACKUP_INFO_EXT);
...
ts_get_log_info (nvplist * req, nvplist * res, char *_dbmt_error)
{
  ...
  sprintf (buf, "%s/userver.err", log_dir);
  if (stat (buf, &statbuf) == 0)
    {
      nv_add_nvp (res, "open", "log");
      nv_add_nvp (res, "path", buf);
...
ts_get_db_error (nvplist * req, nvplist * res, char *_dbmt_error)
{
  ...
  sprintf (dbfilepath, "%s/%s", sco.szCubrid_databases, USQL_DATABASE_TXT);
...
ts_lockdb (nvplist * req, nvplist * res, char *_dbmt_error)
{
  ...
  if (CLIENT_VERSION <= EMGR_MAKE_VER (1, 1))
    {				/* global CLIENT_VERSION */
      if (kr)
	_ts_lockdb_parse_kr (res, infile);
      else
	_ts_lockdb_parse_us (res, infile);
    }
  else
    {
      if (kr)
	{
	  if (_ts_lockdb_parse_5_2_later_kr (res, infile) < 0)
	    {
	      /* parshing error */
	      strcpy (_dbmt_error,
	...
	{
	  if (_ts_lockdb_parse_5_2_later_us (res, infile) < 0)
	    {
	      /* parshing error */
	      strcpy (_dbmt_error,
		      "Lockdb operation has been failed(Unexpected state).");
...
ts_get_backup_list (nvplist * req, nvplist * res, char *_dbmt_error)
{
  ...
  sprintf (f, "%s/%s%s", log_dir, dbname, USQL_BACKUP_INFO_EXT);
...
op_db_user_pass_check (char *dbname, char *dbuser, char *dbpass)
{
  ...
  retval = run_child (argv, 1, NULL, NULL, cubrid_err_file, NULL);	/* sqlx */

  unlink (input_file);
  if (read_sqlx_error_file (cubrid_err_file, NULL, DBMT_ERROR_MSG_SIZE) < 0)
    {
      return 0;
    }
...
_op_get_constraint_info (nvplist * out, DB_CONSTRAINT * con)
{
  ...
  if (db_constraint_type (con) == DB_CONSTRAINT_FOREIGN_KEY)
    {
      char buf[256];
      DB_OBJECT *ref_cls;
      ...
      sprintf (buf, "REFERENCES %s", db_get_class_name (ref_cls));
      ...
      if (cache_attr)
	{
	  sprintf (buf, "ON CACHE OBJECT %s", cache_attr);
	  nv_add_nvp (out, "rule", buf);
	}
    }
...
_op_get_class_info (nvplist * out, DB_OBJECT * classobj)
{
  ...
  if (CLIENT_VERSION > EMGR_MAKE_VER (1, 1))
  ...
  else
    {
      if (db_is_vclass (classobj))
	{
	  nv_add_nvp (out, "virtual", "y");
	}
      else
	{
	  nv_add_nvp (out, "virtual", "n");
	}
    }
...
_tsAppendDBList (nvplist * res, char dbdir_flag)
{
  ...
  sprintf (strbuf, "%s/%s", sco.szCubrid_databases, USQL_DATABASE_TXT);
		 ...
		 char *_dbmt_error, T_SPACEDB_RESULT * cmd_res)
{
  ...
  while ((dp = readdir (dirp)) != NULL)
	...
	{
	  if (!strcmp (fname + baselen, USQL_ACT_LOG_EXT))
	    _ts_gen_spaceinfo (res, fname, dbdir, "Active_log", pagesize);
	  else
	    if (!strncmp
		(fname + baselen, USQL_ARC_LOG_EXT, USQL_ARC_LOG_EXT_LEN))
...
_ts_get_error_log_param (char *dbname)
{
  ...
  if ((uRetrieveDBDirectory (dbname, dbdir)) != ERR_NO_ERROR)
    return NULL;
  sprintf (buf, "%s/%s", dbdir, USQL_SQLX_INIT);
...
{
  char buf[1024], s[32], s1[128], s2[128], s3[128], s4[128], s5[128];
  char *temp, *temp2;
  int i, maxi, flag = 0;
  ...
  while (fgets (buf, 1024, infile))
	...
	{
	  if (!strcmp (s, "Transaction"))
	    {
	      sscanf (buf, "%*s %*s %s %s %s", s1, s2, s3);
	      s1[strlen (s1) - 1] = '\0';
	      s2[strlen (s2) - 1] = '\0';
	      s3[strlen (s3) - 1] = '\0';
	      nv_add_nvp (res, "open", "transaction");
	  ...
	  while (!strcmp (s, "OID"))
	    {
	      ...
	      nv_add_nvp (res, "num_granted", s4);
	      nv_add_nvp (res, "num_waiting", s5);
	      fgets (buf, 1024, infile);
	      sscanf (buf, "%*s %*s %s", s1);
	      s1[strlen (s1) - 1] = '\0';
	      nv_add_nvp (res, "class", s1);

	      nv_add_nvp (res, "open", "granted");
	      if ((maxi = atoi (s4)) != 0)
		{
		  ...
		  for (i = 0; i < maxi; i++)
		    {
		      ...
		      nv_add_nvp (res, "lock", s2);
		      nv_add_nvp (res, "count", s3);
		      nv_add_nvp (res, "subgraules", s4);
		    }
		}
	      nv_add_nvp (res, "close", "granted");

	      nv_add_nvp (res, "open", "waiting");
	      if ((maxi = atoi (s5)) != 0)
		{
		  for (i = 0; i < maxi; i++)
		    {
		      ...
		      s1[strlen (s1) - 1] = '\0';
		      s2[strlen (s2) - 1] = '\0';
		      nv_add_nvp (res, "wait_sec", s1);
		      nv_add_nvp (res, "wait_num", s2);
		      fgets (buf, 1024, infile);
		      sscanf (buf, "%*s %*s %s", s1);
		      temp = strchr (buf, s1[0]);
		      strncpy (s1, temp, buf + strlen (buf) - temp - 1);
		      s1[buf + strlen (buf) - temp] = '\0';
		      nv_add_nvp (res, "wait_tran", s1);
		    }
		}
	      nv_add_nvp (res, "close", "waiting");

	      nv_add_nvp (res, "open", "non2pl");
	      fgets (buf, 1024, infile);
	      sscanf (buf, "%s", s);
	      if (!strcmp (s, "NON_2PL_RELEASED:"))
		{
		  while (1)
		    {
		      if (fgets (buf, 1024, infile) == NULL)
	      ...
	      nv_add_nvp (res, "close", "non2pl");

	      nv_add_nvp (res, "close", "entry");

	    }			/* end of while(!strcmp(s, "OID") */
	  nv_add_nvp (res, "close", "lot");
	  sscanf (buf, "%*s %*s %*s %*s %*s %*s %*s %*s %s", s1);
	  nv_add_nvp (res, "open", "lpt");
	  nv_add_nvp (res, "entries", s1);
	  flag = 3;
	}			/* end of if (flag == 2) */
      else if (flag == 3)
	{
	  while (!strcmp (s, "Vol_Page") && flag == 3)
	    {
	      ...
	      strcat (s1, s2);
	      nv_add_nvp (res, "open", "entry");
	      nv_add_nvp (res, "vol_page:", s1);
	      nv_add_nvp (res, "num_granted", s3);
	      nv_add_nvp (res, "num_waiting", s4);
	      ...
	      else
		{
	      ...
	      nv_add_nvp (res, "close", "non2pl");
	      nv_add_nvp (res, "close", "entry");
	    }			/* end of while(!strcmp(s, "Vol_Page") && flag == 3) */
	}			/* end of if (flag == 3) */
    }				/* end of while */
  nv_add_nvp (res, "close", "lpt");
...
ts_localdb_operation (nvplist * req, nvplist * res, char *_dbmt_error)
{
  ...
  /* register ldb with sqlx command */
  /* sqlx -sa -i input_file dbname  */
  ...
  retval = run_child (argv, 1, NULL, NULL, cubrid_err_file, NULL);	/* sqlx - register new ldb */
  unlink (input_file);
...
ts_trigger_operation (nvplist * req, nvplist * res, char *_dbmt_error)
{
  ...
  retval = run_child (argv, 1, NULL, NULL, cubrid_err_file, NULL);	/* sqlx - trigger */
  unlink (input_file);
...
static int
_ts_lockdb_parse_5_2_later_us (nvplist * res, FILE * infile)
{
...
static int
_ts_lockdb_parse_5_2_later_kr (nvplist * res, FILE * infile)
{
  char buf[1024], s[256], s1[256], s2[256], s3[256], s4[256];
  char *temp, *temp2;
  int scan_matched;
...
static void
op_make_sqlx_param_default_val_to_5_2 (T_SQLXINIT_PARAM * default_sqlxinit)
{
  int index;
  for (index = 0; index < SQLXINIT_PARAM_NUM; index++)
    {
      if (strcmp (default_sqlxinit[index].name, "lock_escalation") == 0)
	{
	  strcpy (default_sqlxinit[index].value, "1000");
	}
      else
	if (strcmp
	    (default_sqlxinit[index].name,
	     "deadlock_detection_interval") == 0)
	{
	  strcpy (default_sqlxinit[index].value, "30");
	}
#if 0
      else
	if (strcmp (default_sqlxinit[index].name, "flush_data_buffer_factor")
	    == 0)
	{
	  memset (default_sqlxinit[index].name, '\0',
		  sizeof (default_sqlxinit[index].name));
	  memset (default_sqlxinit[index].value, '\0',
		  sizeof (default_sqlxinit[index].value));
	}
#endif
    }
}
...
static void
op_make_sqlx_param_to_6 (T_SQLXINIT_PARAM * default_sqlxinit)
{
  int index;
  for (index = 0; index < SQLXINIT_PARAM_NUM; index++)
    {
      if (default_sqlxinit[index].version >= 0x70)
	{
	  memset (default_sqlxinit[index].value, '\0',
		  sizeof (default_sqlxinit[index].value));
	  memset (default_sqlxinit[index].name, '\0',
		  sizeof (default_sqlxinit[index].name));
	  default_sqlxinit[index].version = 0;
	}
    }
}

static void
op_make_sqlx_param_default_val_delete (T_SQLXINIT_PARAM * default_sqlxinit)
{
  int index;
  for (index = 0; index < SQLXINIT_PARAM_NUM; index++)
    {
...
get_dbvoldir (char *vol_dir, char *dbname, char *err_buf)
{
  ...
  sprintf (db_txt, "%s/%s", envpath, USQL_DATABASE_TXT);
