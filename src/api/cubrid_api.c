 ...
 */
int
ci_glo_create (CI_CONNECTION conn, const char *file_path,
	       const char *init_file_path, CI_OID * glo)
{
  ...
  res = opool->glo_create (opool, conn, file_path, init_file_path, glo);
  API_RETURN (res);
}

/*
 * ci_glo_get_path_name - 
 *    return:
 *    glo():
 *    buf():
 *    bufsz():
 ...
 */
int
ci_glo_get_path_name (CI_OID * glo, char *buf, size_t bufsz, bool full_path)
{
  API_DECLARE;
  int res;
  COMMON_API_STRUCTURE *pst;
  ...
  if (glo == NULL || buf == NULL || bufsz <= 0)
    {
      API_IMPL_TBL->err_set (ER_INTERFACE_INVALID_ARGUMENT);
      return ER_INTERFACE_INVALID_ARGUMENT;
    }

  API_HOUSEKEEP_BEGIN (glo->conn, COMMON_API_STRUCTURE *, pst);
  API_CHECK_HANDLE (pst, HANDLE_TYPE_CONNECTION);
  ...
  res = opool->glo_get_path_name (opool, glo, buf, bufsz, full_path);
  API_RETURN (res);
}

/*
 * ci_glo_do_compaction - 
 *    return:
 *    glo():
 */
int
ci_glo_do_compaction (CI_OID * glo)
{
  API_DECLARE;
  int res;
  COMMON_API_STRUCTURE *pst;
  ...
  res = opool->glo_do_compaction (opool, glo);
  API_RETURN (res);
}
 ...
 */
int
ci_glo_insert (CI_OID * glo, const char *buf, size_t bufsz)
{
  API_DECLARE;
  int res;
  COMMON_API_STRUCTURE *pst;
  ...
  res = opool->glo_insert (opool, glo, buf, bufsz);
  API_RETURN (res);
}
 ...
 */
int
ci_glo_delete (CI_OID * glo, size_t sz, size_t * ndeleted)
{
  API_DECLARE;
  int res;
  COMMON_API_STRUCTURE *pst;
  ...
  res = opool->glo_delete (opool, glo, sz, ndeleted);
  API_RETURN (res);
}
 ...
 */
int
ci_glo_read (CI_OID * glo, char *buf, size_t bufsz, size_t * nread)
{
  API_DECLARE;
  int res;
  COMMON_API_STRUCTURE *pst;
  ...
  res = opool->glo_read (opool, glo, buf, bufsz, arg);
  API_RETURN (res);
}
 ...
 */
int
ci_glo_write (CI_OID * glo, const char *buf, size_t sz)
{
  API_DECLARE;
  int res;
  COMMON_API_STRUCTURE *pst;
  ...
  res = opool->glo_write (opool, glo, buf, sz);
  API_RETURN (res);
}
 ...
 */
int
ci_glo_truncate (CI_OID * glo, size_t * ndeleted)
{
  API_DECLARE;
  int res;
  COMMON_API_STRUCTURE *pst;
  ...
  res = opool->glo_truncate (opool, glo, arg);
  API_RETURN (res);
}
 ...
 */
int
ci_glo_seek (CI_OID * glo, long offset, int whence)
{
  API_DECLARE;
  int res;
  COMMON_API_STRUCTURE *pst;
  ...
  res = opool->glo_seek (opool, glo, offset, whence);
  API_RETURN (res);
}
 ...
 */
int
ci_glo_tell (CI_OID * glo, long *offset)
{
  API_DECLARE;
  int res;
  COMMON_API_STRUCTURE *pst;
  ...
  res = opool->glo_tell (opool, glo, offset);
  API_RETURN (res);
}
 ...
 */
int
ci_glo_like_search (CI_OID * glo, const char *str, size_t strsz, bool * found)
{
  API_DECLARE;
  int res;
  COMMON_API_STRUCTURE *pst;
  ...
  if (glo == NULL || str == NULL || strsz <= 0 || found == NULL)
    {
      API_IMPL_TBL->err_set (ER_INTERFACE_INVALID_ARGUMENT);
      return ER_INTERFACE_INVALID_ARGUMENT;
    }
  ...
  res = opool->glo_like_search (opool, glo, str, strsz, found);
  API_RETURN (res);
}
 ...
 */
int
ci_glo_reg_search (CI_OID * glo, const char *str, size_t strsz, bool * found)
{
  API_DECLARE;
  int res;
  COMMON_API_STRUCTURE *pst;
  ...
  res = opool->glo_reg_search (opool, glo, str, strsz, found);
  API_RETURN (res);
}
 ...
 */
int
ci_glo_bin_search (CI_OID * glo, const char *str, size_t strsz, bool * found)
{
  API_DECLARE;
  int res;
  COMMON_API_STRUCTURE *pst;
  ...
  res = opool->glo_bin_search (opool, glo, str, strsz, found);
  API_RETURN (res);
}
 ...
 */
int
ci_glo_copy (CI_OID * to, CI_OID * from)
{
  API_DECLARE;
  int res;
  COMMON_API_STRUCTURE *pst;
  ...
  API_HOUSEKEEP_BEGIN (from->conn, COMMON_API_STRUCTURE *, pst);
  API_CHECK_HANDLE (pst, HANDLE_TYPE_CONNECTION);
  ...
  res = opool->glo_copy (opool, to, from);
  API_RETURN (res);
}
