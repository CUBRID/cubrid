...
| 65,536 records/slots, 1 GiB scan and 100 ms traversal | Deterministic scan and wire boundary cases at limit minus one, limit, limit plus one; lower scan-byte budgets isolate footer reservation since ordinary scalar frames do not reach 1 GiB before the record cap |
