...
set -euo pipefail
mount --make-rprivate /
mount --bind "/home/vimkim/temp/p06/ctp-debug" /mnt
...
export PGBUF_INSPECTOR_FIXTURE=/home/vimkim/gh/cb/CBRD-27398-pgbuf-inspector-contract/build_preset_debug_gcc/bin/pgbuf_inspector_fixture
