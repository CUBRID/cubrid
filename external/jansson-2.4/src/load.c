...
static void
stream_unget (stream_t * stream, int c)
{
...
static void
lex_unget (lex_t * lex, int c)
{
  stream_unget (&lex->stream, c);
}

static void
lex_unget_unsave (lex_t * lex, int c)
{
  if (c != STREAM_STATE_EOF && c != STREAM_STATE_ERROR)
    {
      char d;
...
static int
lex_scan_number (lex_t * lex, int c, json_error_t * error)
{
...
static int
lex_init (lex_t * lex, get_func get, void *data)
{
...
json_t *
json_load_callback (json_load_callback_t callback, void *arg, size_t flags, json_error_t * error)
{
  lex_t lex;
  json_t *result;
