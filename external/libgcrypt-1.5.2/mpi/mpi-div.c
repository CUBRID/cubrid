...
void
_gcry_mpi_fdiv_qr (gcry_mpi_t quot, gcry_mpi_t rem, gcry_mpi_t dividend,
		   gcry_mpi_t divisor)
{
  int divisor_sign = divisor->sign;
  gcry_mpi_t temp_divisor = NULL;
...
void
_gcry_mpi_tdiv_qr (gcry_mpi_t quot, gcry_mpi_t rem, gcry_mpi_t num,
		   gcry_mpi_t den)
{
  mpi_ptr_t np, dp;
  mpi_ptr_t qp, rp;
...
void
gcry_mpi_div (gcry_mpi_t quot, gcry_mpi_t rem, gcry_mpi_t dividend,
