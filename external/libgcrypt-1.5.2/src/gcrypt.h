...
/* Please note that keygrip is still experimental and should not be
   used without contacting the author. */
     unsigned char *gcry_pk_get_keygrip (gcry_sexp_t key,
					 unsigned char *array);
...
/* Create a message digest object for algorithm ALGO.  FLAGS may be
   ...
   gcry_md_enable.  */
     gcry_error_t gcry_md_open (gcry_md_hd_t * h, int algo,
				unsigned int flags);
...
/* Store the value labelled with NAME found in DATA in MPI.  If FLAGS
   ...
   in the data set.  MPI may be NULL.  */
     gcry_error_t gcry_ac_data_get_name (gcry_ac_data_t data,
...
/* Stores in NAME and MPI the named MPI value contained in the data
   ...
   may be NULL.  */
     gcry_error_t gcry_ac_data_get_index (gcry_ac_data_t data,
					  unsigned int flags,
...
/* Convert the data set DATA into a new S-Expression, which is to be
   ...
   IDENTIFIERS.  */
     gcry_error_t gcry_ac_data_to_sexp (gcry_ac_data_t data,
					gcry_sexp_t * sexp,
...
/* Create a new data set, which is to be stored in DATA_SET, from the
   ...
   IDENTIFIERS.  */
     gcry_error_t gcry_ac_data_from_sexp (gcry_ac_data_t * data,
					  gcry_sexp_t sexp,
					  const char **identifiers)
  /* */ _GCRY_ATTR_INTERNAL;
...
/* Type for progress handlers.  */
     typedef void (*gcry_handler_progress_t) (void *, const char *, int, int,
					      int);
...
/* Certain operations can provide progress information.  This function
   is used to register a handler for retrieving these information. */
     void gcry_set_progress_handler (gcry_handler_progress_t cb,
				     void *cb_data);
...
/* Register a function used instead of the internal fatal error
   handler. */
     void gcry_set_fatalerror_handler (gcry_handler_error_t fnc,
				       void *opaque);
