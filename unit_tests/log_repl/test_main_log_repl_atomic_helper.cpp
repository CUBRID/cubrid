...
struct log_record_spec_type
{
  ...
  // TODO: feature about whether the page for the log record can be
  // fixed or not (to simulate real life conditions)
};
...
TEST_CASE ("log replication atomic helper: LOG_START/END_ATOMIC_REPL", "")
{
  // logging snippet:
  ...
  log_rec_vec.push_back ({ trid, INV_LSA, INV_VPID, LOG_START_ATOMIC_REPL, INV_RCVINDEX, INV_SYSOP_END_TYPE, INV_LSA });
  log_rec_vec.push_back ({ trid, INV_LSA, { 102, 0 }, INV_RECTYPE, RVHF_UPDATE_NOTIFY_VACUUM, INV_SYSOP_END_TYPE, INV_LSA });
  log_rec_vec.push_back ({ trid, INV_LSA, { 102, 0 }, INV_RECTYPE, RVHF_SET_PREV_VERSION_LSA, INV_SYSOP_END_TYPE, INV_LSA });
  log_rec_vec.push_back ({ trid, INV_LSA, INV_VPID, LOG_END_ATOMIC_REPL, INV_RCVINDEX, INV_SYSOP_END_TYPE, INV_LSA });
...
TEST_CASE ("log replication atomic helper: LOG_SYSOP_ATOMIC_START/LOG_SYSOP_END-LOG_SYSOP_END_LOGICAL_UNDO", "")
{
  // logging snippet:
  ...
  log_rec_vec.push_back ({ trid, INV_LSA, INV_VPID, LOG_SYSOP_ATOMIC_START, INV_RCVINDEX, INV_SYSOP_END_TYPE, INV_LSA });
  log_rec_vec.push_back ({ trid, INV_LSA, { 102, 0 }, INV_RECTYPE, RVFL_PARTSECT_ALLOC, INV_SYSOP_END_TYPE, INV_LSA });
  log_rec_vec.push_back ({ trid, INV_LSA, { 102, 0 }, INV_RECTYPE, RVFL_FHEAD_ALLOC, INV_SYSOP_END_TYPE, INV_LSA });
  log_rec_vec.push_back ({ trid, INV_LSA, { 102, 0 }, INV_RECTYPE, RVFL_EXTDATA_REMOVE, INV_SYSOP_END_TYPE, INV_LSA });
  log_rec_vec.push_back ({ trid, INV_LSA, { 102, 0 }, INV_RECTYPE, RVFL_EXTDATA_ADD, INV_SYSOP_END_TYPE, INV_LSA });
  log_rec_vec.push_back ({ trid, INV_LSA, { 103, 0 }, INV_RECTYPE, RVHF_NEWPAGE, INV_SYSOP_END_TYPE, INV_LSA });
  test_spec.calculate_log_records_offsets (start_lsa);
  const LOG_LSA &sysop_end_last_parent_lsa = log_rec_vec[0].m_lsa;
  log_rec_vec.push_back ({ trid, INV_LSA, INV_VPID, LOG_SYSOP_END, INV_RCVINDEX, LOG_SYSOP_END_LOGICAL_UNDO, sysop_end_last_parent_lsa });
...
TEST_CASE ("log replication atomic helper: LOG_SYSOP_ATOMIC_START/LOG_SYSOP_END-LOG_SYSOP_END_COMMIT", "")
{
  // logging snippet:
  ...
  log_rec_vec.push_back ({ trid, INV_LSA, INV_VPID, LOG_SYSOP_ATOMIC_START, INV_RCVINDEX, INV_SYSOP_END_TYPE, INV_LSA });
  log_rec_vec.push_back ({ trid, INV_LSA, { 102, 0 }, INV_RECTYPE, RVDK_RESERVE_SECTORS, INV_SYSOP_END_TYPE, INV_LSA });
  log_rec_vec.push_back ({ trid, INV_LSA, { 103, 0 }, INV_RECTYPE, RVFL_EXPAND, INV_SYSOP_END_TYPE, INV_LSA });
  test_spec.calculate_log_records_offsets (start_lsa);
  const LOG_LSA &sysop_end_last_parent_lsa = log_rec_vec[0].m_lsa;
  log_rec_vec.push_back ({ trid, INV_LSA, INV_VPID, LOG_SYSOP_END, INV_RCVINDEX, LOG_SYSOP_END_COMMIT, sysop_end_last_parent_lsa });
...
TEST_CASE ("log replication atomic helper: LOG_SYSOP_ATOMIC_START/LOG_SYSOP_START_POSTPONE/LOG_SYSOP_END", "")
{
  ...
  log_rec_vec.push_back ({ trid, INV_LSA, INV_VPID, LOG_SYSOP_ATOMIC_START, INV_RCVINDEX, INV_SYSOP_END_TYPE, INV_LSA });
  log_rec_vec.push_back ({ trid, INV_LSA, { 15, 0 }, INV_RECTYPE, RVBT_NDRECORD_DEL, INV_SYSOP_END_TYPE, INV_LSA });
  log_rec_vec.push_back ({ trid, INV_LSA, { 88, 0 }, INV_RECTYPE, RVBT_COPYPAGE, INV_SYSOP_END_TYPE, INV_LSA });
  log_rec_vec.push_back ({ trid, INV_LSA, { 64, 0 }, INV_RECTYPE, RVBT_NDHEADER_UPD, INV_SYSOP_END_TYPE, INV_LSA });
  log_rec_vec.push_back ({ trid, INV_LSA, INV_VPID, LOG_SYSOP_START_POSTPONE, INV_RCVINDEX, INV_SYSOP_END_TYPE, INV_LSA });
  log_rec_vec.push_back ({ trid, INV_LSA, INV_VPID, LOG_SYSOP_ATOMIC_START, INV_RCVINDEX, INV_SYSOP_END_TYPE, INV_LSA });
  log_rec_vec.push_back ({ trid, INV_LSA, { 24, 0 }, INV_RECTYPE, RVFL_EXTDATA_REMOVE, INV_SYSOP_END_TYPE, INV_LSA });
  log_rec_vec.push_back ({ trid, INV_LSA, { 24, 0 }, INV_RECTYPE, RVFL_EXTDATA_ADD, INV_SYSOP_END_TYPE, INV_LSA });
  log_rec_vec.push_back ({ trid, INV_LSA, { 24, 0 }, INV_RECTYPE, RVFL_FHEAD_DEALLOC, INV_SYSOP_END_TYPE, INV_LSA });
  log_rec_vec.push_back ({ trid, INV_LSA, { 71, 0 }, INV_RECTYPE, RVPGBUF_DEALLOC, INV_SYSOP_END_TYPE, INV_LSA });
  test_spec.calculate_log_records_offsets (start_lsa);
  // lsa of LOG_SYSOP_START_POSTPONE log record
  const LOG_LSA &sysop_end_last_parent_lsa = log_rec_vec[4].m_lsa;
  log_rec_vec.push_back ({ trid, INV_LSA, INV_VPID, LOG_SYSOP_END, INV_RCVINDEX, LOG_SYSOP_END_LOGICAL_RUN_POSTPONE, sysop_end_last_parent_lsa });
  log_rec_vec.push_back ({ trid, INV_LSA, INV_VPID, LOG_SYSOP_END, INV_RCVINDEX, LOG_SYSOP_END_COMMIT, INV_LSA });
  ...
  for (auto &pair: m_fixed_page_map)
    {
      ...
      assert (m_fixed_page_ptr_set.find (page_ptr) != m_fixed_page_ptr_set.cend ());
      delete [] page_ptr;
    }
...
void test_spec_type::calculate_log_records_offsets (LOG_LSA start_lsa)
{
  ...
  for (; it != m_log_record_vec.end (); ++it)
    {
      log_record_spec_type &log_rec = *it;
      assert (LSA_ISNULL (&log_rec.m_lsa));
...
void test_spec_type::execute (cublog::atomic_replication_helper &atomic_helper)
{
  for (const log_record_spec_type &log_rec : m_log_record_vec)
	...
	{
	  assert (VPID_EQ (&log_rec.m_vpid, &INV_VPID));
	  assert (log_rec.m_rcvindex == INV_RCVINDEX);
	  assert (log_rec.m_sysop_end_type == INV_SYSOP_END_TYPE);
	  assert (log_rec.m_sysop_end_last_parent_lsa == INV_LSA);
	...
	{
	  assert (log_rec.m_rectype == INV_RECTYPE);
	  assert (log_rec.m_sysop_end_type == INV_SYSOP_END_TYPE);
	  assert (log_rec.m_sysop_end_last_parent_lsa == INV_LSA);
...
PAGE_PTR test_spec_type::fix_page (const VPID &vpid)
{
  ...
  if (find_it == m_fixed_page_map.cend ())
    {
      PAGE_PTR page_ptr = new char[256];
