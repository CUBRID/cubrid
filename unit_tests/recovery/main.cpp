...
int execute_test (cubthread::manager *_cub_thread_manager, const db_database_config &a_database_config, const log_recovery_test_config &a_test_config)
{
  ...
  ux_db_database db_online { new db_database (a_database_config.max_volume_count_per_database, a_database_config.max_page_count_per_volume) };
