...
#define X509v3_KU_UNDEF                 0xffff
  ...
  typedef struct X509_name_entry_st X509_NAME_ENTRY;
    ...
    DEFINE_STACK_OF (X509_NAME_ENTRY) DEFINE_STACK_OF (X509_NAME)
...
#define X509_EX_V_INIT                  0x0001
  ...
  typedef STACK_OF (X509_EXTENSION) X509_EXTENSIONS;
    ...
    DEFINE_STACK_OF (X509_EXTENSION) typedef struct x509_attributes_st X509_ATTRIBUTE;

    DEFINE_STACK_OF (X509_ATTRIBUTE) typedef struct X509_req_info_st X509_REQ_INFO;
...
#define XN_FLAG_MULTILINE (ASN1_STRFLGS_ESC_CTRL | \
                        ...
                        XN_FLAG_FN_LN | \
                        XN_FLAG_FN_ALIGN)
    DEFINE_STACK_OF (X509_REVOKED) typedef struct X509_crl_info_st X509_CRL_INFO;

    DEFINE_STACK_OF (X509_CRL) typedef struct private_key_st
  {
    int version;
...
#define         X509_name_cmp(a,b)      X509_NAME_cmp((a),(b))
  ...
  X509 *X509_REQ_to_X509 (X509_REQ * r, int days, EVP_PKEY * pkey);
    ...
    DECLARE_ASN1_FUNCTIONS (X509_PUBKEY) int X509_PUBKEY_set (X509_PUBKEY ** x, EVP_PKEY * pkey);
  ...
  void X509_SIG_getm (X509_SIG * sig, X509_ALGOR ** palg, ASN1_OCTET_STRING ** pdigest);
    ...
    DECLARE_ASN1_FUNCTIONS (X509_ATTRIBUTE) X509_ATTRIBUTE *X509_ATTRIBUTE_create (int nid, int atrtype, void *value);

    DECLARE_ASN1_FUNCTIONS (X509_EXTENSION)
    DECLARE_ASN1_ENCODE_FUNCTIONS (X509_EXTENSIONS, X509_EXTENSIONS, X509_EXTENSIONS)
    DECLARE_ASN1_FUNCTIONS (X509_NAME_ENTRY)
    DECLARE_ASN1_FUNCTIONS (X509_NAME) int X509_NAME_set (X509_NAME ** xn, X509_NAME * name);

    DECLARE_ASN1_FUNCTIONS (X509_CINF) DECLARE_ASN1_FUNCTIONS (X509) DECLARE_ASN1_FUNCTIONS (X509_CERT_AUX)
#define X509_get_ex_new_index(l, p, newf, dupf, freef) \
  ...
  void X509_reject_clear (X509 * x);
    ...
    DECLARE_ASN1_FUNCTIONS (X509_CRL) int X509_CRL_add0_revoked (X509_CRL * crl, X509_REVOKED * rev);
  ...
  void X509_PKEY_free (X509_PKEY * a);
    ...
    DECLARE_ASN1_FUNCTIONS (NETSCAPE_CERT_SEQUENCE) X509_INFO *X509_INFO_new (void);
  ...
  int ASN1_sign (i2d_of_void * i2d, X509_ALGOR * algor1,
		 X509_ALGOR * algor2, ASN1_BIT_STRING * signature, char *data, EVP_PKEY * pkey, const EVP_MD * type);
  ...
  int ASN1_item_sign_ctx (const ASN1_ITEM * it, X509_ALGOR * algor1,
			  X509_ALGOR * algor2, ASN1_BIT_STRING * signature, void *asn, EVP_MD_CTX * ctx);
 ...
 */
  ...
  X509_ATTRIBUTE *X509at_delete_attr (STACK_OF (X509_ATTRIBUTE) * x, int loc);
    ...
    STACK_OF (X509_ATTRIBUTE) * X509at_add1_attr_by_NID (STACK_OF (X509_ATTRIBUTE)
							 ** x, int nid, int type, const unsigned char *bytes, int len);
...
/* lookup a cert from a X509 STACK */
  ...
  X509 *X509_find_by_subject (STACK_OF (X509) * sk, X509_NAME * name);
    ...
    DECLARE_ASN1_FUNCTIONS (PBEPARAM) DECLARE_ASN1_FUNCTIONS (PBE2PARAM) DECLARE_ASN1_FUNCTIONS (PBKDF2PARAM)
#ifndef OPENSSL_NO_SCRYPT
...
/* PKCS#8 utilities */
    ...
    DECLARE_ASN1_FUNCTIONS (PKCS8_PRIV_KEY_INFO) EVP_PKEY *EVP_PKCS82PKEY (const PKCS8_PRIV_KEY_INFO * p8);
  PKCS8_PRIV_KEY_INFO *EVP_PKEY2PKCS8 (EVP_PKEY * pkey);

  int PKCS8_pkey_set0 (PKCS8_PRIV_KEY_INFO * priv, ASN1_OBJECT * aobj,
		       int version, int ptype, void *pval, unsigned char *penc, int penclen);
  int PKCS8_pkey_get0 (const ASN1_OBJECT ** ppkalg,
		       const unsigned char **pk, int *ppklen, const X509_ALGOR ** pa, const PKCS8_PRIV_KEY_INFO * p8);
  ...
  int X509_PUBKEY_get0_param (ASN1_OBJECT ** ppkalg,
			      const unsigned char **pk, int *ppklen, X509_ALGOR ** pa, X509_PUBKEY * pub);
