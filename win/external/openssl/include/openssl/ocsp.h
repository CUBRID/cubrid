...
#define OCSP_NOTIME                     0x800
  ...
  typedef struct ocsp_cert_id_st OCSP_CERTID;
    ...
    DEFINE_STACK_OF (OCSP_CERTID) typedef struct ocsp_one_request_st OCSP_ONEREQ;

    DEFINE_STACK_OF (OCSP_ONEREQ) typedef struct ocsp_req_info_st OCSP_REQINFO;
...
#define V_OCSP_RESPID_KEY  1
    ...
    DEFINE_STACK_OF (OCSP_RESPID) typedef struct ocsp_revoked_info_st OCSP_REVOKEDINFO;
...
#define V_OCSP_CERTSTATUS_UNKNOWN 2
  ...
  typedef struct ocsp_single_response_st OCSP_SINGLERESP;
    ...
    DEFINE_STACK_OF (OCSP_SINGLERESP) typedef struct ocsp_response_data_st OCSP_RESPDATA;
...
#define OCSP_CERTSTATUS_dup(cs)\
  ...
  int OCSP_request_sign (OCSP_REQUEST * req,
			 X509 * signer,
			 EVP_PKEY * key, const EVP_MD * dgst, STACK_OF (X509) * certs, unsigned long flags);
  ...
  int OCSP_basic_sign_ctx (OCSP_BASICRESP * brsp,
			   X509 * signer, EVP_MD_CTX * ctx, STACK_OF (X509) * certs, unsigned long flags);
  ...
  const OCSP_CERTID *OCSP_SINGLERESP_get0_id (const OCSP_SINGLERESP * x);
    ...
    DECLARE_ASN1_FUNCTIONS (OCSP_SERVICELOC) const char *OCSP_response_status_str (long s);
