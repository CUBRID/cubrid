...
#define BN_mod(rem,m,d,ctx) BN_div(NULL,(rem),(m),(d),(ctx))
  ...
  int BN_mod_exp2_mont (BIGNUM * r, const BIGNUM * a1, const BIGNUM * p1,
			const BIGNUM * a2, const BIGNUM * p2, const BIGNUM * m, BN_CTX * ctx, BN_MONT_CTX * m_ctx);
...
#define BN_BLINDING_NO_RECREATE 0x00000002
  ...
  BN_BLINDING *BN_BLINDING_create_param (BN_BLINDING * b,
					 ...
					 int (*bn_mod_exp) (BIGNUM * r,
							    ...
							    const BIGNUM * p,
							    const BIGNUM * m,
							    BN_CTX * ctx, BN_MONT_CTX * m_ctx), BN_MONT_CTX * m_ctx);

    DEPRECATEDIN_0_9_8 (void BN_set_params (int mul, int high, int low, int mont)) DEPRECATEDIN_0_9_8 (int BN_get_params (int which))	/* 0, mul, 1 high, 2 low, 3
																	 * mont */
 ...
 */
  ...
  int BN_generate_dsa_nonce (BIGNUM * out, const BIGNUM * range,
			     const BIGNUM * priv, const unsigned char *message, size_t message_len, BN_CTX * ctx);
