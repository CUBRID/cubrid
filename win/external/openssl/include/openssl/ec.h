...
/********************************************************************/
    ...
    DECLARE_ASN1_ITEM (ECPARAMETERS) DECLARE_ASN1_ALLOC_FUNCTIONS (ECPARAMETERS)
/*
 ...
 */
  ...
  int ECDH_compute_key (void *out, size_t outlen, const EC_POINT * pub_key,
			const EC_KEY * ecdh, void *(*KDF) (const void *in, size_t inlen, void *out, size_t * outlen));
 ...
 */
  int ECDSA_sign_ex (int type, const unsigned char *dgst, int dgstlen,
		     unsigned char *sig, unsigned int *siglen, const BIGNUM * kinv, const BIGNUM * rp, EC_KEY * eckey);
