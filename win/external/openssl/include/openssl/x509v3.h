...
#define GEN_RID         8
  ...
  typedef STACK_OF (ASN1_INTEGER) TLS_FEATURE;
    ...
    DEFINE_STACK_OF (GENERAL_NAME) typedef STACK_OF (GENERAL_NAME) GENERAL_NAMES;
    DEFINE_STACK_OF (GENERAL_NAMES) DEFINE_STACK_OF (ACCESS_DESCRIPTION) typedef struct DIST_POINT_NAME_st
  {
    int type;
    union
    {
...
#define CRL_REASON_AA_COMPROMISE                10
  ...
  typedef STACK_OF (DIST_POINT) CRL_DIST_POINTS;
    ...
    DEFINE_STACK_OF (DIST_POINT) struct AUTHORITY_KEYID_st
  {
...
/* Strong extranet structures */
  ...
  typedef struct SXNET_ID_st
  {
    ...
    DEFINE_STACK_OF (SXNETID) typedef struct SXNET_st
  {
  ...
  typedef struct POLICYQUALINFO_st
  {
    ...
    DEFINE_STACK_OF (POLICYQUALINFO) typedef struct POLICYINFO_st
  {
  ...
  typedef STACK_OF (POLICYINFO) CERTIFICATEPOLICIES;
    ...
    DEFINE_STACK_OF (POLICYINFO) typedef struct POLICY_MAPPING_st
  {
    ASN1_OBJECT *issuerDomainPolicy;
    ASN1_OBJECT *subjectDomainPolicy;
  } POLICY_MAPPING;

    DEFINE_STACK_OF (POLICY_MAPPING) typedef STACK_OF (POLICY_MAPPING) POLICY_MAPPINGS;
  ...
  typedef struct GENERAL_SUBTREE_st
  {
    ...
    DEFINE_STACK_OF (GENERAL_SUBTREE) struct NAME_CONSTRAINTS_st
  {
...
/* Proxy certificate structures, see RFC 3820 */
  ...
  typedef struct PROXY_CERT_INFO_EXTENSION_st
  {
    ...
    DECLARE_ASN1_FUNCTIONS (PROXY_POLICY) DECLARE_ASN1_FUNCTIONS (PROXY_CERT_INFO_EXTENSION) struct ISSUING_DIST_POINT_st
  {
    DIST_POINT_NAME *distpoint;
    int onlyuser;
    int onlyCA;
...
#define X509V3_ADD_SILENT               0x10
  ...
  ASN1_OCTET_STRING *SXNET_get_id_INTEGER (SXNET * sx, ASN1_INTEGER * zone);
    ...
    DECLARE_ASN1_FUNCTIONS (GENERAL_NAME) GENERAL_NAME *GENERAL_NAME_dup (GENERAL_NAME * a);
  ...
  ASN1_BIT_STRING *v2i_ASN1_BIT_STRING (X509V3_EXT_METHOD * method, X509V3_CTX * ctx, STACK_OF (CONF_VALUE) * nval);
    STACK_OF (CONF_VALUE) * i2v_ASN1_BIT_STRING (X509V3_EXT_METHOD * method,
						 ASN1_BIT_STRING * bits, STACK_OF (CONF_VALUE) * extlist);
  ...
  GENERAL_NAMES *v2i_GENERAL_NAMES (const X509V3_EXT_METHOD * method, X509V3_CTX * ctx, STACK_OF (CONF_VALUE) * nval);
    ...
    DECLARE_ASN1_FUNCTIONS (EDIPARTYNAME) int OTHERNAME_cmp (OTHERNAME * a, OTHERNAME * b);
  ...
  ASN1_OCTET_STRING *s2i_ASN1_OCTET_STRING (X509V3_EXT_METHOD * method, X509V3_CTX * ctx, const char *str);
    ...
    DECLARE_ASN1_FUNCTIONS (EXTENDED_KEY_USAGE) int i2a_ACCESS_DESCRIPTION (BIO * bp, const ACCESS_DESCRIPTION * a);
    ...
    DECLARE_ASN1_FUNCTIONS (ISSUING_DIST_POINT) int DIST_POINT_set_dpname (DIST_POINT_NAME * dpn, X509_NAME * iname);
  ...
  GENERAL_NAME *v2i_GENERAL_NAME_ex (GENERAL_NAME * out,
				     const X509V3_EXT_METHOD * method, X509V3_CTX * ctx, CONF_VALUE * cnf, int is_nc);
...
#define ASIdentifierChoice_asIdsOrRanges        1
  ...
  typedef struct ASIdentifiers_st
  {
    ...
    DECLARE_ASN1_FUNCTIONS (ASIdentifierChoice) DECLARE_ASN1_FUNCTIONS (ASIdentifiers) typedef struct IPAddressRange_st
  {
...
#define IPAddressChoice_addressesOrRanges       1
  ...
  typedef STACK_OF (IPAddressFamily) IPAddrBlocks;
    ...
    DECLARE_ASN1_FUNCTIONS (IPAddressChoice) DECLARE_ASN1_FUNCTIONS (IPAddressFamily)
/*
 ...
 */
  ...
  int X509v3_addr_add_prefix (IPAddrBlocks * addr,
			      const unsigned afi, const unsigned *safi, unsigned char *a, const int prefixlen);
  int X509v3_addr_add_range (IPAddrBlocks * addr,
			     const unsigned afi, const unsigned *safi, unsigned char *min, unsigned char *max);
 ...
 */
  ...
  typedef struct AdmissionSyntax_st ADMISSION_SYNTAX;
    ...
    DEFINE_STACK_OF (ADMISSIONS) DEFINE_STACK_OF (PROFESSION_INFO) typedef STACK_OF (PROFESSION_INFO) PROFESSION_INFOS;
