...
#define ASN1_STRFLGS_RFC2253    (ASN1_STRFLGS_ESC_2253 | \
    ...
    DEFINE_STACK_OF (ASN1_INTEGER) DEFINE_STACK_OF (ASN1_GENERALSTRING) DEFINE_STACK_OF (ASN1_UTF8STRING) typedef struct asn1_type_st
  {
    int type;
    union
    {
...
#define B_ASN1_DISPLAYTEXT \
  ...
  int ASN1_OCTET_STRING_set (ASN1_OCTET_STRING * str, const unsigned char *data, int len);
    ...
    DECLARE_ASN1_FUNCTIONS (ASN1_BMPSTRING) int UTF8_getc (const unsigned char *str, int len, unsigned long *val);
  int UTF8_putc (unsigned char *str, int len, unsigned long value);
    ...
    DECLARE_ASN1_ITEM (ASN1_OCTET_STRING_NDEF) ASN1_TIME *ASN1_TIME_set (ASN1_TIME * s, time_t t);
