 ...
 */
  ...
  int RAND_DRBG_set_reseed_defaults (unsigned int master_reseed_interval,
				     ...
				     time_t master_reseed_time_interval, time_t slave_reseed_time_interval);
 ...
 */
  typedef size_t (*RAND_DRBG_get_entropy_fn) (RAND_DRBG * drbg,
					      unsigned char **pout,
					      int entropy, size_t min_len, size_t max_len, int prediction_resistance);
  ...
  int RAND_DRBG_set_callbacks (RAND_DRBG * drbg,
			       ...
			       RAND_DRBG_get_nonce_fn get_nonce, RAND_DRBG_cleanup_nonce_fn cleanup_nonce);
