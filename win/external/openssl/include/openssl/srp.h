...
extern "C"
{
  ...
  typedef struct SRP_gN_cache_st
  {
    ...
    DEFINE_STACK_OF (SRP_gN_cache) typedef struct SRP_user_pwd_st
  {
    /* Owned by us. */
    char *id;
    BIGNUM *s;
  ...
  void SRP_user_pwd_free (SRP_user_pwd * user_pwd);
    ...
    DEFINE_STACK_OF (SRP_user_pwd) typedef struct SRP_VBASE_st
  {
 ...
 */
  typedef struct SRP_gN_st
  {
    ...
    DEFINE_STACK_OF (SRP_gN) SRP_VBASE *SRP_VBASE_new (char *seed_key);
