...
*/
  ...
  typedef struct pkcs7_signer_info_st
  {
    ...
    DEFINE_STACK_OF (PKCS7_SIGNER_INFO) typedef struct pkcs7_recip_info_st
  {
    ...
    DEFINE_STACK_OF (PKCS7_RECIP_INFO) typedef struct pkcs7_signed_st
  {
    ASN1_INTEGER *version;	/* version 1 */
...
#define SMIME_ASCIICRLF         0x80000
  ...
  int PEM_write_bio_PKCS7_stream (BIO * out, PKCS7 * p7, BIO * in, int flags);
    ...
    DECLARE_ASN1_PRINT_FUNCTION (PKCS7) long PKCS7_ctrl (PKCS7 * p7, int cmd, long larg, char *parg);
