...
extern "C"
{
  ...
  typedef struct CMS_OtherKeyAttribute_st CMS_OtherKeyAttribute;
    ...
    DECLARE_ASN1_FUNCTIONS (CMS_ReceiptRequest) DECLARE_ASN1_PRINT_FUNCTION (CMS_ContentInfo)
...
#define CMS_ASCIICRLF                   0x80000
  ...
  CMS_ContentInfo *CMS_sign_receipt (CMS_SignerInfo * si,
				     X509 * signcert, EVP_PKEY * pkey, STACK_OF (X509) * certs, unsigned int flags);
  ...
  int CMS_EncryptedData_decrypt (CMS_ContentInfo * cms,
				 const unsigned char *key, size_t keylen, BIO * dcont, BIO * out, unsigned int flags);
  ...
  int CMS_decrypt_set1_key (CMS_ContentInfo * cms,
			    unsigned char *key, size_t keylen, const unsigned char *id, size_t idlen);
  ...
  void CMS_SignerInfo_get0_algs (CMS_SignerInfo * si, EVP_PKEY ** pk,
				 X509 ** signer, X509_ALGOR ** pdig, X509_ALGOR ** psig);
  ...
  CMS_ReceiptRequest *CMS_ReceiptRequest_create0 (unsigned char *id, int idlen,
						  ...
						  * receiptList, STACK_OF (GENERAL_NAMES) * receiptsTo);
