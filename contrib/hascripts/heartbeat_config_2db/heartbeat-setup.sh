...
change_heartbeat_config()
{
	...
	cmd="ssh $1@$2 'sed -i \"s/HB_MADDR/$HB_MADDR/g\" $INSTALL_TMP_DIR/heartbeat/ha.cf'"; 		eval $cmd
	cmd="ssh $1@$2 'sed -i \"s/HB_PORT/$HB_PORT/g\" $INSTALL_TMP_DIR/heartbeat/ha.cf'"; 		eval $cmd
...
install_heartbeat_config()
{
	...
	ssh -t $1@$2 "sudo chmod 600 /etc/ha.d/authkeys"
