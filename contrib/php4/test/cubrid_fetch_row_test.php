<?php
echo "<html>";
echo "<title>cubrid_fetch_row</title>";
echo "PHP version: ".phpversion();
echo "<br>";
echo "<br>";
echo "Testing <b>cubrid_fetch_row</b> implementation...";
echo "<br>"."<br>";
...
else 
{
  ...
  echo "Testing <b>cubrid_fetch_row</b>...<br>";
  ...
  echo "<br>";
  echo "<b>Testing cubrid_fetch_row with wrong number of params: 0</b>...<br>";
  $result = cubrid_execute($cubrid_con, $sql);
  if ($result) 
  {
    $row = cubrid_fetch_row();
    cubrid_close_request($result); 
  }
  echo "<br>";
  echo "<br>";
