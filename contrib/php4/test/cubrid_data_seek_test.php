<?php
echo "<html>";
echo "<title>cubrid_data_seek</title>";
echo "PHP version: ".phpversion();
echo "<br>";
echo "<br>";
echo "Testing <b>cubrid_data_seek</b> implementation...";
echo "<br>"."<br>";
...
else 
{
  ...
  echo "Testing <b>cubrid_data_seek</b>...<br>";
  ...
  echo "<br>";
  echo "<b>Testing cubrid_data_seek with wrong number of params: 0</b>...<br>";
  $result = cubrid_execute($cubrid_con, $sql);
  if ($result) 
  {
    cubrid_data_seek();
  ...
  echo "<br>";
  echo "<b>Testing cubrid_data_seek with invalid value of column number: -1</b>...<br>";
  $result = cubrid_execute($cubrid_con, $sql);
  if ($result) 
  {
    $row = cubrid_data_seek($result, -1);
    if (!$row)
    	echo "index out of range<br>";
    cubrid_close_request($result); 
  }
  echo "<br>";
  
  echo "<br>";
  echo "<b>Testing cubrid_data_seek with a large value of column number: 12345</b>...<br>";
  $result = cubrid_execute($cubrid_con, $sql);
  if ($result) 
  {
    $row = cubrid_data_seek($result, 12345);
    if (!$row)
    	echo "index out of range<br>";
    cubrid_close_request($result); 
  }
