<?php
echo "<html>";
echo "<title>cubrid_get_client_info</title>";
echo "PHP version: ".phpversion();
echo "<br>";
echo "<br>";
echo "Testing <b>cubrid_get_client_info</b> implementation...";
echo "<br>"."<br>";
...
else 
{
  ...
  echo "Testing <b>cubrid_get_client_info</b>...<br>";

  echo "<br>";
  echo "Output: ".cubrid_get_client_info();
  echo "<br>";

  echo "<br>";
  echo "<b>Testing cubrid_get_client_info with wrong number of params: 1</b>...<br>";
