				...
				stage('Linux Release') {
					stages {
						stage('centos') {
							agent {
								docker {
									image 'cubridci/cubridci:develop_dev9'
									label 'linux'
									alwaysPull true
								}
							}
							...
							steps {
								...
								// Used for the other agent. 
								echo 'Copying CUBRID'
								sh 'rm -rf CUBRID_BK;cp -rf /home/CUBRID CUBRID_BK'
						...
						stage('ubuntu') {
							agent {
								docker {
									image 'cubridci/cubridci:ub20.04_dev9'
									label 'linux'
									alwaysPull true
								}
							}
							...
							steps {
								echo 'Copying CUBRID'
								sh 'rm -rf /home/CUBRID; cp -rf CUBRID_BK /home/CUBRID'
