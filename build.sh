...
function build_configure ()
{
  ...
  configure_options="$configure_options --enable-dbgw --with-nbase-t=yes --enable-nclavis --enable-systemtap"
...
function show_usage ()
{
  ...
  echo "  -z arg  Package to generate (src,zip_src,cci_src,php_src,shell,tarball,cci,jdbc,srpm,rpm,nbase,dbgwci,dbgwci_nclavis,owfs);"
  echo "          [default: all]"
